...
//
class crinstitucionesdesalud extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('institucionesdesalud', 'institucionesdesalud', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombre
		$this->nombre = new crField('institucionesdesalud', 'institucionesdesalud', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// departamento
		$this->departamento = new crField('institucionesdesalud', 'institucionesdesalud', 'x_departamento', 'departamento', '`departamento`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// provincia
		$this->provincia = new crField('institucionesdesalud', 'institucionesdesalud', 'x_provincia', 'provincia', '`provincia`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// municipio
		$this->municipio = new crField('institucionesdesalud', 'institucionesdesalud', 'x_municipio', 'municipio', '`municipio`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// direccion
		$this->direccion = new crField('institucionesdesalud', 'institucionesdesalud', 'x_direccion', 'direccion', '`direccion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// telefono
		$this->telefono = new crField('institucionesdesalud', 'institucionesdesalud', 'x_telefono', 'telefono', '`telefono`', 200, EWR_DATATYPE_STRING, -1);
		...
		// email
		$this->_email = new crField('institucionesdesalud', 'institucionesdesalud', 'x__email', 'email', '`email`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_persona
		$this->id_persona = new crField('institucionesdesalud', 'institucionesdesalud', 'x_id_persona', 'id_persona', '`id_persona`', 3, EWR_DATATYPE_NUMBER, -1);
