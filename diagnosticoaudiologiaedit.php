...
$diagnosticoaudiologia_edit = NULL; // Initialize page object first

class cdiagnosticoaudiologia_edit extends cdiagnosticoaudiologia {
	...
	// Page object name
	var $PageObjName = 'diagnosticoaudiologia_edit';
...
// Create page object
if (!isset($diagnosticoaudiologia_edit)) $diagnosticoaudiologia_edit = new cdiagnosticoaudiologia_edit();

// Page init
$diagnosticoaudiologia_edit->Page_Init();

// Page main
$diagnosticoaudiologia_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$diagnosticoaudiologia_edit->Page_Render();
?>
...
var CurrentForm = fdiagnosticoaudiologiaedit = new ew_Form("fdiagnosticoaudiologiaedit", "edit");

// Validate form
fdiagnosticoaudiologiaedit.Validate = function() {
...
fdiagnosticoaudiologiaedit.Form_CustomValidate = 
...
fdiagnosticoaudiologiaedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fdiagnosticoaudiologiaedit.Lists["x_id_tipodiagnosticoaudiologia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodiagnosticoaudiologia"};
fdiagnosticoaudiologiaedit.Lists["x_id_tipodiagnosticoaudiologia"].Data = "<?php echo $diagnosticoaudiologia_edit->id_tipodiagnosticoaudiologia->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $diagnosticoaudiologia_edit->ShowPageHeader(); ?>
<?php
$diagnosticoaudiologia_edit->ShowMessage();
?>
<form name="fdiagnosticoaudiologiaedit" id="fdiagnosticoaudiologiaedit" class="<?php echo $diagnosticoaudiologia_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($diagnosticoaudiologia_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $diagnosticoaudiologia_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="diagnosticoaudiologia">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($diagnosticoaudiologia_edit->IsModal) ?>">
...
<?php if ($diagnosticoaudiologia->id_tipodiagnosticoaudiologia->Visible) { // id_tipodiagnosticoaudiologia ?>
	<div id="r_id_tipodiagnosticoaudiologia" class="form-group">
		<label id="elh_diagnosticoaudiologia_id_tipodiagnosticoaudiologia" for="x_id_tipodiagnosticoaudiologia" class="<?php echo $diagnosticoaudiologia_edit->LeftColumnClass ?>"><?php echo $diagnosticoaudiologia->id_tipodiagnosticoaudiologia->FldCaption() ?></label>
		<div class="<?php echo $diagnosticoaudiologia_edit->RightColumnClass ?>"><div<?php echo $diagnosticoaudiologia->id_tipodiagnosticoaudiologia->CellAttributes() ?>>
...
<?php if ($diagnosticoaudiologia->resultado->Visible) { // resultado ?>
	<div id="r_resultado" class="form-group">
		<label id="elh_diagnosticoaudiologia_resultado" for="x_resultado" class="<?php echo $diagnosticoaudiologia_edit->LeftColumnClass ?>"><?php echo $diagnosticoaudiologia->resultado->FldCaption() ?></label>
		<div class="<?php echo $diagnosticoaudiologia_edit->RightColumnClass ?>"><div<?php echo $diagnosticoaudiologia->resultado->CellAttributes() ?>>
...
<input type="hidden" data-table="diagnosticoaudiologia" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($diagnosticoaudiologia->id->CurrentValue) ?>">
<?php if (!$diagnosticoaudiologia_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $diagnosticoaudiologia_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $diagnosticoaudiologia_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fdiagnosticoaudiologiaedit.Init();
</script>
<?php
$diagnosticoaudiologia_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$diagnosticoaudiologia_edit->Page_Terminate();
?>
