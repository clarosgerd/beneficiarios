...
<?php include_once "otrasorganizacionesrptinfo.php" ?>
<?php
...
$otrasorganizaciones_rpt = NULL; // Initialize page object first

class crotrasorganizaciones_rpt extends crotrasorganizaciones {
	...
	// Page object name
	var $PageObjName = 'otrasorganizaciones_rpt';
	...
	function __construct() {
		...
		if (!isset($GLOBALS["otrasorganizaciones"])) {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'otrasorganizaciones', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fotrasorganizacionesrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'otrasorganizaciones');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fotrasorganizacionesrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fotrasorganizacionesrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fotrasorganizacionesrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[4] = $this->ciudad->CurrentValue;
...
// Create page object
if (!isset($otrasorganizaciones_rpt)) $otrasorganizaciones_rpt = new crotrasorganizaciones_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$otrasorganizaciones_rpt;
...
// Create page object
var otrasorganizaciones_rpt = new ewr_Page("otrasorganizaciones_rpt");

// Page properties
otrasorganizaciones_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = otrasorganizaciones_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_otrasorganizaciones" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="otrasorganizaciones_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="otrasorganizaciones_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="departamento"><div class="otrasorganizaciones_departamento"><span class="ewTableHeaderCaption"><?php echo $Page->departamento->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="departamento">
<?php if ($Page->SortUrl($Page->departamento) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_departamento">
			<span class="ewTableHeaderCaption"><?php echo $Page->departamento->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_departamento" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->departamento) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->departamento->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ciudad"><div class="otrasorganizaciones_ciudad"><span class="ewTableHeaderCaption"><?php echo $Page->ciudad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ciudad">
<?php if ($Page->SortUrl($Page->ciudad) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_ciudad">
			<span class="ewTableHeaderCaption"><?php echo $Page->ciudad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_ciudad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ciudad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ciudad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="direccion"><div class="otrasorganizaciones_direccion"><span class="ewTableHeaderCaption"><?php echo $Page->direccion->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="direccion">
<?php if ($Page->SortUrl($Page->direccion) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_direccion">
			<span class="ewTableHeaderCaption"><?php echo $Page->direccion->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_direccion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->direccion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->direccion->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="telefono"><div class="otrasorganizaciones_telefono"><span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="telefono">
<?php if ($Page->SortUrl($Page->telefono) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_telefono">
			<span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_telefono" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->telefono) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="_email"><div class="otrasorganizaciones__email"><span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="_email">
<?php if ($Page->SortUrl($Page->_email) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones__email">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones__email" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->_email) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_persona"><div class="otrasorganizaciones_id_persona"><span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_persona">
<?php if ($Page->SortUrl($Page->id_persona) == "") { ?>
		<div class="ewTableHeaderBtn otrasorganizaciones_id_persona">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otrasorganizaciones_id_persona" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_persona) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span>
...
<?php include "otrasorganizacionesrptpager.php" ?>
