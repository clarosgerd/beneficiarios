...
<?php include_once "institucionesdesaludrptinfo.php" ?>
<?php
...
$institucionesdesalud_rpt = NULL; // Initialize page object first

class crinstitucionesdesalud_rpt extends crinstitucionesdesalud {
	...
	// Page object name
	var $PageObjName = 'institucionesdesalud_rpt';
	...
	function __construct() {
		...
		if (!isset($GLOBALS["institucionesdesalud"])) {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'institucionesdesalud', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption finstitucionesdesaludrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'institucionesdesalud');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_institucionesdesalud\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_institucionesdesalud',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"finstitucionesdesaludrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"finstitucionesdesaludrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"finstitucionesdesaludrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[3] = $this->departamento->CurrentValue;
			$this->Val[4] = $this->provincia->CurrentValue;
			...
			$this->Val[9] = $this->id_persona->CurrentValue;
		} else {
			$this->id->setDbValue("");
...
// Create page object
if (!isset($institucionesdesalud_rpt)) $institucionesdesalud_rpt = new crinstitucionesdesalud_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$institucionesdesalud_rpt;
...
// Create page object
var institucionesdesalud_rpt = new ewr_Page("institucionesdesalud_rpt");

// Page properties
institucionesdesalud_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = institucionesdesalud_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_institucionesdesalud" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="institucionesdesalud_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="institucionesdesalud_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="departamento"><div class="institucionesdesalud_departamento"><span class="ewTableHeaderCaption"><?php echo $Page->departamento->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="departamento">
<?php if ($Page->SortUrl($Page->departamento) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_departamento">
			<span class="ewTableHeaderCaption"><?php echo $Page->departamento->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_departamento" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->departamento) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->departamento->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="provincia"><div class="institucionesdesalud_provincia"><span class="ewTableHeaderCaption"><?php echo $Page->provincia->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="provincia">
<?php if ($Page->SortUrl($Page->provincia) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_provincia">
			<span class="ewTableHeaderCaption"><?php echo $Page->provincia->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_provincia" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->provincia) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->provincia->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="municipio"><div class="institucionesdesalud_municipio"><span class="ewTableHeaderCaption"><?php echo $Page->municipio->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="municipio">
<?php if ($Page->SortUrl($Page->municipio) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_municipio">
			<span class="ewTableHeaderCaption"><?php echo $Page->municipio->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_municipio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->municipio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->municipio->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="direccion"><div class="institucionesdesalud_direccion"><span class="ewTableHeaderCaption"><?php echo $Page->direccion->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="direccion">
<?php if ($Page->SortUrl($Page->direccion) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_direccion">
			<span class="ewTableHeaderCaption"><?php echo $Page->direccion->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_direccion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->direccion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->direccion->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="telefono"><div class="institucionesdesalud_telefono"><span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="telefono">
<?php if ($Page->SortUrl($Page->telefono) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_telefono">
			<span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_telefono" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->telefono) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="_email"><div class="institucionesdesalud__email"><span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="_email">
<?php if ($Page->SortUrl($Page->_email) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud__email">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud__email" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->_email) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_persona"><div class="institucionesdesalud_id_persona"><span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_persona">
<?php if ($Page->SortUrl($Page->id_persona) == "") { ?>
		<div class="ewTableHeaderBtn institucionesdesalud_id_persona">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer institucionesdesalud_id_persona" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_persona) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span>
...
<?php include "institucionesdesaludrptpager.php" ?>
