...
<?php include_once "actividadrptinfo.php" ?>
<?php
...
$actividad_rpt = NULL; // Initialize page object first

class cractividad_rpt extends cractividad {
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'actividad', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption factividadrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'actividad');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_actividad\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_actividad',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"factividadrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"factividadrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"factividadrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['id_tipoactividad'] = ewr_Conv($rs->fields('id_tipoactividad'), 3);
		...
		if (!$rs->EOF) {
			...
			$this->Val[3] = $this->id_tipoactividad->CurrentValue;
			$this->Val[4] = $this->organizador->CurrentValue;
			$this->Val[5] = $this->nombreactividad->CurrentValue;
			$this->Val[6] = $this->nombrelocal->CurrentValue;
			$this->Val[7] = $this->direccionlocal->CurrentValue;
			$this->Val[8] = $this->fecha_inicio->CurrentValue;
			$this->Val[9] = $this->fecha_fin->CurrentValue;
			$this->Val[10] = $this->horasprogramadas->CurrentValue;
			$this->Val[11] = $this->id_persona->CurrentValue;
			$this->Val[12] = $this->contenido->CurrentValue;
			$this->Val[13] = $this->observaciones->CurrentValue;
			$this->Val[14] = $this->id_centro->CurrentValue;
		} else {
			$this->id->setDbValue("");
			$this->id_sector->setDbValue("");
			$this->id_tipoactividad->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->id_tipoactividad->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// id_tipoactividad
			$CurrentValue = $this->id_tipoactividad->CurrentValue;
			$ViewValue = &$this->id_tipoactividad->ViewValue;
			$ViewAttrs = &$this->id_tipoactividad->ViewAttrs;
			$CellAttrs = &$this->id_tipoactividad->CellAttrs;
			$HrefValue = &$this->id_tipoactividad->HrefValue;
			$LinkAttrs = &$this->id_tipoactividad->LinkAttrs;
			$this->Cell_Rendered($this->id_tipoactividad, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		if ($this->id_tipoactividad->Visible) $this->DtlColumnCount += 1;
...
// Create page object
if (!isset($actividad_rpt)) $actividad_rpt = new cractividad_rpt();
...
// Create page object
var actividad_rpt = new ewr_Page("actividad_rpt");

// Page properties
actividad_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = actividad_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_actividad" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="actividad_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn actividad_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_sector"><div class="actividad_id_sector"><span class="ewTableHeaderCaption"><?php echo $Page->id_sector->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_sector">
<?php if ($Page->SortUrl($Page->id_sector) == "") { ?>
		<div class="ewTableHeaderBtn actividad_id_sector">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_sector->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_id_sector" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_sector) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_sector->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->id_tipoactividad->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_tipoactividad"><div class="actividad_id_tipoactividad"><span class="ewTableHeaderCaption"><?php echo $Page->id_tipoactividad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_tipoactividad">
<?php if ($Page->SortUrl($Page->id_tipoactividad) == "") { ?>
		<div class="ewTableHeaderBtn actividad_id_tipoactividad">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_tipoactividad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_id_tipoactividad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_tipoactividad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_tipoactividad->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_tipoactividad->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_tipoactividad->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="organizador"><div class="actividad_organizador"><span class="ewTableHeaderCaption"><?php echo $Page->organizador->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="organizador">
<?php if ($Page->SortUrl($Page->organizador) == "") { ?>
		<div class="ewTableHeaderBtn actividad_organizador">
			<span class="ewTableHeaderCaption"><?php echo $Page->organizador->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_organizador" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->organizador) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->organizador->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombreactividad"><div class="actividad_nombreactividad"><span class="ewTableHeaderCaption"><?php echo $Page->nombreactividad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombreactividad">
<?php if ($Page->SortUrl($Page->nombreactividad) == "") { ?>
		<div class="ewTableHeaderBtn actividad_nombreactividad">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombreactividad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_nombreactividad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombreactividad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombreactividad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombrelocal"><div class="actividad_nombrelocal"><span class="ewTableHeaderCaption"><?php echo $Page->nombrelocal->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombrelocal">
<?php if ($Page->SortUrl($Page->nombrelocal) == "") { ?>
		<div class="ewTableHeaderBtn actividad_nombrelocal">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombrelocal->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_nombrelocal" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombrelocal) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombrelocal->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="direccionlocal"><div class="actividad_direccionlocal"><span class="ewTableHeaderCaption"><?php echo $Page->direccionlocal->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="direccionlocal">
<?php if ($Page->SortUrl($Page->direccionlocal) == "") { ?>
		<div class="ewTableHeaderBtn actividad_direccionlocal">
			<span class="ewTableHeaderCaption"><?php echo $Page->direccionlocal->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_direccionlocal" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->direccionlocal) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->direccionlocal->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="fecha_inicio"><div class="actividad_fecha_inicio"><span class="ewTableHeaderCaption"><?php echo $Page->fecha_inicio->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="fecha_inicio">
<?php if ($Page->SortUrl($Page->fecha_inicio) == "") { ?>
		<div class="ewTableHeaderBtn actividad_fecha_inicio">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_inicio->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_fecha_inicio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fecha_inicio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_inicio->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="fecha_fin"><div class="actividad_fecha_fin"><span class="ewTableHeaderCaption"><?php echo $Page->fecha_fin->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="fecha_fin">
<?php if ($Page->SortUrl($Page->fecha_fin) == "") { ?>
		<div class="ewTableHeaderBtn actividad_fecha_fin">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_fin->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_fecha_fin" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fecha_fin) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_fin->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="horasprogramadas"><div class="actividad_horasprogramadas"><span class="ewTableHeaderCaption"><?php echo $Page->horasprogramadas->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="horasprogramadas">
<?php if ($Page->SortUrl($Page->horasprogramadas) == "") { ?>
		<div class="ewTableHeaderBtn actividad_horasprogramadas">
			<span class="ewTableHeaderCaption"><?php echo $Page->horasprogramadas->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_horasprogramadas" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->horasprogramadas) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->horasprogramadas->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_persona"><div class="actividad_id_persona"><span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_persona">
<?php if ($Page->SortUrl($Page->id_persona) == "") { ?>
		<div class="ewTableHeaderBtn actividad_id_persona">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_id_persona" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_persona) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_persona->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="contenido"><div class="actividad_contenido"><span class="ewTableHeaderCaption"><?php echo $Page->contenido->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="contenido">
<?php if ($Page->SortUrl($Page->contenido) == "") { ?>
		<div class="ewTableHeaderBtn actividad_contenido">
			<span class="ewTableHeaderCaption"><?php echo $Page->contenido->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_contenido" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->contenido) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->contenido->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="observaciones"><div class="actividad_observaciones"><span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="observaciones">
<?php if ($Page->SortUrl($Page->observaciones) == "") { ?>
		<div class="ewTableHeaderBtn actividad_observaciones">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_observaciones" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->observaciones) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_centro"><div class="actividad_id_centro"><span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_centro">
<?php if ($Page->SortUrl($Page->id_centro) == "") { ?>
		<div class="ewTableHeaderBtn actividad_id_centro">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer actividad_id_centro" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_centro) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
...
<?php } ?>
<?php if ($Page->id_tipoactividad->Visible) { ?>
		<td data-field="id_tipoactividad"<?php echo $Page->id_tipoactividad->CellAttributes() ?>>
<span<?php echo $Page->id_tipoactividad->ViewAttributes() ?>><?php echo $Page->id_tipoactividad->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->organizador->Visible) { ?>
...
<?php include "actividadrptpager.php" ?>
