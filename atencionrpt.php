...
<?php include_once "atencionrptinfo.php" ?>
<?php
...
$atencion_rpt = NULL; // Initialize page object first

class cratencion_rpt extends cratencion {
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'atencion', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fatencionrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'atencion');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_atencion\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_atencion',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fatencionrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fatencionrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fatencionrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($atencion_rpt)) $atencion_rpt = new cratencion_rpt();
...
// Create page object
var atencion_rpt = new ewr_Page("atencion_rpt");

// Page properties
atencion_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = atencion_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_atencion" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="atencion_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn atencion_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer atencion_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_neonato"><div class="atencion_id_neonato"><span class="ewTableHeaderCaption"><?php echo $Page->id_neonato->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_neonato">
<?php if ($Page->SortUrl($Page->id_neonato) == "") { ?>
		<div class="ewTableHeaderBtn atencion_id_neonato">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_neonato->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer atencion_id_neonato" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_neonato) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_neonato->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_otros"><div class="atencion_id_otros"><span class="ewTableHeaderCaption"><?php echo $Page->id_otros->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_otros">
<?php if ($Page->SortUrl($Page->id_otros) == "") { ?>
		<div class="ewTableHeaderBtn atencion_id_otros">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_otros->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer atencion_id_otros" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_otros) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_otros->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_escolar"><div class="atencion_id_escolar"><span class="ewTableHeaderCaption"><?php echo $Page->id_escolar->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_escolar">
<?php if ($Page->SortUrl($Page->id_escolar) == "") { ?>
		<div class="ewTableHeaderBtn atencion_id_escolar">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_escolar->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer atencion_id_escolar" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_escolar) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_escolar->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_especialista"><div class="atencion_id_especialista"><span class="ewTableHeaderCaption"><?php echo $Page->id_especialista->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_especialista">
<?php if ($Page->SortUrl($Page->id_especialista) == "") { ?>
		<div class="ewTableHeaderBtn atencion_id_especialista">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_especialista->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer atencion_id_especialista" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_especialista) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_especialista->FldCaption() ?></span>
...
<?php include "atencionrptpager.php" ?>
