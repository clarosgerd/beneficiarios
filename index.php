...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'Report Neonatal'))
			$this->Page_Terminate("Report_Neonatallist.php");
		if ($Security->AllowList(CurrentProjectID() . 'Reporte Neontal'))
			$this->Page_Terminate("Reporte_Neontalreport.php");
