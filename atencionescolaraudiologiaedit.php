...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_escolar"><?php echo (strval($atencionescolaraudiologia->id_escolar->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $atencionescolaraudiologia->id_escolar->ViewValue); ?></span>
</span>
...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_especialista"><?php echo (strval($atencionescolaraudiologia->id_especialista->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $atencionescolaraudiologia->id_especialista->ViewValue); ?></span>
</span>
