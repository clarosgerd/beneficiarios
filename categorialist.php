...
<?php
	...
	if ($categoria->CurrentAction == "" && $categoria_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$categoria_list->setWarningMessage(ew_DeniedMsg());
...
?>
<?php if ($categoria->id->Visible) { // id ?>
	<?php if ($categoria->SortUrl($categoria->id) == "") { ?>
		<th data-name="id" class="<?php echo $categoria->id->HeaderCellClass() ?>"><div id="elh_categoria_id" class="categoria_id"><div class="ewTableHeaderCaption"><?php echo $categoria->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $categoria->id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $categoria->SortUrl($categoria->id) ?>',2);"><div id="elh_categoria_id" class="categoria_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $categoria->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($categoria->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($categoria->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($categoria->nombre->Visible) { // nombre ?>
	<?php if ($categoria->SortUrl($categoria->nombre) == "") { ?>
		<th data-name="nombre" class="<?php echo $categoria->nombre->HeaderCellClass() ?>"><div id="elh_categoria_nombre" class="categoria_nombre"><div class="ewTableHeaderCaption"><?php echo $categoria->nombre->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nombre" class="<?php echo $categoria->nombre->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $categoria->SortUrl($categoria->nombre) ?>',2);"><div id="elh_categoria_nombre" class="categoria_nombre">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $categoria->nombre->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($categoria->nombre->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($categoria->nombre->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($categoria->id->Visible) { // id ?>
		<td data-name="id"<?php echo $categoria->id->CellAttributes() ?>>
<span id="el<?php echo $categoria_list->RowCnt ?>_categoria_id" class="categoria_id">
<span<?php echo $categoria->id->ViewAttributes() ?>>
<?php echo $categoria->id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($categoria->nombre->Visible) { // nombre ?>
		<td data-name="nombre"<?php echo $categoria->nombre->CellAttributes() ?>>
<span id="el<?php echo $categoria_list->RowCnt ?>_categoria_nombre" class="categoria_nombre">
