...
//
class crcentros extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('centros', 'centros', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombreinstitucion
		$this->nombreinstitucion = new crField('centros', 'centros', 'x_nombreinstitucion', 'nombreinstitucion', '`nombreinstitucion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ciudad
		$this->ciudad = new crField('centros', 'centros', 'x_ciudad', 'ciudad', '`ciudad`', 200, EWR_DATATYPE_STRING, -1);
		...
		// municipio
		$this->municipio = new crField('centros', 'centros', 'x_municipio', 'municipio', '`municipio`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// provincia
		$this->provincia = new crField('centros', 'centros', 'x_provincia', 'provincia', '`provincia`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// direccion
		$this->direccion = new crField('centros', 'centros', 'x_direccion', 'direccion', '`direccion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// telefono
		$this->telefono = new crField('centros', 'centros', 'x_telefono', 'telefono', '`telefono`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_persona
		$this->id_persona = new crField('centros', 'centros', 'x_id_persona', 'id_persona', '`id_persona`', 3, EWR_DATATYPE_NUMBER, -1);
