...
//
class cunidadeducativa extends cTable {
	var $id;
	var $nombre;
	var $codigo_sie;
	var $departamento;
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "`unidadeducativa`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('unidadeducativa', 'unidadeducativa', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nombre
		$this->nombre = new cField('unidadeducativa', 'unidadeducativa', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre->Sortable = TRUE; // Allow sort
		$this->fields['nombre'] = &$this->nombre;

		// codigo_sie
		$this->codigo_sie = new cField('unidadeducativa', 'unidadeducativa', 'x_codigo_sie', 'codigo_sie', '`codigo_sie`', '`codigo_sie`', 200, -1, FALSE, '`codigo_sie`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->codigo_sie->Sortable = TRUE; // Allow sort
		$this->fields['codigo_sie'] = &$this->codigo_sie;

		// departamento
		$this->departamento = new cField('unidadeducativa', 'unidadeducativa', 'x_departamento', 'departamento', '`departamento`', '`departamento`', 3, -1, FALSE, '`departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// municipio
		$this->municipio = new cField('unidadeducativa', 'unidadeducativa', 'x_municipio', 'municipio', '`municipio`', '`municipio`', 3, -1, FALSE, '`municipio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// provincia
		$this->provincia = new cField('unidadeducativa', 'unidadeducativa', 'x_provincia', 'provincia', '`provincia`', '`provincia`', 3, -1, FALSE, '`provincia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// direccion
		$this->direccion = new cField('unidadeducativa', 'unidadeducativa', 'x_direccion', 'direccion', '`direccion`', '`direccion`', 200, -1, FALSE, '`direccion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->direccion->Sortable = TRUE; // Allow sort
		$this->fields['direccion'] = &$this->direccion;

		// telefono
		$this->telefono = new cField('unidadeducativa', 'unidadeducativa', 'x_telefono', 'telefono', '`telefono`', '`telefono`', 200, -1, FALSE, '`telefono`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->telefono->Sortable = TRUE; // Allow sort
		$this->fields['telefono'] = &$this->telefono;

		// email
		$this->_email = new cField('unidadeducativa', 'unidadeducativa', 'x__email', 'email', '`email`', '`email`', 200, -1, FALSE, '`email`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_email->Sortable = TRUE; // Allow sort
		$this->_email->FldDefaultErrMsg = $Language->Phrase("IncorrectEmail");
		$this->fields['email'] = &$this->_email;

		// id_persona
		$this->id_persona = new cField('unidadeducativa', 'unidadeducativa', 'x_id_persona', 'id_persona', '`id_persona`', '`id_persona`', 3, -1, FALSE, '`EV__id_persona`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_centro
		$this->id_centro = new cField('unidadeducativa', 'unidadeducativa', 'x_id_centro', 'id_centro', '`id_centro`', '`id_centro`', 3, -1, FALSE, '`id_centro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "unidadeducativalist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "unidadeducativaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "unidadeducativaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("unidadeducativaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("unidadeducativaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "unidadeducativaadd.php?" . $this->UrlParm($parm);
		else
			$url = "unidadeducativaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("unidadeducativaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("unidadeducativaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("unidadeducativadelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->codigo_sie->EditValue = $this->codigo_sie->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->codigo_sie->Exportable) $Doc->ExportCaption($this->codigo_sie);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->codigo_sie->Exportable) $Doc->ExportField($this->codigo_sie);
