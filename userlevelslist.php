...
<?php if ($userlevels->userlevelid->Visible) { // userlevelid ?>
	...
	<?php } else { ?>
		<th data-name="userlevelid" class="<?php echo $userlevels->userlevelid->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->userlevelid) ?>',2);"><div id="elh_userlevels_userlevelid" class="userlevels_userlevelid">
...
<?php if ($userlevels->userlevelname->Visible) { // userlevelname ?>
	...
	<?php } else { ?>
		<th data-name="userlevelname" class="<?php echo $userlevels->userlevelname->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevels->SortUrl($userlevels->userlevelname) ?>',2);"><div id="elh_userlevels_userlevelname" class="userlevels_userlevelname">
