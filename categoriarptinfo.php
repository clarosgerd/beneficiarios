...
//
class crcategoria extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('categoria', 'categoria', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombre
		$this->nombre = new crField('categoria', 'categoria', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
