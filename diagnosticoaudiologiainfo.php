...
$diagnosticoaudiologia = NULL;

//
// Table class for diagnosticoaudiologia
//
class cdiagnosticoaudiologia extends cTable {
	var $id;
	var $id_audiologia;
	...
	function __construct() {
		...
		$this->TableVar = 'diagnosticoaudiologia';
		$this->TableName = 'diagnosticoaudiologia';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`diagnosticoaudiologia`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('diagnosticoaudiologia', 'diagnosticoaudiologia', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_audiologia
		$this->id_audiologia = new cField('diagnosticoaudiologia', 'diagnosticoaudiologia', 'x_id_audiologia', 'id_audiologia', '`id_audiologia`', '`id_audiologia`', 3, -1, FALSE, '`id_audiologia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->id_tipodiagnosticoaudiologia = new cField('diagnosticoaudiologia', 'diagnosticoaudiologia', 'x_id_tipodiagnosticoaudiologia', 'id_tipodiagnosticoaudiologia', '`id_tipodiagnosticoaudiologia`', '`id_tipodiagnosticoaudiologia`', 3, -1, FALSE, '`id_tipodiagnosticoaudiologia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// resultado
		$this->resultado = new cField('diagnosticoaudiologia', 'diagnosticoaudiologia', 'x_resultado', 'resultado', '`resultado`', '`resultado`', 200, -1, FALSE, '`resultado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`diagnosticoaudiologia`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "diagnosticoaudiologialist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "diagnosticoaudiologiaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "diagnosticoaudiologiaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("diagnosticoaudiologiaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("diagnosticoaudiologiaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "diagnosticoaudiologiaadd.php?" . $this->UrlParm($parm);
		else
			$url = "diagnosticoaudiologiaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("diagnosticoaudiologiaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("diagnosticoaudiologiaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("diagnosticoaudiologiadelete.php", $this->UrlParm());
	}
