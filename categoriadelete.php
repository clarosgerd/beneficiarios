...
<?php if ($categoria->id->Visible) { // id ?>
		<th class="<?php echo $categoria->id->HeaderCellClass() ?>"><span id="elh_categoria_id" class="categoria_id"><?php echo $categoria->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($categoria->nombre->Visible) { // nombre ?>
		<th class="<?php echo $categoria->nombre->HeaderCellClass() ?>"><span id="elh_categoria_nombre" class="categoria_nombre"><?php echo $categoria->nombre->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($categoria->id->Visible) { // id ?>
		<td<?php echo $categoria->id->CellAttributes() ?>>
<span id="el<?php echo $categoria_delete->RowCnt ?>_categoria_id" class="categoria_id">
...
<span id="el<?php echo $categoria_delete->RowCnt ?>_categoria_nombre" class="categoria_nombre">
