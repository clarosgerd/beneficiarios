...
define("EW_RANDOM_KEY", 'MvWwAdgFN2D0pjCq', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "benificiaries", "qs" => "`", "qe" => "`");
