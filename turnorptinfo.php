...
//
class crturno extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('turno', 'turno', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// turno
		$this->turno = new crField('turno', 'turno', 'x_turno', 'turno', '`turno`', 200, EWR_DATATYPE_STRING, -1);
		$this->turno->Sortable = TRUE; // Allow sort
		$this->turno->DateFilter = "";
		$this->turno->SqlSelect = "";
		$this->turno->SqlOrderBy = "";
