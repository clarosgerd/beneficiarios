...
//
// Table class for referencia
//
class creferencia extends cTable {
	var $id;
	var $id_medio;
	var $nombrescompleto;
	...
	function __construct() {
		...
		$this->TableVar = 'referencia';
		$this->TableName = 'referencia';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`referencia`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('referencia', 'referencia', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_medio
		$this->id_medio = new cField('referencia', 'referencia', 'x_id_medio', 'id_medio', '`id_medio`', '`id_medio`', 3, -1, FALSE, '`id_medio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->id_medio->Sortable = TRUE; // Allow sort
		$this->id_medio->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->id_medio->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['id_medio'] = &$this->id_medio;

		// nombrescompleto
		$this->nombrescompleto = new cField('referencia', 'referencia', 'x_nombrescompleto', 'nombrescompleto', '`nombrescompleto`', '`nombrescompleto`', 200, -1, FALSE, '`nombrescompleto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombrescompleto->Sortable = TRUE; // Allow sort
		$this->fields['nombrescompleto'] = &$this->nombrescompleto;

		// nombrescentromedico
		$this->nombrescentromedico = new cField('referencia', 'referencia', 'x_nombrescentromedico', 'nombrescentromedico', '`nombrescentromedico`', '`nombrescentromedico`', 200, -1, FALSE, '`nombrescentromedico`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`referencia`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "referenciaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "referenciaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("referenciaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("referenciaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "referenciaadd.php?" . $this->UrlParm($parm);
		else
			$url = "referenciaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("referenciaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("referenciaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("referenciadelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		// id_medio
		$this->id_medio->EditAttrs["class"] = "form-control";
		...
		$this->nombrescompleto->EditValue = $this->nombrescompleto->CurrentValue;
