...
$diagnosticoaudiologia_grid = NULL; // Initialize page object first

class cdiagnosticoaudiologia_grid extends cdiagnosticoaudiologia {
	...
	// Page object name
	var $PageObjName = 'diagnosticoaudiologia_grid';

	// Grid form hidden field names
	var $FormName = 'fdiagnosticoaudiologiagrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["diagnosticoaudiologia"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_id_tipodiagnosticoaudiologia") && $objForm->HasValue("o_id_tipodiagnosticoaudiologia") && $this->id_tipodiagnosticoaudiologia->CurrentValue <> $this->id_tipodiagnosticoaudiologia->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->id_tipodiagnosticoaudiologia->setOldValue($objForm->GetValue("o_id_tipodiagnosticoaudiologia"));
