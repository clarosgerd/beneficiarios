...
$pruebasaudiologia_grid = NULL; // Initialize page object first

class cpruebasaudiologia_grid extends cpruebasaudiologia {
	...
	// Page object name
	var $PageObjName = 'pruebasaudiologia_grid';

	// Grid form hidden field names
	var $FormName = 'fpruebasaudiologiagrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["pruebasaudiologia"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_id_tipopruebasaudiologia") && $objForm->HasValue("o_id_tipopruebasaudiologia") && $this->id_tipopruebasaudiologia->CurrentValue <> $this->id_tipopruebasaudiologia->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_resultado") && $objForm->HasValue("o_resultado") && $this->resultado->CurrentValue <> $this->resultado->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_recomendacion") && $objForm->HasValue("o_recomendacion") && $this->recomendacion->CurrentValue <> $this->recomendacion->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->id_tipopruebasaudiologia->setOldValue($objForm->GetValue("o_id_tipopruebasaudiologia"));
		...
		$this->recomendacion->setOldValue($objForm->GetValue("o_recomendacion"));
