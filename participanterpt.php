...
<?php include_once "participanterptinfo.php" ?>
<?php
...
$participante_rpt = NULL; // Initialize page object first

class crparticipante_rpt extends crparticipante {
	...
	// Page object name
	var $PageObjName = 'participante_rpt';
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'participante', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fparticipanterpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'participante');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fparticipanterpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fparticipanterpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fparticipanterpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['id_sector'] = ewr_Conv($rs->fields('id_sector'), 3);
				$this->FirstRowData['id_actividad'] = ewr_Conv($rs->fields('id_actividad'), 3);
				$this->FirstRowData['id_categoria'] = ewr_Conv($rs->fields('id_categoria'), 3);
				...
				$this->FirstRowData['id_institucion'] = ewr_Conv($rs->fields('id_institucion'), 3);
		...
		if (!$rs->EOF) {
			...
			$this->Val[2] = $this->id_sector->CurrentValue;
			$this->Val[3] = $this->id_actividad->CurrentValue;
			$this->Val[4] = $this->id_categoria->CurrentValue;
			...
			$this->Val[18] = $this->id_institucion->CurrentValue;
			$this->Val[19] = $this->observaciones->CurrentValue;
			$this->Val[20] = $this->id_centro->CurrentValue;
		} else {
			$this->id->setDbValue("");
			$this->id_sector->setDbValue("");
			$this->id_actividad->setDbValue("");
			$this->id_categoria->setDbValue("");
			...
			$this->id_institucion->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->id_sector->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// id_actividad
			$this->id_actividad->ViewValue = $this->id_actividad->CurrentValue;
			$this->id_actividad->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// id_categoria
			$this->id_categoria->ViewValue = $this->id_categoria->CurrentValue;
			$this->id_categoria->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
			...
			$this->id_institucion->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// id_sector
			$CurrentValue = $this->id_sector->CurrentValue;
			$ViewValue = &$this->id_sector->ViewValue;
			$ViewAttrs = &$this->id_sector->ViewAttrs;
			$CellAttrs = &$this->id_sector->CellAttrs;
			$HrefValue = &$this->id_sector->HrefValue;
			$LinkAttrs = &$this->id_sector->LinkAttrs;
			$this->Cell_Rendered($this->id_sector, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);

			// id_actividad
			$CurrentValue = $this->id_actividad->CurrentValue;
			$ViewValue = &$this->id_actividad->ViewValue;
			$ViewAttrs = &$this->id_actividad->ViewAttrs;
			$CellAttrs = &$this->id_actividad->CellAttrs;
			$HrefValue = &$this->id_actividad->HrefValue;
			$LinkAttrs = &$this->id_actividad->LinkAttrs;
			$this->Cell_Rendered($this->id_actividad, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);

			// id_categoria
			$CurrentValue = $this->id_categoria->CurrentValue;
			$ViewValue = &$this->id_categoria->ViewValue;
			$ViewAttrs = &$this->id_categoria->ViewAttrs;
			$CellAttrs = &$this->id_categoria->CellAttrs;
			$HrefValue = &$this->id_categoria->HrefValue;
			$LinkAttrs = &$this->id_categoria->LinkAttrs;
			$this->Cell_Rendered($this->id_categoria, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
			...
			// id_institucion
			$CurrentValue = $this->id_institucion->CurrentValue;
			$ViewValue = &$this->id_institucion->ViewValue;
			$ViewAttrs = &$this->id_institucion->ViewAttrs;
			$CellAttrs = &$this->id_institucion->CellAttrs;
			$HrefValue = &$this->id_institucion->HrefValue;
			$LinkAttrs = &$this->id_institucion->LinkAttrs;
			$this->Cell_Rendered($this->id_institucion, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		if ($this->id_sector->Visible) $this->DtlColumnCount += 1;
		if ($this->id_actividad->Visible) $this->DtlColumnCount += 1;
		if ($this->id_categoria->Visible) $this->DtlColumnCount += 1;
		...
		if ($this->id_institucion->Visible) $this->DtlColumnCount += 1;
...
// Create page object
if (!isset($participante_rpt)) $participante_rpt = new crparticipante_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$participante_rpt;
...
// Create page object
var participante_rpt = new ewr_Page("participante_rpt");

// Page properties
participante_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = participante_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_participante" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="participante_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn participante_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->id_sector->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_sector"><div class="participante_id_sector"><span class="ewTableHeaderCaption"><?php echo $Page->id_sector->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_sector">
<?php if ($Page->SortUrl($Page->id_sector) == "") { ?>
		<div class="ewTableHeaderBtn participante_id_sector">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_sector->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_id_sector" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_sector) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_sector->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_sector->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_sector->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
<?php } ?>
<?php if ($Page->id_actividad->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_actividad"><div class="participante_id_actividad"><span class="ewTableHeaderCaption"><?php echo $Page->id_actividad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_actividad">
<?php if ($Page->SortUrl($Page->id_actividad) == "") { ?>
		<div class="ewTableHeaderBtn participante_id_actividad">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_actividad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_id_actividad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_actividad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_actividad->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_actividad->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_actividad->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
<?php } ?>
<?php if ($Page->id_categoria->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_categoria"><div class="participante_id_categoria"><span class="ewTableHeaderCaption"><?php echo $Page->id_categoria->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_categoria">
<?php if ($Page->SortUrl($Page->id_categoria) == "") { ?>
		<div class="ewTableHeaderBtn participante_id_categoria">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_categoria->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_id_categoria" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_categoria) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_categoria->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_categoria->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_categoria->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="apellidopaterno"><div class="participante_apellidopaterno"><span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="apellidopaterno">
<?php if ($Page->SortUrl($Page->apellidopaterno) == "") { ?>
		<div class="ewTableHeaderBtn participante_apellidopaterno">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_apellidopaterno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellidopaterno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="apellidomaterno"><div class="participante_apellidomaterno"><span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="apellidomaterno">
<?php if ($Page->SortUrl($Page->apellidomaterno) == "") { ?>
		<div class="ewTableHeaderBtn participante_apellidomaterno">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_apellidomaterno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellidomaterno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="participante_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn participante_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="fecha_nacimiento"><div class="participante_fecha_nacimiento"><span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="fecha_nacimiento">
<?php if ($Page->SortUrl($Page->fecha_nacimiento) == "") { ?>
		<div class="ewTableHeaderBtn participante_fecha_nacimiento">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_fecha_nacimiento" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fecha_nacimiento) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="sexo"><div class="participante_sexo"><span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="sexo">
<?php if ($Page->SortUrl($Page->sexo) == "") { ?>
		<div class="ewTableHeaderBtn participante_sexo">
			<span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_sexo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->sexo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ci"><div class="participante_ci"><span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ci">
<?php if ($Page->SortUrl($Page->ci) == "") { ?>
		<div class="ewTableHeaderBtn participante_ci">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_ci" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ci) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nrodiscapacidad"><div class="participante_nrodiscapacidad"><span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nrodiscapacidad">
<?php if ($Page->SortUrl($Page->nrodiscapacidad) == "") { ?>
		<div class="ewTableHeaderBtn participante_nrodiscapacidad">
			<span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_nrodiscapacidad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nrodiscapacidad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="celular"><div class="participante_celular"><span class="ewTableHeaderCaption"><?php echo $Page->celular->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="celular">
<?php if ($Page->SortUrl($Page->celular) == "") { ?>
		<div class="ewTableHeaderBtn participante_celular">
			<span class="ewTableHeaderCaption"><?php echo $Page->celular->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_celular" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->celular) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->celular->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="direcciondomicilio"><div class="participante_direcciondomicilio"><span class="ewTableHeaderCaption"><?php echo $Page->direcciondomicilio->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="direcciondomicilio">
<?php if ($Page->SortUrl($Page->direcciondomicilio) == "") { ?>
		<div class="ewTableHeaderBtn participante_direcciondomicilio">
			<span class="ewTableHeaderCaption"><?php echo $Page->direcciondomicilio->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_direcciondomicilio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->direcciondomicilio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->direcciondomicilio->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ocupacion"><div class="participante_ocupacion"><span class="ewTableHeaderCaption"><?php echo $Page->ocupacion->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ocupacion">
<?php if ($Page->SortUrl($Page->ocupacion) == "") { ?>
		<div class="ewTableHeaderBtn participante_ocupacion">
			<span class="ewTableHeaderCaption"><?php echo $Page->ocupacion->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_ocupacion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ocupacion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ocupacion->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="_email"><div class="participante__email"><span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="_email">
<?php if ($Page->SortUrl($Page->_email) == "") { ?>
		<div class="ewTableHeaderBtn participante__email">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante__email" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->_email) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="cargo"><div class="participante_cargo"><span class="ewTableHeaderCaption"><?php echo $Page->cargo->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="cargo">
<?php if ($Page->SortUrl($Page->cargo) == "") { ?>
		<div class="ewTableHeaderBtn participante_cargo">
			<span class="ewTableHeaderCaption"><?php echo $Page->cargo->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_cargo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->cargo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->cargo->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nivelestudio"><div class="participante_nivelestudio"><span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nivelestudio">
<?php if ($Page->SortUrl($Page->nivelestudio) == "") { ?>
		<div class="ewTableHeaderBtn participante_nivelestudio">
			<span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_nivelestudio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nivelestudio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->id_institucion->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_institucion"><div class="participante_id_institucion"><span class="ewTableHeaderCaption"><?php echo $Page->id_institucion->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_institucion">
<?php if ($Page->SortUrl($Page->id_institucion) == "") { ?>
		<div class="ewTableHeaderBtn participante_id_institucion">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_institucion->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_id_institucion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_institucion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_institucion->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_institucion->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_institucion->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="observaciones"><div class="participante_observaciones"><span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="observaciones">
<?php if ($Page->SortUrl($Page->observaciones) == "") { ?>
		<div class="ewTableHeaderBtn participante_observaciones">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_observaciones" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->observaciones) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_centro"><div class="participante_id_centro"><span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_centro">
<?php if ($Page->SortUrl($Page->id_centro) == "") { ?>
		<div class="ewTableHeaderBtn participante_id_centro">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer participante_id_centro" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_centro) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
...
<?php } ?>
<?php if ($Page->id_sector->Visible) { ?>
		<td data-field="id_sector"<?php echo $Page->id_sector->CellAttributes() ?>>
<span<?php echo $Page->id_sector->ViewAttributes() ?>><?php echo $Page->id_sector->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->id_actividad->Visible) { ?>
		<td data-field="id_actividad"<?php echo $Page->id_actividad->CellAttributes() ?>>
<span<?php echo $Page->id_actividad->ViewAttributes() ?>><?php echo $Page->id_actividad->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->id_categoria->Visible) { ?>
		<td data-field="id_categoria"<?php echo $Page->id_categoria->CellAttributes() ?>>
<span<?php echo $Page->id_categoria->ViewAttributes() ?>><?php echo $Page->id_categoria->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->apellidopaterno->Visible) { ?>
...
<?php } ?>
<?php if ($Page->id_institucion->Visible) { ?>
		<td data-field="id_institucion"<?php echo $Page->id_institucion->CellAttributes() ?>>
<span<?php echo $Page->id_institucion->ViewAttributes() ?>><?php echo $Page->id_institucion->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->observaciones->Visible) { ?>
...
<?php include "participanterptpager.php" ?>
