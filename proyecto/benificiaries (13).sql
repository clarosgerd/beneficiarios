...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2019 at 04:21 PM
...
(7, 'AUDIOLOGIA', '80980446', 2, 1, 1, 'GRAL. ACHA 677', '4259577', 'lily_marcelo@hotmail.com', 15, 3);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewmarcologico`  AS  select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,`estudiante`.`id` AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from (((`estudiante` join `centros` on((`centros`.`id` = `estudiante`.`id_centro`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) in (0,1,2,3,4)) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,0 AS `cuadro1`,`estudiante`.`id` AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from (((`estudiante` join `centros` on((`centros`.`id` = `estudiante`.`id_centro`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (`estudiante`.`discapacidad` = 1) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,`participante`.`id` AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_categoria` = 13) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,`participante`.`id` AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_categoria` = 5) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,`participante`.`id` AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_categoria` = 5) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,`participante`.`id` AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_categoria` = 5) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,`estudiante`.`id` AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from (((`estudiante` join `centros` on((`centros`.`id` = `estudiante`.`id_centro`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (`estudiante`.`discapacidad` = 1) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,`participante`.`id` AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_categoria` = 11) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,`participante`.`id` AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_categoria` = 8) union all select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,`participante`.`id` AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `centros` on((`centros`.`id` = `participante`.`id_centro`))) where (`participante`.`id_sector` = 6) ;
