...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2019 a las 21:20:08
...
(5, 4, 4, 1, 'CENTRO DE ESTUDIANTES', 'AUDIOLOGIA', 'GENERAL ACHA Y SUIPACHA', '2019-04-25', '2019-04-29', '30 MIN POR DIA', 13, 'ELECCIÓN DEL CENTRO DE ESTUDIANTES AUDIOLOGIA', 'NINGUNA', 3),
(6, 4, 1, 1, 'JORNADA PEGADOGICA', 'AUDIOLOGIA', 'GENERAL ACHA Y SUIPACHA', '2019-04-24', '2019-04-24', '4', 14, 'XXXXXXX', 'FACILITADOR ALTERON.....', 3),
...
INSERT INTO `apoderado` (`id`, `parentesco`, `apellidopaterno`, `apellidomaterno`, `nombres`, `ci`, `fechanacimiento`, `sexo`, `direccion`, `celular`, `ocupacion`, `observaciones`, `id_centro`) VALUES
...
--
-- Estructura Stand-in para la vista `atencionescolaraudiologia`
--
...
--
-- Estructura Stand-in para la vista `atencionneonatoaudiologia`
--
...
--
-- Estructura Stand-in para la vista `atencionotrosaudiologia`
--
...
--
-- Estructura de tabla para la tabla `audiologia`
--
...
--
-- Volcado de datos para la tabla `audiologia`
--
...
--
-- Estructura de tabla para la tabla `diagnosticoaudiologia`
--
...
--
-- Volcado de datos para la tabla `diagnosticoaudiologia`
--
...
(1, 2, 1, 1, 7, 'Arevalo', 'Guayacuma', 'Miguel Mateo', 'Xxxxxx', '15670725', '2004-02-08', 'MASCULINO', 1, 4, 'VBBXB', NULL, '8098044620198087', 3, 1, 2018, 1, '2019-10-31'),
(2, 2, 1, 1, 7, 'Paz', 'Lupe', 'Erick', 'Xxxxx', '15201417', '2013-01-11', 'MASCULINO', 1, 4, 'VBBXB', NULL, '8098044620166947', 3, 1, 2018, 1, '2019-10-31'),
(3, 2, 1, 1, 7, 'Rios', 'Carrión', 'Miguel Jhudid', '03-2014012JMRC', '15072278', '2014-01-20', 'MASCULINO', 1, 4, 'VBBXB', NULL, '8098044620186900', 3, 1, 2018, 1, '2019-10-31'),
(4, 2, 1, 1, 7, 'Zurita', 'Cuba', 'Damián Fernando', 'Xxxx', '14992163', '2013-04-19', 'MASCULINO', 1, 4, 'gfdgdf', NULL, '8098044620195001', 3, 1, 2018, 1, '2019-10-31'),
(5, 2, 1, 1, 7, 'Toledo', 'Dorado', 'Reyna', 'Xxxx', '15607858', '2015-05-14', 'FEMENINO', 1, 4, 'VBBXB', NULL, '809804462019513', 3, 1, 2018, 1, '2019-10-31'),
(6, 2, 1, 1, 7, 'Gonzales', 'Salazar', 'Kendra Thais', 'Xxxx', 'Xxxxx', '2015-09-06', 'FEMENINO', 1, 4, 'VBBXB', NULL, '809800452018081', 3, 1, 2018, 1, '2019-10-31'),
(7, 2, 1, 1, 7, 'Huaranca', 'Cáceres', 'Abril Adriana', 'Xxxx', '14645960', '2013-02-09', 'FEMENINO', 1, 6, NULL, NULL, '809804462016471', 3, 2, 0, 1, '2019-10-31'),
(8, 2, 3, 2, 7, 'Guardia', 'Cadima', 'Jhosua', '03-20120801JGC', '12811234', '2012-08-01', 'MASCULINO', 1, 4, NULL, NULL, '809804092017027', 3, 2, 0, 1, '2019-10-31'),
(9, 2, 1, 1, 7, 'Sanchez', 'Huanca', 'Jhessica', '03-20100909JSH', '14818438', '2010-09-09', 'FEMENINO', 2, 4, NULL, NULL, '8089011720174024', 3, 2, 0, 1, '2019-10-31'),
(10, 2, 1, 1, 7, 'Avalos', 'Quisbert', 'Katherine', '03-20110922KAQ', '14265014', '2011-09-22', 'FEMENINO', 1, 4, NULL, NULL, '8098044620168391', 3, 3, 0, 1, '2019-10-31'),
(11, 2, 1, 1, 7, 'Garnica', 'Huanca', 'Diana Evelin', '03/20100115DGH', '14265317', '2010-01-15', 'FEMENINO', 1, 6, NULL, NULL, '8098044620168310', 3, 3, 0, 1, '2019-10-31'),
(12, 2, 3, 2, 7, 'Mercado', 'Calle', 'Noemi', '03-20110522NMC', '13256487', '2011-05-22', 'FEMENINO', 1, 4, NULL, NULL, '8098044620175271', 3, 3, 0, 1, '2019-10-31'),
(13, 2, 1, 1, 7, 'Xxxxx', 'Tapia', 'Samuel Alejandro', 'Xxxx', 'Xxxxx', '2008-06-06', 'MASCULINO', 1, 4, NULL, NULL, '809804462014262', 3, 3, 0, 1, '2019-10-31'),
(14, 2, 3, 2, 7, 'Huanca', 'Chipana', 'Juana', '03-20101124JHC', '12812507', '2010-11-24', 'FEMENINO', 1, 4, NULL, NULL, '8098044620165345', 3, 3, 0, 1, '2019-10-31'),
(15, 2, 1, 1, 7, 'Teran', 'Maturano', 'Fabricio Lautaro', '03-20110826FTM', '14812536', '2011-08-28', 'MASCULINO', 1, 4, NULL, NULL, '809801992017026', 3, 3, 0, 1, '2019-10-31'),
(16, 2, 3, 2, 7, 'Alejo', 'Condori', 'Camila', 'Xxxx', '14852636', '2009-07-10', 'FEMENINO', 1, 4, 'SDFSD', NULL, '8089044620169844', 3, 4, 0, 1, '2019-10-31'),
(17, 2, 2, 7, 7, 'Arévalo', 'Garcia', 'Eloyda', '03-20100604EAG', '9849916', '2010-07-04', 'FEMENINO', 1, 4, 'SDFSD', NULL, '8098044620165510', 3, 4, 0, 1, '2019-10-31'),
(18, 2, 1, 1, 7, 'Calle', 'Villcarani', 'Nico! Wendy', 'Xxxx', '14093700', '2009-08-30', 'FEMENINO', 1, 4, 'SDFSD', NULL, '8098044620167484', 3, 4, 0, 1, '2019-10-31'),
(19, 2, 1, 1, 7, 'Choque', 'Martinez', 'Kevin Marcelo', '03-20081007KCM', '9493960', '2008-10-07', 'MASCULINO', 1, 4, 'SDFSD', NULL, '80980446201459', 3, 4, 0, 1, '2019-10-31'),
(20, 2, 1, 1, 7, 'Mamani', 'Rojas', 'David Alejandro', '03-20110629DMR', '13418485', '2011-08-29', 'MASCULINO', 1, 4, 'SDFSD', NULL, '80980446201488', 3, 4, 0, 1, '2019-10-31'),
(21, 2, 1, 1, 7, 'Saenez', 'Flores', 'Cristhian Ronaldo', '03-20080704CSF', '13528952', '2009-07-04', 'MASCULINO', 1, 4, 'SDFSD', NULL, '80980446201442', 3, 4, 0, 1, '2019-10-31'),
(22, 2, 1, 1, 7, 'Vallejos', 'Mamani', 'Sara', '03-20060816SVM', '13623808', '2006-08-16', 'FEMENINO', 1, 4, 'SDFSD', NULL, '8098044620167387', 3, 4, 0, 1, '2019-10-31'),
(23, 2, 1, 1, 7, 'Santillan', 'López', 'Hugo Daniel', 'Xxxx', '12442356', '2010-11-14', 'MASCULINO', 1, 4, 'SDFSD', NULL, '80980324201596', 3, 4, 0, 1, '2019-10-31'),
(24, 2, 1, 1, 7, 'Corrales', 'Vargas', 'José Miguel', 'Xxxx', 'Xxxxx', '2009-08-15', 'MASCULINO', 1, 4, 'SDFSD', NULL, '819802742014194', 3, 4, 0, 1, '2019-10-31'),
(25, 2, 1, 1, 7, 'Xxxxx', 'Miranda', 'Alvaro', 'Xxxx', '14093039', '2007-05-09', 'MASCULINO', 1, 4, NULL, NULL, '8098044620161456', 3, 5, 0, 1, '2019-10-31'),
(26, 2, 1, 1, 7, 'Aguilar', 'Yampa', 'Carlos Gerardo', 'Xxxxx', 'Xxxxx', '2006-12-01', 'MASCULINO', 1, 6, NULL, NULL, '80980446201413', 3, 5, 0, 1, '2019-10-31'),
(27, 2, 1, 1, 7, 'Escalera', 'Choque', 'Martin', 'Xxxxx', 'Xxxx', '2006-07-27', 'MASCULINO', 1, 6, NULL, NULL, '8098044620166997', 3, 5, 0, 1, '2019-10-31'),
(28, 2, 1, 1, 7, 'Pozo', 'Martínez', 'Marcelo Rodolfo', '03-20081209MPM', '9416512', '2008-12-09', 'MASCULINO', 1, 6, NULL, NULL, '809803242013191', 3, 5, 0, 1, '2019-10-31'),
(29, 2, 1, 1, 7, 'Ramirez', 'Perez', 'Mauricio Fernando', '03-20060616MRP', '13001946', '2006-06-16', 'MASCULINO', 1, 4, 'SDFSDFSDF', NULL, '80980446201465', 3, 6, 0, 1, '2019-10-31'),
(30, 2, 1, 1, 7, 'Terrazas', 'Higueras', 'Yessenia Nicol', '03-20090408YTH', '13378613', '2009-04-08', 'MASCULINO', 1, 4, 'SDFSDFSDF', NULL, '8098044620165676', 3, 6, 0, 1, '2019-10-31'),
(31, 2, 1, 1, 7, 'Tola', 'Vallejos', 'Juan Daniel', '03-20090025JTV', '13378422', '2009-03-25', 'MASCULINO', 1, 4, 'SDFSDFSDF', NULL, '809804462016839', 3, 6, 0, 1, '2019-10-31'),
(32, NULL, 1, 1, 7, 'Torrez', 'Reynaga', 'Matías Gerardo', '03-20090924MTR', '13002404', '2009-09-24', 'MASCULINO', 2, 4, 'SDFSDFSDF', NULL, '8098044620139140', 3, 6, 0, 1, '2019-10-31'),
(33, 2, 1, 1, 7, 'Esquivel', 'Canasi', 'Humberto', 'Xxxx', '15129296', '2009-07-04', 'MASCULINO', 1, 4, 'SDFSDFSDF', NULL, '714500012016038', 3, 6, 0, 1, '2019-10-31'),
(34, 2, 1, 1, 7, 'Guzmán', 'Aranibar', 'Sophia Belen', 'Xxxxx', 'Xxxx', '2004-07-26', 'MASCULINO', 1, 4, 'SDFSDFSDF', NULL, '809804742018633', 3, 6, 0, 1, '2019-10-31'),
(35, 2, 1, 1, 7, 'Xxxxx', 'Illanes', 'Jhonatan Cristian', '03-20070425JI', '13226100', '2007-04-25', 'MASCULINO', 1, 4, 'DSDAD', NULL, '80980446201436', 3, 8, 0, 1, '2019-10-31'),
(36, 2, 1, 1, 7, 'Mirabal', 'Chocotea', 'Marializ', '03-20090103MMC', '13289308', '2009-01-03', 'MASCULINO', 1, 4, 'DSDAD', NULL, '8098044620139098', 3, 8, 0, 1, '2019-10-31'),
(37, 2, 1, 1, 7, 'Reynaga', 'Alvarez', 'Etmar Marcelo', '03-20071130ERA', '13260877', '2007-11-30', 'MASCULINO', 1, 4, 'DSDAD', NULL, '8098044620139155', 3, 8, 0, 1, '2019-10-31'),
(38, 2, 1, 1, 7, 'Sossa', 'Cayo', 'José Miguel', 'Xxxx', 'Xxxx', '2003-08-27', 'FEMENINO', 1, 4, 'DSDAD', NULL, '80980446201494', 3, 8, 0, 1, '2019-10-31'),
(39, 2, 1, 1, 7, 'Jiménez', 'Espinoza', 'Jeison Guido', '03-20070321JJE', '13418357', '2007-03-21', 'FEMENINO', 1, 4, NULL, NULL, '71860012201279', 3, 13, 0, 1, '2019-10-31'),
(40, 2, 1, 1, 7, 'Barrientos', 'Segales', 'Cristóbal Alejandro', 'Xxxx', '13228266', '2008-09-11', 'FEMENINO', 1, 4, 'DSDAD', NULL, '80980446201163', 3, 8, 0, 1, '2019-10-31'),
(41, 2, 1, 1, 7, 'Xxxx', 'Chambi', 'Angelica', '03-20070104LC', '12342908', '2007-01-04', 'FEMENINO', 1, 6, 'DSDAD', NULL, '809804462013916A', 3, 8, 0, 1, '2019-10-31'),
(42, 2, 1, 1, 7, 'Anampa', 'Quinteros', 'Leonardo Leonel', 'Xxxx', 'Xxxx', '2006-06-09', 'FEMENINO', 1, 4, 'DSDAD', NULL, '80980446201225', 3, 8, 0, 1, '2019-10-31'),
(43, 2, 1, 1, 7, 'Delgadillo', 'Cerrudo', 'Alejandra', '03-20089110ADC', '9422534', '2006-01-13', 'FEMENINO', 1, 4, 'DSDAD', NULL, '80980446201157', 3, 8, 0, 1, '2019-10-31'),
(44, 2, 1, 1, 7, 'Mamani', 'Rojas', 'Isac', 'Xxx', '8850390', '2005-03-30', 'FEMENINO', 1, 4, 'DSDAD', NULL, '809804462011119', 3, 8, 0, 1, '2019-10-31'),
(45, 2, 1, 1, 7, 'Olivarez', 'Alavi', 'Gabriel Melvin', '03-20051108GOA', '13097801', '2005-11-08', 'FEMENINO', 1, 4, 'DSDAD', NULL, '8098044620139174', 3, 8, 0, 1, '2019-10-31'),
(46, 2, 1, 1, 7, 'Ojeda', 'Bernabe', 'Gabriel', '03-20071208GOB', '12714561', '2007-12-06', 'FEMENINO', 1, 4, 'DSDAD', NULL, '8098044620139189', 3, 8, 0, 1, '2019-10-31'),
(47, 2, 1, 1, 7, 'Cayuba', 'Roca', 'Matilde', 'xxxx', 'Xxxxx', '2004-03-31', 'FEMENINO', 1, 4, 'DSDAD', NULL, '8219013020112193', 3, 8, 0, 1, '2019-10-31');
...
--
-- Estructura de tabla para la tabla `inscripcionestudiante`
--
...
--
-- Volcado de datos para la tabla `inscripcionestudiante`
--

INSERT INTO `inscripcionestudiante` (`id_estudiante`, `id_curso`, `id_gestion`, `fecha`, `esincritoespecial`) VALUES
(1, 1, 2019, '2019-10-31', 1),
(2, 1, 2019, '2019-10-31', 1),
(3, 1, 2019, '2019-10-31', 1),
(4, 2019, 0, '2019-10-31', 1),
(5, 1, 2019, '2019-10-31', 1),
(6, 1, 2019, '2019-10-31', 1),
(7, 2, 2019, '2019-10-31', 1),
(8, 2, 2019, '2019-10-31', 1),
(9, 2, 2019, '2019-10-31', 1),
(10, 3, 2019, '2019-10-31', 1),
(11, 3, 2019, '2019-10-31', 1),
(12, 3, 2019, '2019-10-31', 1),
(13, 3, 2019, '2019-10-31', 1),
(14, 3, 2019, '2019-10-31', 1),
(15, 3, 2019, '2019-10-31', 1),
(16, 4, 2019, '2019-10-31', 1),
(17, 4, 2019, '2019-10-31', 1),
(18, 4, 2019, '2019-10-31', 1),
(19, 4, 2019, '2019-10-31', 1),
(20, 4, 2019, '2019-10-31', 1),
(21, 4, 2019, '2019-10-31', 1),
(22, 4, 2019, '2019-10-31', 1),
(23, 4, 2019, '2019-10-31', 1),
(24, 4, 2019, '2019-10-31', 1),
(25, 5, 2019, '2019-10-31', 1),
(26, 5, 2019, '2019-10-31', 1),
(27, 5, 2019, '2019-10-31', 1),
(28, 5, 2019, '2019-10-31', 1),
(29, 6, 2019, '2019-10-31', 1),
(30, 6, 2019, '2019-10-31', 1),
(31, 6, 2019, '2019-10-31', 1),
(32, 6, 2019, '2019-10-31', 1),
(33, 6, 2019, '2019-10-31', 1),
(34, 6, 2019, '2019-10-31', 1),
(35, 8, 2019, '2019-10-31', 1),
(36, 8, 2019, '2019-10-31', 1),
(37, 8, 2019, '2019-10-31', 1),
(38, 8, 2019, '2019-10-31', 1),
(39, 13, 2019, '2019-10-31', 1),
(40, 8, 2019, '2019-10-31', 1),
(41, 8, 2019, '2019-10-31', 1),
(42, 8, 2019, '2019-10-31', 1),
(43, 8, 2019, '2019-10-31', 1),
(44, 8, 2019, '2019-10-31', 1),
(45, 8, 2019, '2019-10-31', 1),
(46, 8, 2019, '2019-10-31', 1),
(47, 8, 2019, '2019-10-31', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `institucionesdesalud`
--
...
--
-- Volcado de datos para la tabla `institucionesdesalud`
--
...
--
-- Estructura de tabla para la tabla `neonatal`
--
...
--
-- Volcado de datos para la tabla `neonatal`
--
...
--
-- Estructura de tabla para la tabla `otrasorganizaciones`
--
...
--
-- Estructura de tabla para la tabla `pruebasaudiologia`
--
...
--
-- Volcado de datos para la tabla `pruebasaudiologia`
--
...
INSERT INTO `referencia` (`id`, `id_medio`, `nombrescompleto`, `nombrescentromedico`, `direccion`, `telefono`, `id_centro`) VALUES
...
--
-- Estructura de tabla para la tabla `tapon`
--
...
--
-- Volcado de datos para la tabla `tapon`
--
...
--
-- Estructura de tabla para la tabla `tipodiagnosticoaudiologia`
--
...
--
-- Volcado de datos para la tabla `tipodiagnosticoaudiologia`
--
...
--
-- Estructura de tabla para la tabla `tipopruebasaudiologia`
--
...
--
-- Volcado de datos para la tabla `tipopruebasaudiologia`
--
...
--
-- Estructura de tabla para la tabla `tipotratamientoaudiologia`
--
...
--
-- Volcado de datos para la tabla `tipotratamientoaudiologia`
--
...
--
-- Estructura de tabla para la tabla `unidadeducativa`
--
...
CREATE TABLE `unidadeducativa` (
  ...
  `id_persona` int(11) DEFAULT NULL,
  `id_centro` int(11) NOT NULL,
  `esespecial` int(11) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `unidadeducativa`
--

INSERT INTO `unidadeducativa` (`id`, `nombre`, `codigo_sie`, `departamento`, `provincia`, `municipio`, `direccion`, `telefono`, `email`, `id_persona`, `id_centro`, `esespecial`) VALUES
(1, 'Fe y alegria', 'sdfeer2322', 2, 1, 1, 'Atahuallpa', '298', 'carli@gmail.com', 5, 0, 0),
(2, 'Fe y Alegria Sud', 'SDE2324234', 2, 1, 1, 'Av. Suecia', '2424234', 'feyalegriasud@gmail.com', 6, 0, 0),
(3, 'Mariano Terrazas', '7556hjji', 2, 1, 1, 'Aurelio Melean', '765544', 'dsaludP@hotmail.com', 4, 0, 0),
(5, 'XXX llenar Nilda', 'llenar', 2, 4, 10, 'San Benito', '000000', '000@com.bo', 11, 0, 0),
(6, 'Josè Quintín Mendoza', '80980175', 2, 1, 1, 'Baptista y La Paz', '70379913', 'juanmen-300562@hotmail.com', 12, 0, 0),
(7, 'AUDIOLOGIA', '80980446', 2, 1, 1, 'GRAL. ACHA 677', '4259577', 'lily_marcelo@hotmail.com', 15, 3, 1);
...
--
-- Estructura Stand-in para la vista `viewactividad`
--
...
--
-- Estructura Stand-in para la vista `viewdocente`
--
...
--
-- Estructura Stand-in para la vista `viewestudiante`
--
...
--
-- Estructura Stand-in para la vista `viewestudiantecurso`
--
...
--
-- Estructura Stand-in para la vista `viewestudiantesetareo`
--
...
--
-- Estructura Stand-in para la vista `viewestudiantesetareocurso`
--
...
--
-- Estructura Stand-in para la vista `viewmarcologico`
--
...
--
-- Estructura Stand-in para la vista `viewmarcologicosummary`
--
CREATE TABLE `viewmarcologicosummary` (
`nombreinstitucion` varchar(100)
,`fecha` int(4)
,`cuadro1` decimal(23,0)
,`cuadro2` decimal(23,0)
,`cuadro3` decimal(23,0)
,`cuadro4` decimal(23,0)
,`cuadro5` decimal(23,0)
,`cuadro6` decimal(23,0)
,`cuadro7` decimal(23,0)
,`cuadro8` decimal(23,0)
,`cuadro9` decimal(23,0)
,`cuadro10` decimal(23,0)
);

-- --------------------------------------------------------

--
-- Estructura Stand-in para la vista `viewparticipante`
--
...
--
-- Estructura Stand-in para la vista `viewsalsudapoderado`
--
CREATE TABLE `viewsalsudapoderado` (
`nombreinstitucion` varchar(100)
...
--
-- Estructura Stand-in para la vista `viewsaludderivacion`
--
CREATE TABLE `viewsaludderivacion` (
`especialidad` varchar(20)
,`nombreneonatal` varchar(302)
,`nombreescolar` varchar(302)
,`nombreotros` varchar(302)
...
--
-- Estructura Stand-in para la vista `viewsaluddiagnostico`
--
CREATE TABLE `viewsaluddiagnostico` (
`especialidad` varchar(20)
,`nombreneonatal` varchar(302)
,`nombreescolar` varchar(302)
,`nombreotros` varchar(302)
...
--
-- Estructura Stand-in para la vista `viewsaludescolar`
--
CREATE TABLE `viewsaludescolar` (
`codigorude` varchar(100)
,`codigorude_es` varchar(100)
,`fecha` date
,`unidad eductiva` varchar(100)
,`Nombreescolar` varchar(302)
,`ci` varchar(15)
,`nrodiscapacidad` varchar(100)
,`fechanacimiento` date
...
,`tipo` varchar(100)
,`resultado` varchar(100)
,`resultadotamizaje` varchar(100)
,`nombretapon` varchar(100)
,`tapodonde` varchar(100)
,`repetirprueba` varchar(100)
...
--
-- Estructura Stand-in para la vista `viewsaludmarcologico`
--
CREATE TABLE `viewsaludmarcologico` (
`nombreinstitucion` varchar(100)
,`fecha` date
,`cuadro1` bigint(20)
,`cuadro2` bigint(20)
...
--
-- Estructura Stand-in para la vista `viewsaludmarcologicosummary`
--
CREATE TABLE `viewsaludmarcologicosummary` (
`nombreinstitucion` varchar(100)
,`fecha` int(4)
,`cuadro1` decimal(23,0)
,`cuadro2` decimal(23,0)
...
,`cuadro9` decimal(23,0)
,`cuadro10` decimal(23,0)
,`cuadro11` decimal(23,0)
,`cuadro12` decimal(23,0)
,`cuadro13` decimal(23,0)
);

-- --------------------------------------------------------

--
-- Estructura Stand-in para la vista `viewsaludneonatal`
--
CREATE TABLE `viewsaludneonatal` (
`fecha_tamizaje` date
,`nombreinstitucion` varchar(100)
,`nombreneonatal` varchar(302)
,`ci` varchar(100)
...
--
-- Estructura Stand-in para la vista `viewsaludoruebas`
--
CREATE TABLE `viewsaludoruebas` (
`resultado` varchar(100)
,`tipopruebaaudiologia` varchar(100)
...
--
-- Estructura Stand-in para la vista `viewsaludotros`
--
CREATE TABLE `viewsaludotros` (
`nombreactividad` varchar(100)
,`nombreotros` varchar(302)
,`nrodiscapacidad` varchar(100)
,`ci` varchar(100)
...
,`sexo` varchar(100)
,`nivelestudio` varchar(100)
,`discacidad` varchar(100)
,`tipo discapacidad` varchar(100)
,`resultado` varchar(100)
,`resultadotamizaje` varchar(100)
,`tapon` int(11)
,`tipo tapo` varchar(100)
,`repetirprueba` varchar(100)
,`observaciones` varchar(100)
,`parentesco` varchar(100)
,`nombrescompleto` varchar(100)
...
--
-- Estructura Stand-in para la vista `viewsaludreferencia`
--
CREATE TABLE `viewsaludreferencia` (
`nombrescompleto` varchar(100)
,`nombrescentromedico` varchar(100)
,`direccion` int(11)
,`telefono` int(11)
,`nombre` varchar(100)
);
...
--
-- Estructura Stand-in para la vista `viewsaludservicios`
--
CREATE TABLE `viewsaludservicios` (
`nombreespecialista` varchar(302)
,`observaciones` int(11)
,`nombreneonatal` varchar(302)
,`nombreescolar` varchar(302)
,`nombreotros` varchar(302)
,`ticketdeatencion` int(11)
...
--
-- Estructura Stand-in para la vista `viewsaludtratamiento`
--
CREATE TABLE `viewsaludtratamiento` (
`especialidad` varchar(20)
,`nombreneonatal` varchar(302)
,`nombreescolar` varchar(302)
,`nombreotros` varchar(302)
...
--
-- Estructura Stand-in para la vista `viewunidadeducativa`
--
...
,`email` varchar(100)
,`director` varchar(302)
,`cantidadalumnos` bigint(21)
,`cantidadalumnosvaronessi` bigint(21)
,`cantidadalumnosvaronesno` bigint(21)
,`cantidadalumnosmujeressi` bigint(21)
,`cantidadalumnosmujeresno` bigint(21)
);

-- --------------------------------------------------------

--
-- Estructura para la vista `atencionescolaraudiologia`
--
DROP TABLE IF EXISTS `atencionescolaraudiologia`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `atencionescolaraudiologia`  AS  select `atencion`.`id` AS `id`,`atencion`.`id_escolar` AS `id_escolar`,`atencion`.`id_especialista` AS `id_especialista`,`atencion`.`id_referencia` AS `id_referencia` from `atencion` ;

-- --------------------------------------------------------

--
-- Estructura para la vista `atencionneonatoaudiologia`
--
DROP TABLE IF EXISTS `atencionneonatoaudiologia`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `atencionneonatoaudiologia`  AS  select `atencion`.`id` AS `id1`,`atencion`.`id_neonato` AS `id_neonato`,`atencion`.`id_especialista` AS `id_especialista`,`atencion`.`id_referencia` AS `id_referencia` from `atencion` ;

-- --------------------------------------------------------

--
-- Estructura para la vista `atencionotrosaudiologia`
--
DROP TABLE IF EXISTS `atencionotrosaudiologia`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `atencionotrosaudiologia`  AS  select `atencion`.`id` AS `id`,`atencion`.`id_otros` AS `id_otros`,`atencion`.`id_especialista` AS `id_especialista`,`atencion`.`id_referencia` AS `id_referencia` from `atencion` ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewactividad`
--
DROP TABLE IF EXISTS `viewactividad`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewactividad`  AS  select `sector`.`nombre` AS `sector`,`tipoactividad`.`nombre` AS `tipoactividad`,`actividad`.`nombreactividad` AS `nombreactividad`,`actividad`.`nombrelocal` AS `nombrelocal`,`centros`.`nombreinstitucion` AS `nombreinstitucion`,`unidadeducativa`.`nombre` AS `organizador`,`actividad`.`direccionlocal` AS `direccionlocal`,`actividad`.`fecha_inicio` AS `fecha_inicio`,`actividad`.`fecha_fin` AS `fecha_fin`,`actividad`.`horasprogramadas` AS `horasprogramadas`,concat(`persona`.`nombre`,' ',`persona`.`apellidopaterno`,' ',`persona`.`apellidomaterno`) AS `facilitador`,`actividad`.`contenido` AS `contenido`,`actividad`.`observaciones` AS `observaciones` from (((((`actividad` join `sector` on((`sector`.`id` = `actividad`.`id_sector`))) join `tipoactividad` on((`tipoactividad`.`id` = `actividad`.`id_tipoactividad`))) join `persona` on((`persona`.`id` = `actividad`.`id_persona`))) join `centros` on((`centros`.`id` = `actividad`.`id_centro`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `actividad`.`organizador`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewdocente`
--
...
--
-- Estructura para la vista `viewestudiante`
--
DROP TABLE IF EXISTS `viewestudiante`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewestudiante`  AS  select `departamento`.`nombre` AS `departamento`,`estudiante`.`codigorude` AS `codigorude`,`estudiante`.`codigorude_es` AS `codigorude_es`,`municipio`.`descripcion` AS `municipio`,`provincia`.`nombre` AS `provincia`,`unidadeducativa`.`nombre` AS `unidadeducativa`,`estudiante`.`nombres` AS `nombre`,`estudiante`.`apellidomaterno` AS `materno`,`estudiante`.`apellidopaterno` AS `paterno`,`estudiante`.`nrodiscapacidad` AS `nrodiscapacidad`,`estudiante`.`ci` AS `ci`,`estudiante`.`fechanacimiento` AS `fechanacimiento`,timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) AS `edad`,`estudiante`.`sexo` AS `sexo`,`discapacidad`.`nombre` AS `discapacidad`,`tipodiscapacidad`.`nombre` AS `tipodiscapcidad`,`centros`.`nombreinstitucion` AS `nombreinstitucion`,`estudiante`.`observaciones` AS `observaciones`,`curso`.`curso` AS `curso`,`inscripcionestudiante`.`fecha` AS `fecha` from (((((((((`estudiante` join `departamento` on((`departamento`.`id` = `estudiante`.`departamento`))) join `municipio` on((`municipio`.`id` = `estudiante`.`municipio`))) join `provincia` on((`provincia`.`id` = `estudiante`.`provincisa`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `discapacidad` on((`discapacidad`.`id` = `estudiante`.`discapacidad`))) join `tipodiscapacidad` on((`tipodiscapacidad`.`id` = `estudiante`.`tipodiscapacidad`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) join `centros` on((`centros`.`id` = `estudiante`.`id_centro`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewestudiantecurso`
--
DROP TABLE IF EXISTS `viewestudiantecurso`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewestudiantecurso`  AS  select `unidadeducativa`.`nombre` AS `unidadeducativa`,`departamento`.`nombre` AS `departamento`,`provincia`.`nombre` AS `provincia`,`municipio`.`descripcion` AS `municipio`,`estudiante`.`codigorude_es` AS `codigorude_es`,`estudiante`.`nombres` AS `nombre`,`estudiante`.`apellidomaterno` AS `materno`,`estudiante`.`apellidopaterno` AS `paterno`,`estudiante`.`nrodiscapacidad` AS `nrodiscapacidad`,`estudiante`.`ci` AS `ci`,`estudiante`.`fechanacimiento` AS `fechanacimiento`,timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) AS `edad`,`estudiante`.`sexo` AS `sexo`,`discapacidad`.`nombre` AS `discapacidad`,`tipodiscapacidad`.`nombre` AS `tipodiscapcidad`,`centros`.`nombreinstitucion` AS `centro`,`curso`.`curso` AS `curso`,`inscripcionestudiante`.`fecha` AS `fecha` from (((((((((`estudiante` left join `departamento` on((`departamento`.`id` = `estudiante`.`departamento`))) left join `municipio` on((`municipio`.`id` = `estudiante`.`municipio`))) left join `provincia` on((`provincia`.`id` = `estudiante`.`provincisa`))) left join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) left join `discapacidad` on((`discapacidad`.`id` = `estudiante`.`discapacidad`))) left join `tipodiscapacidad` on((`tipodiscapacidad`.`id` = `estudiante`.`tipodiscapacidad`))) left join `centros` on((`centros`.`id` = `estudiante`.`id_centro`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewestudiantesetareo`
--
DROP TABLE IF EXISTS `viewestudiantesetareo`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewestudiantesetareo`  AS  select `unidadeducativa`.`nombre` AS `unidadeducativa`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 else 0 end)) AS `0-3F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 else 0 end)) AS `4-6F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 else 0 end)) AS `7-9F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 else 0 end)) AS `10-12F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 else 0 end)) AS `13-15F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 else 0 end)) AS `16-18F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'FEMENINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'FEMENINO')) then 1 else 0 end)) AS `19F`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 else 0 end)) AS `0-3M`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 else 0 end)) AS `4-6M`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 else 0 end)) AS `7-9M`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 else 0 end)) AS `10-12M`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 else 0 end)) AS `13-15M`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 else 0 end)) AS `16-18M`,sum((case when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 0) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 1) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 2) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 3) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 4) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 5) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 6) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 7) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 8) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 9) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 10) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 11) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 12) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 13) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 14) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 15) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 16) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 17) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) = 18) and (`estudiante`.`sexo` = 'MASCULINO')) then 0 when ((timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) >= 19) and (`estudiante`.`sexo` = 'MASCULINO')) then 1 else 0 end)) AS `19M`,`inscripcionestudiante`.`fecha` AS `fecha` from ((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) group by `unidadeducativa`.`nombre`,`inscripcionestudiante`.`fecha` ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewestudiantesetareocurso`
--
DROP TABLE IF EXISTS `viewestudiantesetareocurso`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewestudiantesetareocurso`  AS  select `estudiante`.`id` AS `id`,`estudiante`.`nombres` AS `nombres`,`estudiante`.`apellidopaterno` AS `apellidopaterno`,`estudiante`.`apellidomaterno` AS `apellidomaterno`,`estudiante`.`codigorude_es` AS `codigorude_es`,`estudiante`.`ci` AS `ci`,`curso`.`curso` AS `curso`,`discapacidad`.`nombre` AS `discapacidad`,`tipodiscapacidad`.`nombre` AS `tipodiscapacidad`,`unidadeducativa`.`nombre` AS `unidadeducativa`,`inscripcionestudiante`.`fecha` AS `fecha` from (((((((((`estudiante` left join `departamento` on((`departamento`.`id` = `estudiante`.`departamento`))) left join `municipio` on((`municipio`.`id` = `estudiante`.`municipio`))) left join `provincia` on((`provincia`.`id` = `estudiante`.`provincisa`))) left join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) left join `discapacidad` on((`discapacidad`.`id` = `estudiante`.`discapacidad`))) left join `tipodiscapacidad` on((`tipodiscapacidad`.`id` = `estudiante`.`tipodiscapacidad`))) left join `centros` on((`centros`.`id` = `estudiante`.`id_centro`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) group by `estudiante`.`id`,`estudiante`.`nombres`,`estudiante`.`apellidopaterno`,`estudiante`.`apellidomaterno`,`estudiante`.`codigorude_es`,`estudiante`.`ci`,`curso`.`curso`,`discapacidad`.`nombre`,`tipodiscapacidad`.`nombre`,`unidadeducativa`.`nombre`,`inscripcionestudiante`.`fecha`,`estudiante`.`curso`,`estudiante`.`codigorude` ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewmarcologico`
--
DROP TABLE IF EXISTS `viewmarcologico`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewmarcologico`  AS  select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,`estudiante`.`id` AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from (((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) in (0,1,2,3,4)) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,0 AS `cuadro1`,`estudiante`.`id` AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from (((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (`estudiante`.`discapacidad` = 1) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,`participante`.`id` AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 13) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,`participante`.`id` AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 5) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,`participante`.`id` AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 5) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,`participante`.`id` AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 5) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,`estudiante`.`id` AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from (((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (`unidadeducativa`.`esespecial` = 1) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,`participante`.`id` AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_categoria` = 11) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,`participante`.`id` AS `cuadro9`,0 AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_categoria` = 8) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,`participante`.`id` AS `cuadro10` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_sector` = 6) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewmarcologicosummary`
--
DROP TABLE IF EXISTS `viewmarcologicosummary`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewmarcologicosummary`  AS  select `viewmarcologico`.`nombreinstitucion` AS `nombreinstitucion`,year(`viewmarcologico`.`fecha`) AS `fecha`,sum((case when (`viewmarcologico`.`cuadro1` > 0) then 1 else 0 end)) AS `cuadro1`,sum((case when (`viewmarcologico`.`cuadro2` > 0) then 1 else 0 end)) AS `cuadro2`,sum((case when (`viewmarcologico`.`cuadro3` > 0) then 1 else 0 end)) AS `cuadro3`,sum((case when (`viewmarcologico`.`cuadro4` > 0) then 1 else 0 end)) AS `cuadro4`,sum((case when (`viewmarcologico`.`cuadro5` > 0) then 1 else 0 end)) AS `cuadro5`,sum((case when (`viewmarcologico`.`cuadro6` > 0) then 1 else 0 end)) AS `cuadro6`,sum((case when (`viewmarcologico`.`cuadro7` > 0) then 1 else 0 end)) AS `cuadro7`,sum((case when (`viewmarcologico`.`cuadro8` > 0) then 1 else 0 end)) AS `cuadro8`,sum((case when (`viewmarcologico`.`cuadro9` > 0) then 1 else 0 end)) AS `cuadro9`,sum((case when (`viewmarcologico`.`cuadro10` > 0) then 1 else 0 end)) AS `cuadro10` from `viewmarcologico` group by `viewmarcologico`.`nombreinstitucion`,year(`viewmarcologico`.`fecha`) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewparticipante`
--
...
--
-- Estructura para la vista `viewsalsudapoderado`
--
DROP TABLE IF EXISTS `viewsalsudapoderado`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsalsudapoderado`  AS  select `centros`.`nombreinstitucion` AS `nombreinstitucion`,`apoderado`.`parentesco` AS `parentesco`,`apoderado`.`apellidopaterno` AS `apellidopaterno`,`apoderado`.`apellidomaterno` AS `apellidomaterno`,`apoderado`.`nombres` AS `nombres`,`apoderado`.`ci` AS `ci`,`apoderado`.`sexo` AS `sexo`,`apoderado`.`fechanacimiento` AS `fechanacimiento`,`apoderado`.`direccion` AS `direccion`,`apoderado`.`celular` AS `celular`,`apoderado`.`ocupacion` AS `ocupacion`,`apoderado`.`observaciones` AS `observaciones` from (`apoderado` join `centros` on((`centros`.`id` = `apoderado`.`id_centro`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludderivacion`
--
DROP TABLE IF EXISTS `viewsaludderivacion`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludderivacion`  AS  select `audiologia`.`especialidad` AS `especialidad`,concat(`neonatal`.`nombre`,' ',`neonatal`.`apellidopaterno`,' ',`neonatal`.`apellidomaterno`) AS `nombreneonatal`,concat(`escolar`.`nombres`,' ',`escolar`.`apellidopaterno`,' ',`escolar`.`apellidomaterno`) AS `nombreescolar`,concat(`otros`.`nombre`,' ',`otros`.`apellidopaterno`,' ',`otros`.`apellidomaterno`) AS `nombreotros`,`derivacion`.`tipoderivacion` AS `derivacion` from ((((`audiologia` left join `escolar` on((`escolar`.`id` = `audiologia`.`id_escolar`))) left join `otros` on((`otros`.`id` = `audiologia`.`id_otros`))) left join `neonatal` on((`neonatal`.`id` = `audiologia`.`id_neonato`))) left join `derivacion` on((`derivacion`.`id_audiologia` = `audiologia`.`id`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaluddiagnostico`
--
DROP TABLE IF EXISTS `viewsaluddiagnostico`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaluddiagnostico`  AS  select `audiologia`.`especialidad` AS `especialidad`,concat(`neonatal`.`nombre`,' ',`neonatal`.`apellidopaterno`,' ',`neonatal`.`apellidomaterno`) AS `nombreneonatal`,concat(`escolar`.`nombres`,' ',`escolar`.`apellidopaterno`,' ',`escolar`.`apellidomaterno`) AS `nombreescolar`,concat(`otros`.`nombre`,' ',`otros`.`apellidopaterno`,' ',`otros`.`apellidomaterno`) AS `nombreotros`,`diagnosticoaudiologia`.`resultado` AS `resultado`,`tipodiagnosticoaudiologia`.`nombre` AS `diagnostico` from (((((`audiologia` left join `escolar` on((`escolar`.`id` = `audiologia`.`id_escolar`))) left join `otros` on((`otros`.`id` = `audiologia`.`id_otros`))) left join `neonatal` on((`neonatal`.`id` = `audiologia`.`id_neonato`))) left join `diagnosticoaudiologia` on((`diagnosticoaudiologia`.`id_audiologia` = `audiologia`.`id`))) left join `tipodiagnosticoaudiologia` on((`tipodiagnosticoaudiologia`.`id` = `diagnosticoaudiologia`.`id_tipodiagnosticoaudiologia`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludescolar`
--
DROP TABLE IF EXISTS `viewsaludescolar`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludescolar`  AS  select `escolar`.`codigorude` AS `codigorude`,`escolar`.`codigorude_es` AS `codigorude_es`,`escolar`.`fecha` AS `fecha`,`unidadeducativa`.`nombre` AS `unidad eductiva`,concat(`escolar`.`nombres`,' ',`escolar`.`apellidopaterno`,' ',`escolar`.`apellidomaterno`) AS `Nombreescolar`,`escolar`.`ci` AS `ci`,`escolar`.`nrodiscapacidad` AS `nrodiscapacidad`,`escolar`.`fechanacimiento` AS `fechanacimiento`,`escolar`.`sexo` AS `sexo`,`curso`.`curso` AS `curso`,`discapacidad`.`nombre` AS `discapcidad`,`tipodiscapacidad`.`nombre` AS `tipo`,`escolar`.`resultado` AS `resultado`,`escolar`.`resultadotamizaje` AS `resultadotamizaje`,`tapon`.`nombre` AS `nombretapon`,`escolar`.`tapodonde` AS `tapodonde`,`escolar`.`repetirprueba` AS `repetirprueba`,`escolar`.`observaciones` AS `observaciones`,`apoderado`.`parentesco` AS `parentesco`,`referencia`.`nombrescompleto` AS `nombrescompleto` from (((((((`escolar` left join `unidadeducativa` on((`unidadeducativa`.`id` = `escolar`.`unidadeducativa`))) left join `curso` on((`curso`.`id` = `escolar`.`curso`))) left join `discapacidad` on((`discapacidad`.`id` = `escolar`.`id_discapacidad`))) left join `tipodiscapacidad` on((`tipodiscapacidad`.`id` = `escolar`.`id_tipodiscapacidad`))) left join `tapon` on((`tapon`.`id` = `escolar`.`tapon`))) left join `apoderado` on((`apoderado`.`id` = `escolar`.`id_apoderado`))) left join `referencia` on((`referencia`.`id` = `escolar`.`id_referencia`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludmarcologico`
--
DROP TABLE IF EXISTS `viewsaludmarcologico`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludmarcologico`  AS  select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,`estudiante`.`id` AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from (((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (timestampdiff(YEAR,`estudiante`.`fechanacimiento`,curdate()) in (0,1,2,3,4)) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,0 AS `cuadro1`,`estudiante`.`id` AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from (((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (`estudiante`.`discapacidad` = 1) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,`participante`.`id` AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 13) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,`participante`.`id` AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 5) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,`participante`.`id` AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 5) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,`participante`.`id` AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_actividad`))) where (`participante`.`id_categoria` = 5) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`inscripcionestudiante`.`fecha` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,`estudiante`.`id` AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from (((`estudiante` join `unidadeducativa` on((`unidadeducativa`.`id` = `estudiante`.`unidadeducativa`))) join `inscripcionestudiante` on((`inscripcionestudiante`.`id_estudiante` = `estudiante`.`id`))) join `curso` on((`inscripcionestudiante`.`id_curso` = `curso`.`id`))) where (`unidadeducativa`.`esespecial` = 1) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,`participante`.`id` AS `cuadro8`,0 AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_categoria` = 11) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,`participante`.`id` AS `cuadro9`,0 AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_categoria` = 8) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,`participante`.`id` AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_sector` = 6) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,`participante`.`id` AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_sector` = 6) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,`participante`.`id` AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_sector` = 6) union all select `unidadeducativa`.`nombre` AS `nombreinstitucion`,`actividad`.`fecha_fin` AS `fecha`,0 AS `cuadro1`,0 AS `cuadro2`,0 AS `cuadro3`,0 AS `cuadro4`,0 AS `cuadro5`,0 AS `cuadro6`,0 AS `cuadro7`,0 AS `cuadro8`,0 AS `cuadro9`,`participante`.`id` AS `cuadro10`,0 AS `cuadro11`,0 AS `cuadro12`,0 AS `cuadro13` from ((`actividad` join `participante` on((`actividad`.`id` = `participante`.`id_actividad`))) join `unidadeducativa` on((`unidadeducativa`.`id` = `participante`.`id_institucion`))) where (`participante`.`id_sector` = 6) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludmarcologicosummary`
--
DROP TABLE IF EXISTS `viewsaludmarcologicosummary`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludmarcologicosummary`  AS  select `viewsaludmarcologico`.`nombreinstitucion` AS `nombreinstitucion`,year(`viewsaludmarcologico`.`fecha`) AS `fecha`,sum((case when (`viewsaludmarcologico`.`cuadro1` > 0) then 1 else 0 end)) AS `cuadro1`,sum((case when (`viewsaludmarcologico`.`cuadro2` > 0) then 1 else 0 end)) AS `cuadro2`,sum((case when (`viewsaludmarcologico`.`cuadro3` > 0) then 1 else 0 end)) AS `cuadro3`,sum((case when (`viewsaludmarcologico`.`cuadro4` > 0) then 1 else 0 end)) AS `cuadro4`,sum((case when (`viewsaludmarcologico`.`cuadro5` > 0) then 1 else 0 end)) AS `cuadro5`,sum((case when (`viewsaludmarcologico`.`cuadro6` > 0) then 1 else 0 end)) AS `cuadro6`,sum((case when (`viewsaludmarcologico`.`cuadro7` > 0) then 1 else 0 end)) AS `cuadro7`,sum((case when (`viewsaludmarcologico`.`cuadro8` > 0) then 1 else 0 end)) AS `cuadro8`,sum((case when (`viewsaludmarcologico`.`cuadro9` > 0) then 1 else 0 end)) AS `cuadro9`,sum((case when (`viewsaludmarcologico`.`cuadro10` > 0) then 1 else 0 end)) AS `cuadro10`,sum((case when (`viewsaludmarcologico`.`cuadro11` > 0) then 1 else 0 end)) AS `cuadro11`,sum((case when (`viewsaludmarcologico`.`cuadro12` > 0) then 1 else 0 end)) AS `cuadro12`,sum((case when (`viewsaludmarcologico`.`cuadro13` > 0) then 1 else 0 end)) AS `cuadro13` from `viewsaludmarcologico` group by `viewsaludmarcologico`.`nombreinstitucion`,year(`viewsaludmarcologico`.`fecha`) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludneonatal`
--
DROP TABLE IF EXISTS `viewsaludneonatal`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludneonatal`  AS  select `neonatal`.`fecha_tamizaje` AS `fecha_tamizaje`,`institucionesdesalud`.`nombre` AS `nombreinstitucion`,concat(`neonatal`.`nombre`,' ',`neonatal`.`apellidopaterno`,' ',`neonatal`.`apellidomaterno`) AS `nombreneonatal`,`neonatal`.`ci` AS `ci`,`neonatal`.`fecha_nacimiento` AS `fecha_nacimiento`,`neonatal`.`dias` AS `dias`,`neonatal`.`semanas` AS `semanas`,`neonatal`.`meses` AS `meses`,`neonatal`.`sexo` AS `sexo`,`discapacidad`.`nombre` AS `discapacidad`,`tipodiscapacidad`.`nombre` AS `tipodiscapacidad`,`neonatal`.`resultado` AS `resultado`,`neonatal`.`resultadotamizaje` AS `resultadotamizaje`,`neonatal`.`tapon` AS `tapon`,`neonatal`.`tipo` AS `tipotapo`,`neonatal`.`repetirprueba` AS `repetirprueba`,`neonatal`.`observaciones` AS `observaciones`,`apoderado`.`parentesco` AS `parentesco`,`referencia`.`nombrescompleto` AS `nombrescompleto` from (((((`neonatal` left join `institucionesdesalud` on((`institucionesdesalud`.`id` = `neonatal`.`id_centro`))) left join `discapacidad` on((`discapacidad`.`id` = `neonatal`.`discapacidad`))) left join `tipodiscapacidad` on((`tipodiscapacidad`.`id` = `neonatal`.`id_tipodiscapacidad`))) left join `apoderado` on((`apoderado`.`id` = `neonatal`.`id_apoderado`))) left join `referencia` on((`referencia`.`id` = `neonatal`.`id_referencia`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludoruebas`
--
DROP TABLE IF EXISTS `viewsaludoruebas`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludoruebas`  AS  select `pruebasaudiologia`.`resultado` AS `resultado`,`tipopruebasaudiologia`.`nombre` AS `tipopruebaaudiologia`,`pruebasaudiologia`.`recomendacion` AS `recomendacion`,`audiologia`.`especialidad` AS `especialidad`,concat(`neonatal`.`nombre`,' ',`neonatal`.`apellidopaterno`,' ',`neonatal`.`apellidomaterno`) AS `nombreneonatal`,concat(`escolar`.`nombres`,' ',`escolar`.`apellidopaterno`,' ',`escolar`.`apellidomaterno`) AS `nombreescolar`,concat(`otros`.`nombre`,' ',`otros`.`apellidopaterno`,' ',`otros`.`apellidomaterno`) AS `nombreotros` from (((((`pruebasaudiologia` left join `tipopruebasaudiologia` on((`tipopruebasaudiologia`.`id` = `pruebasaudiologia`.`id_tipopruebasaudiologia`))) left join `audiologia` on((`audiologia`.`id` = `pruebasaudiologia`.`id_audiologia`))) left join `escolar` on((`escolar`.`id` = `audiologia`.`id_escolar`))) left join `otros` on((`otros`.`id` = `audiologia`.`id_otros`))) left join `neonatal` on((`neonatal`.`id` = `audiologia`.`id_neonato`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludotros`
--
DROP TABLE IF EXISTS `viewsaludotros`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludotros`  AS  select `actividad`.`nombreactividad` AS `nombreactividad`,concat(`otros`.`nombre`,' ',`otros`.`apellidopaterno`,' ',`otros`.`apellidomaterno`) AS `nombreotros`,`otros`.`nrodiscapacidad` AS `nrodiscapacidad`,`otros`.`ci` AS `ci`,`otros`.`fecha_nacimiento` AS `fecha_nacimiento`,`otros`.`sexo` AS `sexo`,`otros`.`nivelestudio` AS `nivelestudio`,`discapacidad`.`nombre` AS `discacidad`,`tipodiscapacidad`.`nombre` AS `tipo discapacidad`,`otros`.`resultado` AS `resultado`,`otros`.`resultadotamizaje` AS `resultadotamizaje`,`otros`.`tapon` AS `tapon`,`otros`.`tipo` AS `tipo tapo`,`otros`.`repetirprueba` AS `repetirprueba`,`otros`.`observaciones` AS `observaciones`,`apoderado`.`parentesco` AS `parentesco`,`referencia`.`nombrescompleto` AS `nombrescompleto` from (((((`otros` left join `actividad` on((`actividad`.`id` = `otros`.`id_actividad`))) left join `discapacidad` on((`discapacidad`.`id` = `otros`.`id_discapacidad`))) left join `tipodiscapacidad` on((`tipodiscapacidad`.`id` = `otros`.`id_tipodiscapacidad`))) left join `apoderado` on((`apoderado`.`id` = `otros`.`id_apoderado`))) left join `referencia` on((`referencia`.`id` = `otros`.`id_referencia`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludreferencia`
--
DROP TABLE IF EXISTS `viewsaludreferencia`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludreferencia`  AS  select `referencia`.`nombrescompleto` AS `nombrescompleto`,`referencia`.`nombrescentromedico` AS `nombrescentromedico`,`referencia`.`direccion` AS `direccion`,`referencia`.`telefono` AS `telefono`,`medio`.`nombre` AS `nombre` from (`referencia` join `medio` on((`medio`.`id` = `referencia`.`id_medio`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludservicios`
--
DROP TABLE IF EXISTS `viewsaludservicios`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludservicios`  AS  select concat(`especialista`.`nombres`,' ',`especialista`.`apellidopaterno`,' ',`especialista`.`apellidomaterno`) AS `nombreespecialista`,`audiologia`.`observaciones` AS `observaciones`,concat(`neonatal`.`nombre`,' ',`neonatal`.`apellidopaterno`,' ',`neonatal`.`apellidomaterno`) AS `nombreneonatal`,concat(`escolar`.`nombres`,' ',`escolar`.`apellidopaterno`,' ',`escolar`.`apellidomaterno`) AS `nombreescolar`,concat(`otros`.`nombre`,' ',`otros`.`apellidopaterno`,' ',`otros`.`apellidomaterno`) AS `nombreotros`,`atencion`.`id` AS `ticketdeatencion`,`tipoespecialidad`.`nombre` AS `especialidad` from ((((((`atencion` left join `especialista` on((`especialista`.`id` = `atencion`.`id_especialista`))) left join `audiologia` on((`audiologia`.`id_atencion` = `atencion`.`id`))) left join `neonatal` on((`neonatal`.`id` = `atencion`.`id_neonato`))) left join `escolar` on((`escolar`.`id` = `atencion`.`id_escolar`))) left join `otros` on((`otros`.`id` = `atencion`.`id_otros`))) left join `tipoespecialidad` on((`tipoespecialidad`.`id` = `especialista`.`especialidad`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewsaludtratamiento`
--
DROP TABLE IF EXISTS `viewsaludtratamiento`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewsaludtratamiento`  AS  select `audiologia`.`especialidad` AS `especialidad`,concat(`neonatal`.`nombre`,' ',`neonatal`.`apellidopaterno`,' ',`neonatal`.`apellidomaterno`) AS `nombreneonatal`,concat(`escolar`.`nombres`,' ',`escolar`.`apellidopaterno`,' ',`escolar`.`apellidomaterno`) AS `nombreescolar`,concat(`otros`.`nombre`,' ',`otros`.`apellidopaterno`,' ',`otros`.`apellidomaterno`) AS `nombreotros`,`tipotratamientoaudiologia`.`nombre` AS `tratamiento` from (((((`audiologia` left join `escolar` on((`escolar`.`id` = `audiologia`.`id_escolar`))) left join `otros` on((`otros`.`id` = `audiologia`.`id_otros`))) left join `neonatal` on((`neonatal`.`id` = `audiologia`.`id_neonato`))) left join `tratamiento` on((`tratamiento`.`id_audiologia` = `audiologia`.`id`))) left join `tipotratamientoaudiologia` on((`tipotratamientoaudiologia`.`id` = `tratamiento`.`id_tipotratamientoaudiologia`))) ;

-- --------------------------------------------------------

--
-- Estructura para la vista `viewunidadeducativa`
--
DROP TABLE IF EXISTS `viewunidadeducativa`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viewunidadeducativa`  AS  select `centros`.`nombreinstitucion` AS `centro`,`unidadeducativa`.`nombre` AS `unidadeducativa`,`unidadeducativa`.`codigo_sie` AS `codigo_sie`,`departamento`.`nombre` AS `departamento`,`municipio`.`nombre` AS `municipio`,`provincia`.`nombre` AS `principio`,`unidadeducativa`.`direccion` AS `direccion`,`unidadeducativa`.`telefono` AS `telefono`,`unidadeducativa`.`email` AS `email`,concat(`persona`.`nombre`,' ',`persona`.`apellidopaterno`,' ',`persona`.`apellidomaterno`) AS `director`,(select count(`es`.`id`) from `estudiante` `es` where (`es`.`unidadeducativa` = `unidadeducativa`.`id`)) AS `cantidadalumnos`,(select count(`es`.`id`) from `estudiante` `es` where ((`es`.`unidadeducativa` = `unidadeducativa`.`id`) and (`es`.`sexo` = 'MASCULINO') and (`es`.`discapacidad` = 1))) AS `cantidadalumnosvaronessi`,(select count(`es`.`id`) from `estudiante` `es` where ((`es`.`unidadeducativa` = `unidadeducativa`.`id`) and (`es`.`sexo` = 'MASCULINO') and (`es`.`discapacidad` = 2))) AS `cantidadalumnosvaronesno`,(select count(`es`.`id`) from `estudiante` `es` where ((`es`.`unidadeducativa` = `unidadeducativa`.`id`) and (`es`.`sexo` = 'FEMENINO') and (`es`.`discapacidad` = 1))) AS `cantidadalumnosmujeressi`,(select count(`es`.`id`) from `estudiante` `es` where ((`es`.`unidadeducativa` = `unidadeducativa`.`id`) and (`es`.`sexo` = 'FEMENINO') and (`es`.`discapacidad` = 2))) AS `cantidadalumnosmujeresno` from (((((`unidadeducativa` join `centros` on((`centros`.`id` = `unidadeducativa`.`id_centro`))) join `departamento` on((`departamento`.`id` = `unidadeducativa`.`departamento`))) join `provincia` on((`provincia`.`id` = `unidadeducativa`.`provincia`))) join `municipio` on((`municipio`.`id` = `unidadeducativa`.`municipio`))) join `persona` on((`persona`.`id` = `unidadeducativa`.`id_persona`))) ;
...
--
-- Indices de la tabla `audiologia`
--
...
--
-- Indices de la tabla `diagnosticoaudiologia`
--
...
--
-- Indices de la tabla `neonatal`
--
ALTER TABLE `neonatal`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `otrasorganizaciones`
--
...
--
-- Indices de la tabla `pruebasaudiologia`
--
...
--
-- Indices de la tabla `tipodiagnosticoaudiologia`
--
...
--
-- Indices de la tabla `tipopruebasaudiologia`
--
ALTER TABLE `tipopruebasaudiologia`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tipotratamientoaudiologia`
--
...
--
-- Indices de la tabla `unidadeducativa`
--
...
--
-- AUTO_INCREMENT de la tabla `audiologia`
--
ALTER TABLE `audiologia`
...
--
-- AUTO_INCREMENT de la tabla `diagnosticoaudiologia`
--
ALTER TABLE `diagnosticoaudiologia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
-- AUTO_INCREMENT de la tabla `institucionesdesalud`
--
ALTER TABLE `institucionesdesalud`
...
ALTER TABLE `municipio`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `neonatal`
--
ALTER TABLE `neonatal`
...
--
-- AUTO_INCREMENT de la tabla `pruebasaudiologia`
--
ALTER TABLE `pruebasaudiologia`
...
ALTER TABLE `sector`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `tapon`
--
ALTER TABLE `tapon`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT de la tabla `tipodiagnosticoaudiologia`
--
ALTER TABLE `tipodiagnosticoaudiologia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
ALTER TABLE `tipoprueba`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipopruebasaudiologia`
--
ALTER TABLE `tipopruebasaudiologia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT de la tabla `tipotratamientoaudiologia`
--
ALTER TABLE `tipotratamientoaudiologia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
ALTER TABLE `tratamiento`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `unidadeducativa`
--
ALTER TABLE `unidadeducativa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
