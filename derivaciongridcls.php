...
$derivacion_grid = NULL; // Initialize page object first

class cderivacion_grid extends cderivacion {
	...
	// Page object name
	var $PageObjName = 'derivacion_grid';

	// Grid form hidden field names
	var $FormName = 'fderivaciongrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["derivacion"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_id_tipoespecialidad") && $objForm->HasValue("o_id_tipoespecialidad") && $this->id_tipoespecialidad->CurrentValue <> $this->id_tipoespecialidad->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_tipoderivacion") && $objForm->HasValue("o_tipoderivacion") && $this->tipoderivacion->CurrentValue <> $this->tipoderivacion->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->id_tipoespecialidad->setOldValue($objForm->GetValue("o_id_tipoespecialidad"));
		if (!$this->tipoderivacion->FldIsDetailKey) {
			$this->tipoderivacion->setFormValue($objForm->GetValue("x_tipoderivacion"));
		}
		$this->tipoderivacion->setOldValue($objForm->GetValue("o_tipoderivacion"));
	}
