...
//
// Table class for atencion
//
class catencion extends cTable {
	var $id;
	var $id_neonato;
	var $id_otros;
	var $id_escolar;
	...
	function __construct() {
		...
		$this->TableVar = 'atencion';
		$this->TableName = 'atencion';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`atencion`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('atencion', 'atencion', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_neonato
		$this->id_neonato = new cField('atencion', 'atencion', 'x_id_neonato', 'id_neonato', '`id_neonato`', '`id_neonato`', 3, -1, FALSE, '`EV__id_neonato`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_otros
		$this->id_otros = new cField('atencion', 'atencion', 'x_id_otros', 'id_otros', '`id_otros`', '`id_otros`', 3, -1, FALSE, '`id_otros`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_escolar
		$this->id_escolar = new cField('atencion', 'atencion', 'x_id_escolar', 'id_escolar', '`id_escolar`', '`id_escolar`', 3, -1, FALSE, '`EV__id_escolar`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
		...
		// id_especialista
		$this->id_especialista = new cField('atencion', 'atencion', 'x_id_especialista', 'id_especialista', '`id_especialista`', '`id_especialista`', 3, -1, FALSE, '`EV__id_especialista`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`atencion`";
	}
	...
	function getSqlSelectList() { // Select for List page
		$select = "";
		$select = "SELECT * FROM (" .
			"SELECT *, (SELECT CONCAT(`nombre`,'" . ew_ValueSeparator(1, $this->id_neonato) . "',`apellidopaterno`,'" . ew_ValueSeparator(2, $this->id_neonato) . "',`apellidomaterno`) FROM `neonatal` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`id` = `atencion`.`id_neonato` LIMIT 1) AS `EV__id_neonato`, (SELECT CONCAT(`nombres`,'" . ew_ValueSeparator(1, $this->id_escolar) . "',`apellidopaterno`,'" . ew_ValueSeparator(2, $this->id_escolar) . "',`apellidomaterno`) FROM `escolar` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`id` = `atencion`.`id_escolar` LIMIT 1) AS `EV__id_escolar`, (SELECT CONCAT(`nombres`,'" . ew_ValueSeparator(1, $this->id_especialista) . "',`apellidopaterno`,'" . ew_ValueSeparator(2, $this->id_especialista) . "',`apellidomaterno`) FROM `especialista` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`id` = `atencion`.`id_especialista` LIMIT 1) AS `EV__id_especialista` FROM `atencion`" .
			") `EW_TMP_TABLE`";
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "atencionedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "atencionadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("atencionview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("atencionview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "atencionadd.php?" . $this->UrlParm($parm);
		else
			$url = "atencionadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("atencionedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("atencionadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("atenciondelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->id_otros->EditValue = $this->id_otros->CurrentValue;
