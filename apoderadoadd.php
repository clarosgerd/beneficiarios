...
<?php if ($apoderado->direccion->Visible) { // direccion ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_apoderado_direccion" for="x_direccion" class="<?php echo $apoderado_add->LeftColumnClass ?>"><?php echo $apoderado->direccion->FldCaption() ?></label>
		<div class="<?php echo $apoderado_add->RightColumnClass ?>"><div<?php echo $apoderado->direccion->CellAttributes() ?>>
...
<?php if ($apoderado->ocupacion->Visible) { // ocupacion ?>
	<div id="r_ocupacion" class="form-group">
		<label id="elh_apoderado_ocupacion" for="x_ocupacion" class="<?php echo $apoderado_add->LeftColumnClass ?>"><?php echo $apoderado->ocupacion->FldCaption() ?></label>
		<div class="<?php echo $apoderado_add->RightColumnClass ?>"><div<?php echo $apoderado->ocupacion->CellAttributes() ?>>
