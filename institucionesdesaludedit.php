...
$institucionesdesalud_edit = NULL; // Initialize page object first

class cinstitucionesdesalud_edit extends cinstitucionesdesalud {
	...
	// Page object name
	var $PageObjName = 'institucionesdesalud_edit';
...
// Create page object
if (!isset($institucionesdesalud_edit)) $institucionesdesalud_edit = new cinstitucionesdesalud_edit();

// Page init
$institucionesdesalud_edit->Page_Init();

// Page main
$institucionesdesalud_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$institucionesdesalud_edit->Page_Render();
?>
...
var CurrentForm = finstitucionesdesaludedit = new ew_Form("finstitucionesdesaludedit", "edit");

// Validate form
finstitucionesdesaludedit.Validate = function() {
...
finstitucionesdesaludedit.Form_CustomValidate = 
...
finstitucionesdesaludedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finstitucionesdesaludedit.Lists["x_departamento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
finstitucionesdesaludedit.Lists["x_departamento"].Data = "<?php echo $institucionesdesalud_edit->departamento->LookupFilterQuery(FALSE, "edit") ?>";
finstitucionesdesaludedit.Lists["x_municipio"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"municipio"};
finstitucionesdesaludedit.Lists["x_municipio"].Data = "<?php echo $institucionesdesalud_edit->municipio->LookupFilterQuery(FALSE, "edit") ?>";
finstitucionesdesaludedit.AutoSuggests["x_municipio"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $institucionesdesalud_edit->municipio->LookupFilterQuery(TRUE, "edit"))) ?>;
finstitucionesdesaludedit.Lists["x_id_persona"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"persona"};
finstitucionesdesaludedit.Lists["x_id_persona"].Data = "<?php echo $institucionesdesalud_edit->id_persona->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $institucionesdesalud_edit->ShowPageHeader(); ?>
<?php
$institucionesdesalud_edit->ShowMessage();
?>
<form name="finstitucionesdesaludedit" id="finstitucionesdesaludedit" class="<?php echo $institucionesdesalud_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($institucionesdesalud_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $institucionesdesalud_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="institucionesdesalud">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($institucionesdesalud_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($institucionesdesalud->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_institucionesdesalud_id" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->id->FldCaption() ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->id->CellAttributes() ?>>
<span id="el_institucionesdesalud_id">
<span<?php echo $institucionesdesalud->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $institucionesdesalud->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="institucionesdesalud" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($institucionesdesalud->id->CurrentValue) ?>">
<?php echo $institucionesdesalud->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($institucionesdesalud->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_institucionesdesalud_nombre" for="x_nombre" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->nombre->CellAttributes() ?>>
...
<?php if ($institucionesdesalud->departamento->Visible) { // departamento ?>
	<div id="r_departamento" class="form-group">
		<label id="elh_institucionesdesalud_departamento" for="x_departamento" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->departamento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->departamento->CellAttributes() ?>>
...
<?php if ($institucionesdesalud->municipio->Visible) { // municipio ?>
	<div id="r_municipio" class="form-group">
		<label id="elh_institucionesdesalud_municipio" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->municipio->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->municipio->CellAttributes() ?>>
...
<script type="text/javascript">
finstitucionesdesaludedit.CreateAutoSuggest({"id":"x_municipio","forceSelect":false});
</script>
</span>
...
<?php if ($institucionesdesalud->direccion->Visible) { // direccion ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_institucionesdesalud_direccion" for="x_direccion" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->direccion->CellAttributes() ?>>
...
<?php if ($institucionesdesalud->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group">
		<label id="elh_institucionesdesalud_telefono" for="x_telefono" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->telefono->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->telefono->CellAttributes() ?>>
...
<?php if ($institucionesdesalud->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_institucionesdesalud__email" for="x__email" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->_email->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->_email->CellAttributes() ?>>
...
<?php if ($institucionesdesalud->id_persona->Visible) { // id_persona ?>
	<div id="r_id_persona" class="form-group">
		<label id="elh_institucionesdesalud_id_persona" for="x_id_persona" class="<?php echo $institucionesdesalud_edit->LeftColumnClass ?>"><?php echo $institucionesdesalud->id_persona->FldCaption() ?></label>
		<div class="<?php echo $institucionesdesalud_edit->RightColumnClass ?>"><div<?php echo $institucionesdesalud->id_persona->CellAttributes() ?>>
<span id="el_institucionesdesalud_id_persona">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_persona"><?php echo (strval($institucionesdesalud->id_persona->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $institucionesdesalud->id_persona->ViewValue); ?></span>
</span>
...
<?php if (!$institucionesdesalud_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $institucionesdesalud_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $institucionesdesalud_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finstitucionesdesaludedit.Init();
</script>
<?php
$institucionesdesalud_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$institucionesdesalud_edit->Page_Terminate();
?>
