...
<?php include_once "tipodiagnosticoaudiologiarptinfo.php" ?>
<?php
...
$tipodiagnosticoaudiologia_rpt = NULL; // Initialize page object first

class crtipodiagnosticoaudiologia_rpt extends crtipodiagnosticoaudiologia {
	...
	// Page object name
	var $PageObjName = 'tipodiagnosticoaudiologia_rpt';
	...
	function __construct() {
		...
		if (!isset($GLOBALS["tipodiagnosticoaudiologia"])) {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'tipodiagnosticoaudiologia', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ftipodiagnosticoaudiologiarpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'tipodiagnosticoaudiologia');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_tipodiagnosticoaudiologia\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_tipodiagnosticoaudiologia',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ftipodiagnosticoaudiologiarpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ftipodiagnosticoaudiologiarpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ftipodiagnosticoaudiologiarpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($tipodiagnosticoaudiologia_rpt)) $tipodiagnosticoaudiologia_rpt = new crtipodiagnosticoaudiologia_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$tipodiagnosticoaudiologia_rpt;
...
// Create page object
var tipodiagnosticoaudiologia_rpt = new ewr_Page("tipodiagnosticoaudiologia_rpt");

// Page properties
tipodiagnosticoaudiologia_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = tipodiagnosticoaudiologia_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_tipodiagnosticoaudiologia" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="tipodiagnosticoaudiologia_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn tipodiagnosticoaudiologia_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipodiagnosticoaudiologia_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="tipodiagnosticoaudiologia_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn tipodiagnosticoaudiologia_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipodiagnosticoaudiologia_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php include "tipodiagnosticoaudiologiarptpager.php" ?>
