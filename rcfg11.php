...
define("EWR_PROJECT_ID", "{707530BA-BEB7-415A-B683-2C9753B31FA3}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "beneficiarios", TRUE); // Project Name
...
$EWR_BODY_CLASS = "hold-transition skin-purple";
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "benificiaries", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'dck3RI8pW4E7stj3', TRUE); // Random key for encryption
...
define("EWR_USER_NAME_FILTER", "`login` = '%u'", TRUE);
define("EWR_USER_ID_FILTER", "`login` = '%u'",  TRUE);
...
define("EWR_TABLE_PREFIX", "{707530BA-BEB7-415A-B683-2C9753B31FA3}", TRUE);
