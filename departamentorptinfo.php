...
//
class crdepartamento extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('departamento', 'departamento', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombre
		$this->nombre = new crField('departamento', 'departamento', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
