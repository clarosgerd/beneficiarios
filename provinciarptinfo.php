...
//
class crprovincia extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('provincia', 'provincia', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombre
		$this->nombre = new crField('provincia', 'provincia', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// descripcion
		$this->descripcion = new crField('provincia', 'provincia', 'x_descripcion', 'descripcion', '`descripcion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_departamento
		$this->id_departamento = new crField('provincia', 'provincia', 'x_id_departamento', 'id_departamento', '`id_departamento`', 3, EWR_DATATYPE_NUMBER, -1);
