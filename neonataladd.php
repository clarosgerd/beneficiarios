...
$neonatal_add = NULL; // Initialize page object first

class cneonatal_add extends cneonatal {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "neonatalview.php")
...
// Create page object
if (!isset($neonatal_add)) $neonatal_add = new cneonatal_add();

// Page init
$neonatal_add->Page_Init();

// Page main
$neonatal_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$neonatal_add->Page_Render();
?>
...
var CurrentForm = fneonataladd = new ew_Form("fneonataladd", "add");

// Validate form
fneonataladd.Validate = function() {
...
fneonataladd.Form_CustomValidate = 
...
fneonataladd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fneonataladd.Lists["x_id_centro"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"institucionesdesalud"};
fneonataladd.Lists["x_id_centro"].Data = "<?php echo $neonatal_add->id_centro->LookupFilterQuery(FALSE, "add") ?>";
fneonataladd.Lists["x_sexo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fneonataladd.Lists["x_sexo"].Options = <?php echo json_encode($neonatal_add->sexo->Options()) ?>;
fneonataladd.Lists["x_discapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"discapacidad"};
fneonataladd.Lists["x_discapacidad"].Data = "<?php echo $neonatal_add->discapacidad->LookupFilterQuery(FALSE, "add") ?>";
fneonataladd.AutoSuggests["x_discapacidad"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $neonatal_add->discapacidad->LookupFilterQuery(TRUE, "add"))) ?>;
fneonataladd.Lists["x_tapon"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fneonataladd.Lists["x_tapon"].Options = <?php echo json_encode($neonatal_add->tapon->Options()) ?>;
fneonataladd.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fneonataladd.Lists["x_tipo"].Options = <?php echo json_encode($neonatal_add->tipo->Options()) ?>;
fneonataladd.Lists["x_repetirprueba"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fneonataladd.Lists["x_repetirprueba"].Options = <?php echo json_encode($neonatal_add->repetirprueba->Options()) ?>;
fneonataladd.Lists["x_id_apoderado"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_apellidopaterno","x_apellidopaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"apoderado"};
fneonataladd.Lists["x_id_apoderado"].Data = "<?php echo $neonatal_add->id_apoderado->LookupFilterQuery(FALSE, "add") ?>";
fneonataladd.Lists["x_id_referencia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombrescentromedico","x_nombrescompleto","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referencia"};
fneonataladd.Lists["x_id_referencia"].Data = "<?php echo $neonatal_add->id_referencia->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $neonatal_add->ShowPageHeader(); ?>
<?php
$neonatal_add->ShowMessage();
?>
<form name="fneonataladd" id="fneonataladd" class="<?php echo $neonatal_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($neonatal_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $neonatal_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="neonatal">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($neonatal_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($neonatal->id_centro->Visible) { // id_centro ?>
	<div id="r_id_centro" class="form-group">
		<label id="elh_neonatal_id_centro" for="x_id_centro" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->id_centro->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->id_centro->CellAttributes() ?>>
...
<?php if ($neonatal->apellidopaterno->Visible) { // apellidopaterno ?>
	<div id="r_apellidopaterno" class="form-group">
		<label id="elh_neonatal_apellidopaterno" for="x_apellidopaterno" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->apellidopaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->apellidopaterno->CellAttributes() ?>>
...
<?php if ($neonatal->apellidomaterno->Visible) { // apellidomaterno ?>
	<div id="r_apellidomaterno" class="form-group">
		<label id="elh_neonatal_apellidomaterno" for="x_apellidomaterno" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->apellidomaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->apellidomaterno->CellAttributes() ?>>
...
<?php if ($neonatal->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_neonatal_nombre" for="x_nombre" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->nombre->CellAttributes() ?>>
...
<?php if ($neonatal->ci->Visible) { // ci ?>
	<div id="r_ci" class="form-group">
		<label id="elh_neonatal_ci" for="x_ci" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->ci->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->ci->CellAttributes() ?>>
...
<?php if ($neonatal->fecha_nacimiento->Visible) { // fecha_nacimiento ?>
	<div id="r_fecha_nacimiento" class="form-group">
		<label id="elh_neonatal_fecha_nacimiento" for="x_fecha_nacimiento" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->fecha_nacimiento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->fecha_nacimiento->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fneonataladd", "x_fecha_nacimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($neonatal->dias->Visible) { // dias ?>
	<div id="r_dias" class="form-group">
		<label id="elh_neonatal_dias" for="x_dias" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->dias->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->dias->CellAttributes() ?>>
...
<?php if ($neonatal->semanas->Visible) { // semanas ?>
	<div id="r_semanas" class="form-group">
		<label id="elh_neonatal_semanas" for="x_semanas" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->semanas->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->semanas->CellAttributes() ?>>
...
<?php if ($neonatal->meses->Visible) { // meses ?>
	<div id="r_meses" class="form-group">
		<label id="elh_neonatal_meses" for="x_meses" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->meses->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->meses->CellAttributes() ?>>
...
<?php if ($neonatal->sexo->Visible) { // sexo ?>
	<div id="r_sexo" class="form-group">
		<label id="elh_neonatal_sexo" for="x_sexo" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->sexo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->sexo->CellAttributes() ?>>
...
<?php if ($neonatal->discapacidad->Visible) { // discapacidad ?>
	<div id="r_discapacidad" class="form-group">
		<label id="elh_neonatal_discapacidad" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->discapacidad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->discapacidad->CellAttributes() ?>>
...
<script type="text/javascript">
fneonataladd.CreateAutoSuggest({"id":"x_discapacidad","forceSelect":false});
</script>
</span>
...
<?php if ($neonatal->id_tipodiscapacidad->Visible) { // id_tipodiscapacidad ?>
	<div id="r_id_tipodiscapacidad" class="form-group">
		<label id="elh_neonatal_id_tipodiscapacidad" for="x_id_tipodiscapacidad" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->id_tipodiscapacidad->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->id_tipodiscapacidad->CellAttributes() ?>>
...
<?php if ($neonatal->resultado->Visible) { // resultado ?>
	<div id="r_resultado" class="form-group">
		<label id="elh_neonatal_resultado" for="x_resultado" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->resultado->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->resultado->CellAttributes() ?>>
...
<?php if ($neonatal->resultadotamizaje->Visible) { // resultadotamizaje ?>
	<div id="r_resultadotamizaje" class="form-group">
		<label id="elh_neonatal_resultadotamizaje" for="x_resultadotamizaje" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->resultadotamizaje->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->resultadotamizaje->CellAttributes() ?>>
...
<?php if ($neonatal->tapon->Visible) { // tapon ?>
	<div id="r_tapon" class="form-group">
		<label id="elh_neonatal_tapon" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->tapon->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->tapon->CellAttributes() ?>>
...
<?php if ($neonatal->tipo->Visible) { // tipo ?>
	<div id="r_tipo" class="form-group">
		<label id="elh_neonatal_tipo" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->tipo->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->tipo->CellAttributes() ?>>
...
<?php if ($neonatal->repetirprueba->Visible) { // repetirprueba ?>
	<div id="r_repetirprueba" class="form-group">
		<label id="elh_neonatal_repetirprueba" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->repetirprueba->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->repetirprueba->CellAttributes() ?>>
...
<?php if ($neonatal->observaciones->Visible) { // observaciones ?>
	<div id="r_observaciones" class="form-group">
		<label id="elh_neonatal_observaciones" for="x_observaciones" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->observaciones->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->observaciones->CellAttributes() ?>>
...
<?php if ($neonatal->id_apoderado->Visible) { // id_apoderado ?>
	<div id="r_id_apoderado" class="form-group">
		<label id="elh_neonatal_id_apoderado" for="x_id_apoderado" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->id_apoderado->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->id_apoderado->CellAttributes() ?>>
...
<?php if ($neonatal->id_referencia->Visible) { // id_referencia ?>
	<div id="r_id_referencia" class="form-group">
		<label id="elh_neonatal_id_referencia" for="x_id_referencia" class="<?php echo $neonatal_add->LeftColumnClass ?>"><?php echo $neonatal->id_referencia->FldCaption() ?></label>
		<div class="<?php echo $neonatal_add->RightColumnClass ?>"><div<?php echo $neonatal->id_referencia->CellAttributes() ?>>
...
<?php if (!$neonatal_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $neonatal_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $neonatal_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
