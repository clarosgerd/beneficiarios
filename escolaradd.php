...
$escolar_add = NULL; // Initialize page object first

class cescolar_add extends cescolar {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "escolarview.php")
...
// Create page object
if (!isset($escolar_add)) $escolar_add = new cescolar_add();

// Page init
$escolar_add->Page_Init();

// Page main
$escolar_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$escolar_add->Page_Render();
?>
...
var CurrentForm = fescolaradd = new ew_Form("fescolaradd", "add");

// Validate form
fescolaradd.Validate = function() {
...
fescolaradd.Form_CustomValidate = 
...
fescolaradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fescolaradd.Lists["x_unidadeducativa"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"unidadeducativa"};
fescolaradd.Lists["x_unidadeducativa"].Data = "<?php echo $escolar_add->unidadeducativa->LookupFilterQuery(FALSE, "add") ?>";
fescolaradd.Lists["x_sexo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fescolaradd.Lists["x_sexo"].Options = <?php echo json_encode($escolar_add->sexo->Options()) ?>;
fescolaradd.Lists["x_id_discapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"discapacidad"};
fescolaradd.Lists["x_id_discapacidad"].Data = "<?php echo $escolar_add->id_discapacidad->LookupFilterQuery(FALSE, "add") ?>";
fescolaradd.Lists["x_id_tipodiscapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodiscapacidad"};
fescolaradd.Lists["x_id_tipodiscapacidad"].Data = "<?php echo $escolar_add->id_tipodiscapacidad->LookupFilterQuery(FALSE, "add") ?>";
fescolaradd.Lists["x_resultado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fescolaradd.Lists["x_resultado"].Options = <?php echo json_encode($escolar_add->resultado->Options()) ?>;
fescolaradd.Lists["x_tapon"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fescolaradd.Lists["x_tapon"].Options = <?php echo json_encode($escolar_add->tapon->Options()) ?>;
fescolaradd.Lists["x_tapodonde"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fescolaradd.Lists["x_tapodonde"].Options = <?php echo json_encode($escolar_add->tapodonde->Options()) ?>;
fescolaradd.Lists["x_repetirprueba"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fescolaradd.Lists["x_repetirprueba"].Options = <?php echo json_encode($escolar_add->repetirprueba->Options()) ?>;
fescolaradd.Lists["x_id_apoderado"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"apoderado"};
fescolaradd.Lists["x_id_apoderado"].Data = "<?php echo $escolar_add->id_apoderado->LookupFilterQuery(FALSE, "add") ?>";
fescolaradd.Lists["x_id_referencia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombrescompleto","x_nombrescentromedico","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referencia"};
fescolaradd.Lists["x_id_referencia"].Data = "<?php echo $escolar_add->id_referencia->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $escolar_add->ShowPageHeader(); ?>
<?php
$escolar_add->ShowMessage();
?>
<form name="fescolaradd" id="fescolaradd" class="<?php echo $escolar_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($escolar_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $escolar_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="escolar">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($escolar_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($escolar->fecha->Visible) { // fecha ?>
	<div id="r_fecha" class="form-group">
		<label id="elh_escolar_fecha" for="x_fecha" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->fecha->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->fecha->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fescolaradd", "x_fecha", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($escolar->unidadeducativa->Visible) { // unidadeducativa ?>
	<div id="r_unidadeducativa" class="form-group">
		<label id="elh_escolar_unidadeducativa" for="x_unidadeducativa" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->unidadeducativa->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->unidadeducativa->CellAttributes() ?>>
...
<?php if ($escolar->apellidopaterno->Visible) { // apellidopaterno ?>
	<div id="r_apellidopaterno" class="form-group">
		<label id="elh_escolar_apellidopaterno" for="x_apellidopaterno" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->apellidopaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->apellidopaterno->CellAttributes() ?>>
...
<?php if ($escolar->apellidomaterno->Visible) { // apellidomaterno ?>
	<div id="r_apellidomaterno" class="form-group">
		<label id="elh_escolar_apellidomaterno" for="x_apellidomaterno" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->apellidomaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->apellidomaterno->CellAttributes() ?>>
...
<?php if ($escolar->nombres->Visible) { // nombres ?>
	<div id="r_nombres" class="form-group">
		<label id="elh_escolar_nombres" for="x_nombres" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->nombres->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->nombres->CellAttributes() ?>>
...
<?php if ($escolar->ci->Visible) { // ci ?>
	<div id="r_ci" class="form-group">
		<label id="elh_escolar_ci" for="x_ci" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->ci->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->ci->CellAttributes() ?>>
...
<?php if ($escolar->fechanacimiento->Visible) { // fechanacimiento ?>
	<div id="r_fechanacimiento" class="form-group">
		<label id="elh_escolar_fechanacimiento" for="x_fechanacimiento" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->fechanacimiento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->fechanacimiento->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fescolaradd", "x_fechanacimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($escolar->sexo->Visible) { // sexo ?>
	<div id="r_sexo" class="form-group">
		<label id="elh_escolar_sexo" for="x_sexo" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->sexo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->sexo->CellAttributes() ?>>
...
<?php if ($escolar->curso->Visible) { // curso ?>
	<div id="r_curso" class="form-group">
		<label id="elh_escolar_curso" for="x_curso" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->curso->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->curso->CellAttributes() ?>>
...
<?php if ($escolar->id_discapacidad->Visible) { // id_discapacidad ?>
	<div id="r_id_discapacidad" class="form-group">
		<label id="elh_escolar_id_discapacidad" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->id_discapacidad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->id_discapacidad->CellAttributes() ?>>
...
<?php if ($escolar->id_tipodiscapacidad->Visible) { // id_tipodiscapacidad ?>
	<div id="r_id_tipodiscapacidad" class="form-group">
		<label id="elh_escolar_id_tipodiscapacidad" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->id_tipodiscapacidad->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->id_tipodiscapacidad->CellAttributes() ?>>
...
<?php if ($escolar->resultado->Visible) { // resultado ?>
	<div id="r_resultado" class="form-group">
		<label id="elh_escolar_resultado" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->resultado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->resultado->CellAttributes() ?>>
...
<?php if ($escolar->resultadotamizaje->Visible) { // resultadotamizaje ?>
	<div id="r_resultadotamizaje" class="form-group">
		<label id="elh_escolar_resultadotamizaje" for="x_resultadotamizaje" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->resultadotamizaje->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->resultadotamizaje->CellAttributes() ?>>
...
<?php if ($escolar->tapon->Visible) { // tapon ?>
	<div id="r_tapon" class="form-group">
		<label id="elh_escolar_tapon" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->tapon->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->tapon->CellAttributes() ?>>
...
<?php if ($escolar->tapodonde->Visible) { // tapodonde ?>
	<div id="r_tapodonde" class="form-group">
		<label id="elh_escolar_tapodonde" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->tapodonde->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->tapodonde->CellAttributes() ?>>
...
<?php if ($escolar->repetirprueba->Visible) { // repetirprueba ?>
	<div id="r_repetirprueba" class="form-group">
		<label id="elh_escolar_repetirprueba" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->repetirprueba->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->repetirprueba->CellAttributes() ?>>
...
<?php if ($escolar->observaciones->Visible) { // observaciones ?>
	<div id="r_observaciones" class="form-group">
		<label id="elh_escolar_observaciones" for="x_observaciones" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->observaciones->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->observaciones->CellAttributes() ?>>
...
<?php if ($escolar->id_apoderado->Visible) { // id_apoderado ?>
	<div id="r_id_apoderado" class="form-group">
		<label id="elh_escolar_id_apoderado" for="x_id_apoderado" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->id_apoderado->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->id_apoderado->CellAttributes() ?>>
...
<?php if ($escolar->id_referencia->Visible) { // id_referencia ?>
	<div id="r_id_referencia" class="form-group">
		<label id="elh_escolar_id_referencia" for="x_id_referencia" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->id_referencia->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->id_referencia->CellAttributes() ?>>
...
<?php if ($escolar->codigorude->Visible) { // codigorude ?>
	<div id="r_codigorude" class="form-group">
		<label id="elh_escolar_codigorude" for="x_codigorude" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->codigorude->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->codigorude->CellAttributes() ?>>
...
<?php if ($escolar->codigorude_es->Visible) { // codigorude_es ?>
	<div id="r_codigorude_es" class="form-group">
		<label id="elh_escolar_codigorude_es" for="x_codigorude_es" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->codigorude_es->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->codigorude_es->CellAttributes() ?>>
...
<?php if ($escolar->nrodiscapacidad->Visible) { // nrodiscapacidad ?>
	<div id="r_nrodiscapacidad" class="form-group">
		<label id="elh_escolar_nrodiscapacidad" for="x_nrodiscapacidad" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->nrodiscapacidad->FldCaption() ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->nrodiscapacidad->CellAttributes() ?>>
...
<?php if ($escolar->id_centro->Visible) { // id_centro ?>
	<div id="r_id_centro" class="form-group">
		<label id="elh_escolar_id_centro" for="x_id_centro" class="<?php echo $escolar_add->LeftColumnClass ?>"><?php echo $escolar->id_centro->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $escolar_add->RightColumnClass ?>"><div<?php echo $escolar->id_centro->CellAttributes() ?>>
<span id="el_escolar_id_centro">
...
<?php echo $escolar->id_centro->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$escolar_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $escolar_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $escolar_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
