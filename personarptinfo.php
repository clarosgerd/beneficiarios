...
//
class crpersona extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('persona', 'persona', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// nombreinstitucion
		$this->nombreinstitucion = new crField('persona', 'persona', 'x_nombreinstitucion', 'nombreinstitucion', '`nombreinstitucion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidopaterno
		$this->apellidopaterno = new crField('persona', 'persona', 'x_apellidopaterno', 'apellidopaterno', '`apellidopaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidomaterno
		$this->apellidomaterno = new crField('persona', 'persona', 'x_apellidomaterno', 'apellidomaterno', '`apellidomaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombre
		$this->nombre = new crField('persona', 'persona', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// telefono
		$this->telefono = new crField('persona', 'persona', 'x_telefono', 'telefono', '`telefono`', 200, EWR_DATATYPE_STRING, -1);
		...
		// email
		$this->_email = new crField('persona', 'persona', 'x__email', 'email', '`email`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tipopersona
		$this->tipopersona = new crField('persona', 'persona', 'x_tipopersona', 'tipopersona', '`tipopersona`', 200, EWR_DATATYPE_STRING, -1);
		$this->tipopersona->Sortable = TRUE; // Allow sort
		$this->tipopersona->DateFilter = "";
		$this->tipopersona->SqlSelect = "";
		$this->tipopersona->SqlOrderBy = "";
