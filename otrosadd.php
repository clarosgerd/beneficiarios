...
$otros_add = NULL; // Initialize page object first

class cotros_add extends cotros {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "otrosview.php")
...
// Create page object
if (!isset($otros_add)) $otros_add = new cotros_add();
...
var CurrentForm = fotrosadd = new ew_Form("fotrosadd", "add");

// Validate form
fotrosadd.Validate = function() {
...
fotrosadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fotrosadd.Lists["x_id_actividad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombreactividad","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"actividad"};
fotrosadd.Lists["x_id_actividad"].Data = "<?php echo $otros_add->id_actividad->LookupFilterQuery(FALSE, "add") ?>";
fotrosadd.Lists["x_sexo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fotrosadd.Lists["x_sexo"].Options = <?php echo json_encode($otros_add->sexo->Options()) ?>;
fotrosadd.Lists["x_id_discapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"discapacidad"};
fotrosadd.Lists["x_id_discapacidad"].Data = "<?php echo $otros_add->id_discapacidad->LookupFilterQuery(FALSE, "add") ?>";
fotrosadd.Lists["x_id_tipodiscapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodiscapacidad"};
fotrosadd.Lists["x_id_tipodiscapacidad"].Data = "<?php echo $otros_add->id_tipodiscapacidad->LookupFilterQuery(FALSE, "add") ?>";
fotrosadd.AutoSuggests["x_id_tipodiscapacidad"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $otros_add->id_tipodiscapacidad->LookupFilterQuery(TRUE, "add"))) ?>;
fotrosadd.Lists["x_resultado"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fotrosadd.Lists["x_resultado"].Options = <?php echo json_encode($otros_add->resultado->Options()) ?>;
fotrosadd.Lists["x_tapon"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tapon"};
fotrosadd.Lists["x_tapon"].Data = "<?php echo $otros_add->tapon->LookupFilterQuery(FALSE, "add") ?>";
fotrosadd.Lists["x_tipo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fotrosadd.Lists["x_tipo"].Options = <?php echo json_encode($otros_add->tipo->Options()) ?>;
fotrosadd.Lists["x_id_apoderado"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"apoderado"};
fotrosadd.Lists["x_id_apoderado"].Data = "<?php echo $otros_add->id_apoderado->LookupFilterQuery(FALSE, "add") ?>";
fotrosadd.Lists["x_id_referencia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombrescentromedico","x_nombrescompleto","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"referencia"};
fotrosadd.Lists["x_id_referencia"].Data = "<?php echo $otros_add->id_referencia->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $otros_add->ShowPageHeader(); ?>
<?php
$otros_add->ShowMessage();
?>
<form name="fotrosadd" id="fotrosadd" class="<?php echo $otros_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($otros_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $otros_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="otros">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($otros_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($otros->id_actividad->Visible) { // id_actividad ?>
	<div id="r_id_actividad" class="form-group">
		<label id="elh_otros_id_actividad" for="x_id_actividad" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->id_actividad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->id_actividad->CellAttributes() ?>>
...
<?php if ($otros->apellidopaterno->Visible) { // apellidopaterno ?>
	<div id="r_apellidopaterno" class="form-group">
		<label id="elh_otros_apellidopaterno" for="x_apellidopaterno" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->apellidopaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->apellidopaterno->CellAttributes() ?>>
...
<?php if ($otros->apellidomaterno->Visible) { // apellidomaterno ?>
	<div id="r_apellidomaterno" class="form-group">
		<label id="elh_otros_apellidomaterno" for="x_apellidomaterno" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->apellidomaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->apellidomaterno->CellAttributes() ?>>
...
<?php if ($otros->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_otros_nombre" for="x_nombre" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->nombre->CellAttributes() ?>>
...
<?php if ($otros->nrodiscapacidad->Visible) { // nrodiscapacidad ?>
	<div id="r_nrodiscapacidad" class="form-group">
		<label id="elh_otros_nrodiscapacidad" for="x_nrodiscapacidad" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->nrodiscapacidad->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->nrodiscapacidad->CellAttributes() ?>>
...
<?php if ($otros->ci->Visible) { // ci ?>
	<div id="r_ci" class="form-group">
		<label id="elh_otros_ci" for="x_ci" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->ci->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->ci->CellAttributes() ?>>
<span id="el_otros_ci">
...
<?php if ($otros->fecha_nacimiento->Visible) { // fecha_nacimiento ?>
	<div id="r_fecha_nacimiento" class="form-group">
		<label id="elh_otros_fecha_nacimiento" for="x_fecha_nacimiento" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->fecha_nacimiento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->fecha_nacimiento->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fotrosadd", "x_fecha_nacimiento", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($otros->sexo->Visible) { // sexo ?>
	<div id="r_sexo" class="form-group">
		<label id="elh_otros_sexo" for="x_sexo" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->sexo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->sexo->CellAttributes() ?>>
...
<?php if ($otros->nivelestudio->Visible) { // nivelestudio ?>
	<div id="r_nivelestudio" class="form-group">
		<label id="elh_otros_nivelestudio" for="x_nivelestudio" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->nivelestudio->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->nivelestudio->CellAttributes() ?>>
...
<?php if ($otros->id_discapacidad->Visible) { // id_discapacidad ?>
	<div id="r_id_discapacidad" class="form-group">
		<label id="elh_otros_id_discapacidad" for="x_id_discapacidad" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->id_discapacidad->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->id_discapacidad->CellAttributes() ?>>
...
<?php if ($otros->id_tipodiscapacidad->Visible) { // id_tipodiscapacidad ?>
	<div id="r_id_tipodiscapacidad" class="form-group">
		<label id="elh_otros_id_tipodiscapacidad" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->id_tipodiscapacidad->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->id_tipodiscapacidad->CellAttributes() ?>>
...
<script type="text/javascript">
fotrosadd.CreateAutoSuggest({"id":"x_id_tipodiscapacidad","forceSelect":false});
</script>
</span>
...
<?php if ($otros->resultado->Visible) { // resultado ?>
	<div id="r_resultado" class="form-group">
		<label id="elh_otros_resultado" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->resultado->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->resultado->CellAttributes() ?>>
...
<?php if ($otros->resultadotamizaje->Visible) { // resultadotamizaje ?>
	<div id="r_resultadotamizaje" class="form-group">
		<label id="elh_otros_resultadotamizaje" for="x_resultadotamizaje" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->resultadotamizaje->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->resultadotamizaje->CellAttributes() ?>>
...
<?php if ($otros->tapon->Visible) { // tapon ?>
	<div id="r_tapon" class="form-group">
		<label id="elh_otros_tapon" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->tapon->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->tapon->CellAttributes() ?>>
...
<?php if ($otros->tipo->Visible) { // tipo ?>
	<div id="r_tipo" class="form-group">
		<label id="elh_otros_tipo" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->tipo->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->tipo->CellAttributes() ?>>
...
<?php if ($otros->repetirprueba->Visible) { // repetirprueba ?>
	<div id="r_repetirprueba" class="form-group">
		<label id="elh_otros_repetirprueba" for="x_repetirprueba" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->repetirprueba->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->repetirprueba->CellAttributes() ?>>
...
<?php if ($otros->observaciones->Visible) { // observaciones ?>
	<div id="r_observaciones" class="form-group">
		<label id="elh_otros_observaciones" for="x_observaciones" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->observaciones->FldCaption() ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->observaciones->CellAttributes() ?>>
...
<?php if ($otros->id_apoderado->Visible) { // id_apoderado ?>
	<div id="r_id_apoderado" class="form-group">
		<label id="elh_otros_id_apoderado" for="x_id_apoderado" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->id_apoderado->FldCaption() ?></label>
...
<?php if ($otros->id_referencia->Visible) { // id_referencia ?>
	<div id="r_id_referencia" class="form-group">
		<label id="elh_otros_id_referencia" for="x_id_referencia" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->id_referencia->FldCaption() ?></label>
...
<?php if ($otros->id_centro->Visible) { // id_centro ?>
	<div id="r_id_centro" class="form-group">
		<label id="elh_otros_id_centro" for="x_id_centro" class="<?php echo $otros_add->LeftColumnClass ?>"><?php echo $otros->id_centro->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $otros_add->RightColumnClass ?>"><div<?php echo $otros->id_centro->CellAttributes() ?>>
...
<?php if (!$otros_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $otros_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $otros_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
