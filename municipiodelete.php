...
fmunicipiodelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fmunicipiodelete.Lists["x_id_provincia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincia"};
fmunicipiodelete.Lists["x_id_provincia"].Data = "<?php echo $municipio_delete->id_provincia->LookupFilterQuery(FALSE, "delete") ?>";
fmunicipiodelete.AutoSuggests["x_id_provincia"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $municipio_delete->id_provincia->LookupFilterQuery(TRUE, "delete"))) ?>;
...
<?php if ($municipio->nombre->Visible) { // nombre ?>
		<th class="<?php echo $municipio->nombre->HeaderCellClass() ?>"><span id="elh_municipio_nombre" class="municipio_nombre"><?php echo $municipio->nombre->FldCaption() ?></span></th>
<?php } ?>
<?php if ($municipio->descripcion->Visible) { // descripcion ?>
		<th class="<?php echo $municipio->descripcion->HeaderCellClass() ?>"><span id="elh_municipio_descripcion" class="municipio_descripcion"><?php echo $municipio->descripcion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($municipio->id_provincia->Visible) { // id_provincia ?>
		<th class="<?php echo $municipio->id_provincia->HeaderCellClass() ?>"><span id="elh_municipio_id_provincia" class="municipio_id_provincia"><?php echo $municipio->id_provincia->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($municipio->descripcion->Visible) { // descripcion ?>
		<td<?php echo $municipio->descripcion->CellAttributes() ?>>
<span id="el<?php echo $municipio_delete->RowCnt ?>_municipio_descripcion" class="municipio_descripcion">
...
<?php } ?>
<?php if ($municipio->id_provincia->Visible) { // id_provincia ?>
		<td<?php echo $municipio->id_provincia->CellAttributes() ?>>
<span id="el<?php echo $municipio_delete->RowCnt ?>_municipio_id_provincia" class="municipio_id_provincia">
