...
<?php include_once "referenciarptinfo.php" ?>
<?php
...
$referencia_rpt = NULL; // Initialize page object first

class crreferencia_rpt extends crreferencia {
	...
	// Page object name
	var $PageObjName = 'referencia_rpt';
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'referencia', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption freferenciarpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'referencia');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_referencia\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_referencia',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"freferenciarpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"freferenciarpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"freferenciarpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->id_medio->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// id_medio
			$CurrentValue = $this->id_medio->CurrentValue;
			$ViewValue = &$this->id_medio->ViewValue;
			$ViewAttrs = &$this->id_medio->ViewAttrs;
			$CellAttrs = &$this->id_medio->CellAttrs;
			$HrefValue = &$this->id_medio->HrefValue;
			$LinkAttrs = &$this->id_medio->LinkAttrs;
			$this->Cell_Rendered($this->id_medio, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
...
// Create page object
if (!isset($referencia_rpt)) $referencia_rpt = new crreferencia_rpt();
...
// Create page object
var referencia_rpt = new ewr_Page("referencia_rpt");

// Page properties
referencia_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = referencia_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_referencia" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="referencia_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn referencia_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer referencia_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->id_medio->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_medio"><div class="referencia_id_medio"><span class="ewTableHeaderCaption"><?php echo $Page->id_medio->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_medio">
<?php if ($Page->SortUrl($Page->id_medio) == "") { ?>
		<div class="ewTableHeaderBtn referencia_id_medio">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_medio->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer referencia_id_medio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_medio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_medio->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_medio->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_medio->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombrescompleto"><div class="referencia_nombrescompleto"><span class="ewTableHeaderCaption"><?php echo $Page->nombrescompleto->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombrescompleto">
<?php if ($Page->SortUrl($Page->nombrescompleto) == "") { ?>
		<div class="ewTableHeaderBtn referencia_nombrescompleto">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombrescompleto->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer referencia_nombrescompleto" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombrescompleto) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombrescompleto->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombrescentromedico"><div class="referencia_nombrescentromedico"><span class="ewTableHeaderCaption"><?php echo $Page->nombrescentromedico->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombrescentromedico">
<?php if ($Page->SortUrl($Page->nombrescentromedico) == "") { ?>
		<div class="ewTableHeaderBtn referencia_nombrescentromedico">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombrescentromedico->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer referencia_nombrescentromedico" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombrescentromedico) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombrescentromedico->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="telefono"><div class="referencia_telefono"><span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="telefono">
<?php if ($Page->SortUrl($Page->telefono) == "") { ?>
		<div class="ewTableHeaderBtn referencia_telefono">
			<span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer referencia_telefono" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->telefono) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->telefono->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_centro"><div class="referencia_id_centro"><span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_centro">
<?php if ($Page->SortUrl($Page->id_centro) == "") { ?>
		<div class="ewTableHeaderBtn referencia_id_centro">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer referencia_id_centro" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_centro) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
...
<?php } ?>
<?php if ($Page->id_medio->Visible) { ?>
		<td data-field="id_medio"<?php echo $Page->id_medio->CellAttributes() ?>>
<span<?php echo $Page->id_medio->ViewAttributes() ?>><?php echo $Page->id_medio->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->nombrescompleto->Visible) { ?>
...
<?php include "referenciarptpager.php" ?>
