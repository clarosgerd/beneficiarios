...
//
class crreferencia extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('referencia', 'referencia', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_medio
		$this->id_medio = new crField('referencia', 'referencia', 'x_id_medio', 'id_medio', '`id_medio`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->id_medio->Sortable = TRUE; // Allow sort
		$this->id_medio->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->id_medio->DateFilter = "";
		$this->id_medio->SqlSelect = "";
		$this->id_medio->SqlOrderBy = "";
		$this->fields['id_medio'] = &$this->id_medio;

		// nombrescompleto
		$this->nombrescompleto = new crField('referencia', 'referencia', 'x_nombrescompleto', 'nombrescompleto', '`nombrescompleto`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombrescentromedico
		$this->nombrescentromedico = new crField('referencia', 'referencia', 'x_nombrescentromedico', 'nombrescentromedico', '`nombrescentromedico`', 200, EWR_DATATYPE_STRING, -1);
		$this->nombrescentromedico->Sortable = TRUE; // Allow sort
		$this->nombrescentromedico->DateFilter = "";
		$this->nombrescentromedico->SqlSelect = "";
		...
		// id_centro
		$this->id_centro = new crField('referencia', 'referencia', 'x_id_centro', 'id_centro', '`id_centro`', 3, EWR_DATATYPE_NUMBER, -1);
