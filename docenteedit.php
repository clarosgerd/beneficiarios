...
$docente_edit = NULL; // Initialize page object first

class cdocente_edit extends cdocente {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// fechanacimiento
			$this->fechanacimiento->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->fechanacimiento->CurrentValue, 6), ew_CurrentDate(), $this->fechanacimiento->ReadOnly);
			...
			// materias
			$this->materias->SetDbValueDef($rsnew, $this->materias->CurrentValue, NULL, $this->materias->ReadOnly);

			// discapacidad
			$this->discapacidad->SetDbValueDef($rsnew, $this->discapacidad->CurrentValue, 0, $this->discapacidad->ReadOnly);

			// tipodiscapacidad
			$this->tipodiscapacidad->SetDbValueDef($rsnew, $this->tipodiscapacidad->CurrentValue, 0, $this->tipodiscapacidad->ReadOnly);
...
// Create page object
if (!isset($docente_edit)) $docente_edit = new cdocente_edit();

// Page init
$docente_edit->Page_Init();

// Page main
$docente_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$docente_edit->Page_Render();
?>
...
var CurrentForm = fdocenteedit = new ew_Form("fdocenteedit", "edit");

// Validate form
fdocenteedit.Validate = function() {
...
fdocenteedit.Form_CustomValidate = 
...
fdocenteedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fdocenteedit.Lists["x_id_departamento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fdocenteedit.Lists["x_id_departamento"].Data = "<?php echo $docente_edit->id_departamento->LookupFilterQuery(FALSE, "edit") ?>";
fdocenteedit.Lists["x_unidadeducativa"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_codigo_sie","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"unidadeducativa"};
fdocenteedit.Lists["x_unidadeducativa"].Data = "<?php echo $docente_edit->unidadeducativa->LookupFilterQuery(FALSE, "edit") ?>";
fdocenteedit.Lists["x_sexo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdocenteedit.Lists["x_sexo"].Options = <?php echo json_encode($docente_edit->sexo->Options()) ?>;
fdocenteedit.Lists["x_discapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"discapacidad"};
fdocenteedit.Lists["x_discapacidad"].Data = "<?php echo $docente_edit->discapacidad->LookupFilterQuery(FALSE, "edit") ?>";
fdocenteedit.Lists["x_tipodiscapacidad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tipodiscapacidad"};
fdocenteedit.Lists["x_tipodiscapacidad"].Data = "<?php echo $docente_edit->tipodiscapacidad->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $docente_edit->ShowPageHeader(); ?>
<?php
$docente_edit->ShowMessage();
?>
<form name="fdocenteedit" id="fdocenteedit" class="<?php echo $docente_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($docente_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $docente_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="docente">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($docente_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($docente->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_docente_id" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->id->FldCaption() ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->id->CellAttributes() ?>>
<span id="el_docente_id">
<span<?php echo $docente->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $docente->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="docente" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($docente->id->CurrentValue) ?>">
<?php echo $docente->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($docente->id_departamento->Visible) { // id_departamento ?>
	<div id="r_id_departamento" class="form-group">
		<label id="elh_docente_id_departamento" for="x_id_departamento" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->id_departamento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->id_departamento->CellAttributes() ?>>
...
<?php if ($docente->unidadeducativa->Visible) { // unidadeducativa ?>
	<div id="r_unidadeducativa" class="form-group">
		<label id="elh_docente_unidadeducativa" for="x_unidadeducativa" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->unidadeducativa->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->unidadeducativa->CellAttributes() ?>>
<span id="el_docente_unidadeducativa">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_unidadeducativa"><?php echo (strval($docente->unidadeducativa->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $docente->unidadeducativa->ViewValue); ?></span>
</span>
...
<?php if ($docente->apellidopaterno->Visible) { // apellidopaterno ?>
	<div id="r_apellidopaterno" class="form-group">
		<label id="elh_docente_apellidopaterno" for="x_apellidopaterno" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->apellidopaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->apellidopaterno->CellAttributes() ?>>
...
<?php if ($docente->apellidomaterno->Visible) { // apellidomaterno ?>
	<div id="r_apellidomaterno" class="form-group">
		<label id="elh_docente_apellidomaterno" for="x_apellidomaterno" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->apellidomaterno->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->apellidomaterno->CellAttributes() ?>>
...
<?php if ($docente->nombres->Visible) { // nombres ?>
	<div id="r_nombres" class="form-group">
		<label id="elh_docente_nombres" for="x_nombres" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->nombres->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->nombres->CellAttributes() ?>>
...
<?php if ($docente->nrodiscapacidad->Visible) { // nrodiscapacidad ?>
	<div id="r_nrodiscapacidad" class="form-group">
		<label id="elh_docente_nrodiscapacidad" for="x_nrodiscapacidad" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->nrodiscapacidad->FldCaption() ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->nrodiscapacidad->CellAttributes() ?>>
...
<?php if ($docente->ci->Visible) { // ci ?>
	<div id="r_ci" class="form-group">
		<label id="elh_docente_ci" for="x_ci" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->ci->FldCaption() ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->ci->CellAttributes() ?>>
...
<?php if ($docente->fechanacimiento->Visible) { // fechanacimiento ?>
	<div id="r_fechanacimiento" class="form-group">
		<label id="elh_docente_fechanacimiento" for="x_fechanacimiento" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->fechanacimiento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->fechanacimiento->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fdocenteedit", "x_fechanacimiento", {"ignoreReadonly":true,"useCurrent":false,"format":6});
</script>
<?php } ?>
</span>
...
<?php if ($docente->sexo->Visible) { // sexo ?>
	<div id="r_sexo" class="form-group">
		<label id="elh_docente_sexo" for="x_sexo" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->sexo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->sexo->CellAttributes() ?>>
...
<?php if ($docente->celular->Visible) { // celular ?>
	<div id="r_celular" class="form-group">
		<label id="elh_docente_celular" for="x_celular" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->celular->FldCaption() ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->celular->CellAttributes() ?>>
...
<?php if ($docente->materias->Visible) { // materias ?>
	<div id="r_materias" class="form-group">
		<label id="elh_docente_materias" for="x_materias" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->materias->FldCaption() ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->materias->CellAttributes() ?>>
...
<?php if ($docente->discapacidad->Visible) { // discapacidad ?>
	<div id="r_discapacidad" class="form-group">
		<label id="elh_docente_discapacidad" for="x_discapacidad" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->discapacidad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->discapacidad->CellAttributes() ?>>
<span id="el_docente_discapacidad">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_discapacidad"><?php echo (strval($docente->discapacidad->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $docente->discapacidad->ViewValue); ?></span>
</span>
...
<?php if ($docente->tipodiscapacidad->Visible) { // tipodiscapacidad ?>
	<div id="r_tipodiscapacidad" class="form-group">
		<label id="elh_docente_tipodiscapacidad" for="x_tipodiscapacidad" class="<?php echo $docente_edit->LeftColumnClass ?>"><?php echo $docente->tipodiscapacidad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $docente_edit->RightColumnClass ?>"><div<?php echo $docente->tipodiscapacidad->CellAttributes() ?>>
<span id="el_docente_tipodiscapacidad">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_tipodiscapacidad"><?php echo (strval($docente->tipodiscapacidad->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $docente->tipodiscapacidad->ViewValue); ?></span>
</span>
...
<?php if (!$docente_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $docente_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $docente_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
