...
//
class crcurso extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('curso', 'curso', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// curso
		$this->curso = new crField('curso', 'curso', 'x_curso', 'curso', '`curso`', 200, EWR_DATATYPE_STRING, -1);
