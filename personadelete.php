...
<?php if ($persona->id->Visible) { // id ?>
		<th class="<?php echo $persona->id->HeaderCellClass() ?>"><span id="elh_persona_id" class="persona_id"><?php echo $persona->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->nombreinstitucion->Visible) { // nombreinstitucion ?>
		<th class="<?php echo $persona->nombreinstitucion->HeaderCellClass() ?>"><span id="elh_persona_nombreinstitucion" class="persona_nombreinstitucion"><?php echo $persona->nombreinstitucion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->apellidopaterno->Visible) { // apellidopaterno ?>
		<th class="<?php echo $persona->apellidopaterno->HeaderCellClass() ?>"><span id="elh_persona_apellidopaterno" class="persona_apellidopaterno"><?php echo $persona->apellidopaterno->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->apellidomaterno->Visible) { // apellidomaterno ?>
		<th class="<?php echo $persona->apellidomaterno->HeaderCellClass() ?>"><span id="elh_persona_apellidomaterno" class="persona_apellidomaterno"><?php echo $persona->apellidomaterno->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($persona->tipopersona->Visible) { // tipopersona ?>
		<th class="<?php echo $persona->tipopersona->HeaderCellClass() ?>"><span id="elh_persona_tipopersona" class="persona_tipopersona"><?php echo $persona->tipopersona->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($persona->nombreinstitucion->Visible) { // nombreinstitucion ?>
		<td<?php echo $persona->nombreinstitucion->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_nombreinstitucion" class="persona_nombreinstitucion">
...
<?php } ?>
<?php if ($persona->apellidopaterno->Visible) { // apellidopaterno ?>
		<td<?php echo $persona->apellidopaterno->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_apellidopaterno" class="persona_apellidopaterno">
...
<?php } ?>
<?php if ($persona->apellidomaterno->Visible) { // apellidomaterno ?>
		<td<?php echo $persona->apellidomaterno->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_apellidomaterno" class="persona_apellidomaterno">
...
<?php } ?>
<?php if ($persona->tipopersona->Visible) { // tipopersona ?>
		<td<?php echo $persona->tipopersona->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_tipopersona" class="persona_tipopersona">
