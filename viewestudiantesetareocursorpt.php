...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewestudiantesetareocurso_edad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->edad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->edad->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewestudiantesetareocurso_etareo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->etareo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->etareo->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewestudiantesetareocurso_nombreinstitucion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombreinstitucion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombreinstitucion->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewestudiantesetareocurso_curso" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->curso) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->curso->FldCaption() ?></span>
