...
<?php include_once "otrosrptinfo.php" ?>
<?php
...
$otros_rpt = NULL; // Initialize page object first

class crotros_rpt extends crotros {
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'otros', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fotrosrpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'otros');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_otros\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_otros',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fotrosrpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fotrosrpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fotrosrpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function Page_Main() {
		...
		$this->Col = array(array(FALSE, FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE), array(FALSE,FALSE));
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[2] = $this->id_actividad->CurrentValue;
			...
			$this->Val[10] = $this->nivelestudio->CurrentValue;
			$this->Val[11] = $this->id_discapacidad->CurrentValue;
			$this->Val[12] = $this->id_tipodiscapacidad->CurrentValue;
			$this->Val[13] = $this->resultado->CurrentValue;
			$this->Val[14] = $this->resultadotamizaje->CurrentValue;
			$this->Val[15] = $this->tapon->CurrentValue;
			$this->Val[16] = $this->tipo->CurrentValue;
			$this->Val[17] = $this->repetirprueba->CurrentValue;
			$this->Val[18] = $this->observaciones->CurrentValue;
			$this->Val[19] = $this->id_apoderado->CurrentValue;
			$this->Val[20] = $this->id_referencia->CurrentValue;
			$this->Val[21] = $this->id_centro->CurrentValue;
		} else {
			$this->id->setDbValue("");
...
// Create page object
if (!isset($otros_rpt)) $otros_rpt = new crotros_rpt();
...
// Create page object
var otros_rpt = new ewr_Page("otros_rpt");

// Page properties
otros_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = otros_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_otros" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="otros_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn otros_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_actividad"><div class="otros_id_actividad"><span class="ewTableHeaderCaption"><?php echo $Page->id_actividad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_actividad">
<?php if ($Page->SortUrl($Page->id_actividad) == "") { ?>
		<div class="ewTableHeaderBtn otros_id_actividad">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_actividad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id_actividad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_actividad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_actividad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="apellidopaterno"><div class="otros_apellidopaterno"><span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="apellidopaterno">
<?php if ($Page->SortUrl($Page->apellidopaterno) == "") { ?>
		<div class="ewTableHeaderBtn otros_apellidopaterno">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_apellidopaterno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellidopaterno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="apellidomaterno"><div class="otros_apellidomaterno"><span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="apellidomaterno">
<?php if ($Page->SortUrl($Page->apellidomaterno) == "") { ?>
		<div class="ewTableHeaderBtn otros_apellidomaterno">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_apellidomaterno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellidomaterno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="otros_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn otros_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nrodiscapacidad"><div class="otros_nrodiscapacidad"><span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nrodiscapacidad">
<?php if ($Page->SortUrl($Page->nrodiscapacidad) == "") { ?>
		<div class="ewTableHeaderBtn otros_nrodiscapacidad">
			<span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_nrodiscapacidad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nrodiscapacidad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ci"><div class="otros_ci"><span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ci">
<?php if ($Page->SortUrl($Page->ci) == "") { ?>
		<div class="ewTableHeaderBtn otros_ci">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_ci" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ci) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="fecha_nacimiento"><div class="otros_fecha_nacimiento"><span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="fecha_nacimiento">
<?php if ($Page->SortUrl($Page->fecha_nacimiento) == "") { ?>
		<div class="ewTableHeaderBtn otros_fecha_nacimiento">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_fecha_nacimiento" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fecha_nacimiento) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="sexo"><div class="otros_sexo"><span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="sexo">
<?php if ($Page->SortUrl($Page->sexo) == "") { ?>
		<div class="ewTableHeaderBtn otros_sexo">
			<span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_sexo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->sexo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nivelestudio"><div class="otros_nivelestudio"><span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nivelestudio">
<?php if ($Page->SortUrl($Page->nivelestudio) == "") { ?>
		<div class="ewTableHeaderBtn otros_nivelestudio">
			<span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_nivelestudio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nivelestudio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_discapacidad"><div class="otros_id_discapacidad"><span class="ewTableHeaderCaption"><?php echo $Page->id_discapacidad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_discapacidad">
<?php if ($Page->SortUrl($Page->id_discapacidad) == "") { ?>
		<div class="ewTableHeaderBtn otros_id_discapacidad">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_discapacidad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id_discapacidad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_discapacidad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_discapacidad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_tipodiscapacidad"><div class="otros_id_tipodiscapacidad"><span class="ewTableHeaderCaption"><?php echo $Page->id_tipodiscapacidad->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_tipodiscapacidad">
<?php if ($Page->SortUrl($Page->id_tipodiscapacidad) == "") { ?>
		<div class="ewTableHeaderBtn otros_id_tipodiscapacidad">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_tipodiscapacidad->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id_tipodiscapacidad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_tipodiscapacidad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_tipodiscapacidad->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="resultado"><div class="otros_resultado"><span class="ewTableHeaderCaption"><?php echo $Page->resultado->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="resultado">
<?php if ($Page->SortUrl($Page->resultado) == "") { ?>
		<div class="ewTableHeaderBtn otros_resultado">
			<span class="ewTableHeaderCaption"><?php echo $Page->resultado->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_resultado" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->resultado) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->resultado->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="resultadotamizaje"><div class="otros_resultadotamizaje"><span class="ewTableHeaderCaption"><?php echo $Page->resultadotamizaje->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="resultadotamizaje">
<?php if ($Page->SortUrl($Page->resultadotamizaje) == "") { ?>
		<div class="ewTableHeaderBtn otros_resultadotamizaje">
			<span class="ewTableHeaderCaption"><?php echo $Page->resultadotamizaje->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_resultadotamizaje" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->resultadotamizaje) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->resultadotamizaje->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tapon"><div class="otros_tapon"><span class="ewTableHeaderCaption"><?php echo $Page->tapon->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tapon">
<?php if ($Page->SortUrl($Page->tapon) == "") { ?>
		<div class="ewTableHeaderBtn otros_tapon">
			<span class="ewTableHeaderCaption"><?php echo $Page->tapon->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_tapon" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tapon) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tapon->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="tipo"><div class="otros_tipo"><span class="ewTableHeaderCaption"><?php echo $Page->tipo->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="tipo">
<?php if ($Page->SortUrl($Page->tipo) == "") { ?>
		<div class="ewTableHeaderBtn otros_tipo">
			<span class="ewTableHeaderCaption"><?php echo $Page->tipo->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_tipo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->tipo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->tipo->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="repetirprueba"><div class="otros_repetirprueba"><span class="ewTableHeaderCaption"><?php echo $Page->repetirprueba->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="repetirprueba">
<?php if ($Page->SortUrl($Page->repetirprueba) == "") { ?>
		<div class="ewTableHeaderBtn otros_repetirprueba">
			<span class="ewTableHeaderCaption"><?php echo $Page->repetirprueba->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_repetirprueba" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->repetirprueba) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->repetirprueba->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="observaciones"><div class="otros_observaciones"><span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="observaciones">
<?php if ($Page->SortUrl($Page->observaciones) == "") { ?>
		<div class="ewTableHeaderBtn otros_observaciones">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_observaciones" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->observaciones) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_apoderado"><div class="otros_id_apoderado"><span class="ewTableHeaderCaption"><?php echo $Page->id_apoderado->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_apoderado">
<?php if ($Page->SortUrl($Page->id_apoderado) == "") { ?>
		<div class="ewTableHeaderBtn otros_id_apoderado">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_apoderado->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id_apoderado" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_apoderado) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_apoderado->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_referencia"><div class="otros_id_referencia"><span class="ewTableHeaderCaption"><?php echo $Page->id_referencia->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_referencia">
<?php if ($Page->SortUrl($Page->id_referencia) == "") { ?>
		<div class="ewTableHeaderBtn otros_id_referencia">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_referencia->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id_referencia" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_referencia) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_referencia->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_centro"><div class="otros_id_centro"><span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_centro">
<?php if ($Page->SortUrl($Page->id_centro) == "") { ?>
		<div class="ewTableHeaderBtn otros_id_centro">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer otros_id_centro" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_centro) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
