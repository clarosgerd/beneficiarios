...
fdepartamentoadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($departamento_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($departamento->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_departamento_nombre" for="x_nombre" class="<?php echo $departamento_add->LeftColumnClass ?>"><?php echo $departamento->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $departamento_add->RightColumnClass ?>"><div<?php echo $departamento->nombre->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $departamento_add->OffsetColumnClass ?>"><!-- buttons offset -->
