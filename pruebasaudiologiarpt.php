...
<?php include_once "pruebasaudiologiarptinfo.php" ?>
<?php
...
$pruebasaudiologia_rpt = NULL; // Initialize page object first

class crpruebasaudiologia_rpt extends crpruebasaudiologia {
	...
	// Page object name
	var $PageObjName = 'pruebasaudiologia_rpt';
	...
	function __construct() {
		...
		if (!isset($GLOBALS["pruebasaudiologia"])) {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'pruebasaudiologia', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fpruebasaudiologiarpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'pruebasaudiologia');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_pruebasaudiologia\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_pruebasaudiologia',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fpruebasaudiologiarpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fpruebasaudiologiarpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fpruebasaudiologiarpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['id_tipopruebasaudiologia'] = ewr_Conv($rs->fields('id_tipopruebasaudiologia'), 3);
		...
		if (!$rs->EOF) {
			...
			$this->id_tipopruebasaudiologia->setDbValue($rs->fields('id_tipopruebasaudiologia'));
			...
			$this->Val[3] = $this->id_tipopruebasaudiologia->CurrentValue;
			$this->Val[4] = $this->resultado->CurrentValue;
			$this->Val[5] = $this->recomendacion->CurrentValue;
		} else {
			$this->id->setDbValue("");
			$this->id_audiologia->setDbValue("");
			$this->id_tipopruebasaudiologia->setDbValue("");
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->id_tipopruebasaudiologia->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// id_tipopruebasaudiologia
			$CurrentValue = $this->id_tipopruebasaudiologia->CurrentValue;
			$ViewValue = &$this->id_tipopruebasaudiologia->ViewValue;
			$ViewAttrs = &$this->id_tipopruebasaudiologia->ViewAttrs;
			$CellAttrs = &$this->id_tipopruebasaudiologia->CellAttrs;
			$HrefValue = &$this->id_tipopruebasaudiologia->HrefValue;
			$LinkAttrs = &$this->id_tipopruebasaudiologia->LinkAttrs;
			$this->Cell_Rendered($this->id_tipopruebasaudiologia, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		if ($this->id_tipopruebasaudiologia->Visible) $this->DtlColumnCount += 1;
...
// Create page object
if (!isset($pruebasaudiologia_rpt)) $pruebasaudiologia_rpt = new crpruebasaudiologia_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$pruebasaudiologia_rpt;
...
// Create page object
var pruebasaudiologia_rpt = new ewr_Page("pruebasaudiologia_rpt");

// Page properties
pruebasaudiologia_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = pruebasaudiologia_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_pruebasaudiologia" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="pruebasaudiologia_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn pruebasaudiologia_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer pruebasaudiologia_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_audiologia"><div class="pruebasaudiologia_id_audiologia"><span class="ewTableHeaderCaption"><?php echo $Page->id_audiologia->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_audiologia">
<?php if ($Page->SortUrl($Page->id_audiologia) == "") { ?>
		<div class="ewTableHeaderBtn pruebasaudiologia_id_audiologia">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_audiologia->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer pruebasaudiologia_id_audiologia" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_audiologia) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_audiologia->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->id_tipopruebasaudiologia->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_tipopruebasaudiologia"><div class="pruebasaudiologia_id_tipopruebasaudiologia"><span class="ewTableHeaderCaption"><?php echo $Page->id_tipopruebasaudiologia->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_tipopruebasaudiologia">
<?php if ($Page->SortUrl($Page->id_tipopruebasaudiologia) == "") { ?>
		<div class="ewTableHeaderBtn pruebasaudiologia_id_tipopruebasaudiologia">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_tipopruebasaudiologia->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer pruebasaudiologia_id_tipopruebasaudiologia" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_tipopruebasaudiologia) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_tipopruebasaudiologia->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_tipopruebasaudiologia->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_tipopruebasaudiologia->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="resultado"><div class="pruebasaudiologia_resultado"><span class="ewTableHeaderCaption"><?php echo $Page->resultado->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="resultado">
<?php if ($Page->SortUrl($Page->resultado) == "") { ?>
		<div class="ewTableHeaderBtn pruebasaudiologia_resultado">
			<span class="ewTableHeaderCaption"><?php echo $Page->resultado->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer pruebasaudiologia_resultado" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->resultado) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->resultado->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="recomendacion"><div class="pruebasaudiologia_recomendacion"><span class="ewTableHeaderCaption"><?php echo $Page->recomendacion->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="recomendacion">
<?php if ($Page->SortUrl($Page->recomendacion) == "") { ?>
		<div class="ewTableHeaderBtn pruebasaudiologia_recomendacion">
			<span class="ewTableHeaderCaption"><?php echo $Page->recomendacion->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer pruebasaudiologia_recomendacion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->recomendacion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->recomendacion->FldCaption() ?></span>
...
<?php } ?>
<?php if ($Page->id_tipopruebasaudiologia->Visible) { ?>
		<td data-field="id_tipopruebasaudiologia"<?php echo $Page->id_tipopruebasaudiologia->CellAttributes() ?>>
<span<?php echo $Page->id_tipopruebasaudiologia->ViewAttributes() ?>><?php echo $Page->id_tipopruebasaudiologia->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->resultado->Visible) { ?>
...
<?php include "pruebasaudiologiarptpager.php" ?>
