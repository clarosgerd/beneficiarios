...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_organizador"><?php echo (strval($actividad->organizador->AdvancedSearch->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $actividad->organizador->AdvancedSearch->ViewValue); ?></span>
</span>
