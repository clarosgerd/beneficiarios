...
<?php include_once "tipopruebarptinfo.php" ?>
<?php
...
$tipoprueba_rpt = NULL; // Initialize page object first

class crtipoprueba_rpt extends crtipoprueba {
	...
	// Page object name
	var $PageObjName = 'tipoprueba_rpt';
	...
	function __construct() {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'tipoprueba', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ftipopruebarpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'tipoprueba');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_tipoprueba\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_tipoprueba',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ftipopruebarpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ftipopruebarpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ftipopruebarpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[2] = $this->descripcion->CurrentValue;
			$this->Val[3] = $this->id_audiologia->CurrentValue;
		} else {
			$this->id->setDbValue("");
...
// Create page object
if (!isset($tipoprueba_rpt)) $tipoprueba_rpt = new crtipoprueba_rpt();
...
// Create page object
var tipoprueba_rpt = new ewr_Page("tipoprueba_rpt");

// Page properties
tipoprueba_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = tipoprueba_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_tipoprueba" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="tipoprueba_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn tipoprueba_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipoprueba_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="descripcion"><div class="tipoprueba_descripcion"><span class="ewTableHeaderCaption"><?php echo $Page->descripcion->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="descripcion">
<?php if ($Page->SortUrl($Page->descripcion) == "") { ?>
		<div class="ewTableHeaderBtn tipoprueba_descripcion">
			<span class="ewTableHeaderCaption"><?php echo $Page->descripcion->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipoprueba_descripcion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->descripcion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->descripcion->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_audiologia"><div class="tipoprueba_id_audiologia"><span class="ewTableHeaderCaption"><?php echo $Page->id_audiologia->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_audiologia">
<?php if ($Page->SortUrl($Page->id_audiologia) == "") { ?>
		<div class="ewTableHeaderBtn tipoprueba_id_audiologia">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_audiologia->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipoprueba_id_audiologia" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_audiologia) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_audiologia->FldCaption() ?></span>
...
<?php include "tipopruebarptpager.php" ?>
