...
//
class crotros extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('otros', 'otros', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_actividad
		$this->id_actividad = new crField('otros', 'otros', 'x_id_actividad', 'id_actividad', '`id_actividad`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// apellidopaterno
		$this->apellidopaterno = new crField('otros', 'otros', 'x_apellidopaterno', 'apellidopaterno', '`apellidopaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidomaterno
		$this->apellidomaterno = new crField('otros', 'otros', 'x_apellidomaterno', 'apellidomaterno', '`apellidomaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombre
		$this->nombre = new crField('otros', 'otros', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nrodiscapacidad
		$this->nrodiscapacidad = new crField('otros', 'otros', 'x_nrodiscapacidad', 'nrodiscapacidad', '`nrodiscapacidad`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ci
		$this->ci = new crField('otros', 'otros', 'x_ci', 'ci', '`ci`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fecha_nacimiento
		$this->fecha_nacimiento = new crField('otros', 'otros', 'x_fecha_nacimiento', 'fecha_nacimiento', '`fecha_nacimiento`', 133, EWR_DATATYPE_DATE, 0);
		...
		// sexo
		$this->sexo = new crField('otros', 'otros', 'x_sexo', 'sexo', '`sexo`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nivelestudio
		$this->nivelestudio = new crField('otros', 'otros', 'x_nivelestudio', 'nivelestudio', '`nivelestudio`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_discapacidad
		$this->id_discapacidad = new crField('otros', 'otros', 'x_id_discapacidad', 'id_discapacidad', '`id_discapacidad`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_tipodiscapacidad
		$this->id_tipodiscapacidad = new crField('otros', 'otros', 'x_id_tipodiscapacidad', 'id_tipodiscapacidad', '`id_tipodiscapacidad`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// resultado
		$this->resultado = new crField('otros', 'otros', 'x_resultado', 'resultado', '`resultado`', 200, EWR_DATATYPE_STRING, -1);
		...
		// resultadotamizaje
		$this->resultadotamizaje = new crField('otros', 'otros', 'x_resultadotamizaje', 'resultadotamizaje', '`resultadotamizaje`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tapon
		$this->tapon = new crField('otros', 'otros', 'x_tapon', 'tapon', '`tapon`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// tipo
		$this->tipo = new crField('otros', 'otros', 'x_tipo', 'tipo', '`tipo`', 200, EWR_DATATYPE_STRING, -1);
		...
		// repetirprueba
		$this->repetirprueba = new crField('otros', 'otros', 'x_repetirprueba', 'repetirprueba', '`repetirprueba`', 200, EWR_DATATYPE_STRING, -1);
		...
		// observaciones
		$this->observaciones = new crField('otros', 'otros', 'x_observaciones', 'observaciones', '`observaciones`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_apoderado
		$this->id_apoderado = new crField('otros', 'otros', 'x_id_apoderado', 'id_apoderado', '`id_apoderado`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_referencia
		$this->id_referencia = new crField('otros', 'otros', 'x_id_referencia', 'id_referencia', '`id_referencia`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_centro
		$this->id_centro = new crField('otros', 'otros', 'x_id_centro', 'id_centro', '`id_centro`', 3, EWR_DATATYPE_NUMBER, -1);
