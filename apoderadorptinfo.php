...
//
class crapoderado extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('apoderado', 'apoderado', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// parentesco
		$this->parentesco = new crField('apoderado', 'apoderado', 'x_parentesco', 'parentesco', '`parentesco`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidopaterno
		$this->apellidopaterno = new crField('apoderado', 'apoderado', 'x_apellidopaterno', 'apellidopaterno', '`apellidopaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidomaterno
		$this->apellidomaterno = new crField('apoderado', 'apoderado', 'x_apellidomaterno', 'apellidomaterno', '`apellidomaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombres
		$this->nombres = new crField('apoderado', 'apoderado', 'x_nombres', 'nombres', '`nombres`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ci
		$this->ci = new crField('apoderado', 'apoderado', 'x_ci', 'ci', '`ci`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fechanacimiento
		$this->fechanacimiento = new crField('apoderado', 'apoderado', 'x_fechanacimiento', 'fechanacimiento', '`fechanacimiento`', 133, EWR_DATATYPE_DATE, 0);
		...
		// sexo
		$this->sexo = new crField('apoderado', 'apoderado', 'x_sexo', 'sexo', '`sexo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_centro
		$this->id_centro = new crField('apoderado', 'apoderado', 'x_id_centro', 'id_centro', '`id_centro`', 3, EWR_DATATYPE_NUMBER, -1);
