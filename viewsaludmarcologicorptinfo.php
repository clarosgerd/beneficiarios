...
$viewsaludmarcologico = NULL;

//
// Table class for viewsaludmarcologico
//
class crviewsaludmarcologico extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'viewsaludmarcologico';
		$this->TableName = 'viewsaludmarcologico';
		$this->TableType = 'VIEW';
		...
		// nombreinstitucion
		$this->nombreinstitucion = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_nombreinstitucion', 'nombreinstitucion', '`nombreinstitucion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fecha
		$this->fecha = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_fecha', 'fecha', '`fecha`', 133, EWR_DATATYPE_DATE, 0);
		...
		// cuadro1
		$this->cuadro1 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro1', 'cuadro1', '`cuadro1`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro2
		$this->cuadro2 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro2', 'cuadro2', '`cuadro2`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro3
		$this->cuadro3 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro3', 'cuadro3', '`cuadro3`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro4
		$this->cuadro4 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro4', 'cuadro4', '`cuadro4`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro5
		$this->cuadro5 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro5', 'cuadro5', '`cuadro5`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro6
		$this->cuadro6 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro6', 'cuadro6', '`cuadro6`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro7
		$this->cuadro7 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro7', 'cuadro7', '`cuadro7`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro8
		$this->cuadro8 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro8', 'cuadro8', '`cuadro8`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro9
		$this->cuadro9 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro9', 'cuadro9', '`cuadro9`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro10
		$this->cuadro10 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro10', 'cuadro10', '`cuadro10`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// cuadro11
		$this->cuadro11 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro11', 'cuadro11', '`cuadro11`', 20, EWR_DATATYPE_NUMBER, -1);
		$this->cuadro11->Sortable = TRUE; // Allow sort
		$this->cuadro11->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		...
		// cuadro12
		$this->cuadro12 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro12', 'cuadro12', '`cuadro12`', 20, EWR_DATATYPE_NUMBER, -1);
		$this->cuadro12->Sortable = TRUE; // Allow sort
		$this->cuadro12->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		...
		// cuadro13
		$this->cuadro13 = new crField('viewsaludmarcologico', 'viewsaludmarcologico', 'x_cuadro13', 'cuadro13', '`cuadro13`', 20, EWR_DATATYPE_NUMBER, -1);
		$this->cuadro13->Sortable = TRUE; // Allow sort
		$this->cuadro13->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`viewsaludmarcologico`";
	}
