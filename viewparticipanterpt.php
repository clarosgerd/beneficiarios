...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_sector" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->sector) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->sector->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_actividad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->actividad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->actividad->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_categoria" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->categoria) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->categoria->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_nombreinstitucion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombreinstitucion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombreinstitucion->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_apellidopaterno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellidopaterno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidopaterno->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_apellidomaterno" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellidomaterno) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellidomaterno->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_fecha_nacimiento" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->fecha_nacimiento) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->fecha_nacimiento->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_sexo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->sexo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->sexo->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_ci" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ci) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_nrodiscapacidad" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nrodiscapacidad) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nrodiscapacidad->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_celular" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->celular) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->celular->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_direcciondomicilio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->direcciondomicilio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->direcciondomicilio->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_ocupacion" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ocupacion) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ocupacion->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante__email" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->_email) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->_email->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_cargo" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->cargo) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->cargo->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_nivelestudio" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nivelestudio) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nivelestudio->FldCaption() ?></span>
...
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer viewparticipante_observaciones" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->observaciones) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->observaciones->FldCaption() ?></span>
