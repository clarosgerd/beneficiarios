...
//		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if ($opt == 1) { // Get first row
				...
				$this->FirstRowData['login'] = ewr_Conv($rs->fields('login'), 200);
				$this->FirstRowData['password'] = ewr_Conv($rs->fields('password'), 200);
				$this->FirstRowData['ci'] = ewr_Conv($rs->fields('ci'), 200);
				$this->FirstRowData['id_rol'] = ewr_Conv($rs->fields('id_rol'), 3);
		} else { // Get next row
			$rs->MoveNext();
		}
		if (!$rs->EOF) {
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->apellido->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
			...
			$this->login->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
			...
			// id_rol
			if (($Security->CurrentUserLevel & EWR_ALLOW_ADMIN) == EWR_ALLOW_ADMIN) { // System admin
			$this->id_rol->ViewValue = $this->id_rol->CurrentValue;
			} else {
				$this->id_rol->ViewValue = "********";
			}
			$this->id_rol->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// apellido
			$CurrentValue = $this->apellido->CurrentValue;
			$ViewValue = &$this->apellido->ViewValue;
			...
			// login
			$CurrentValue = $this->login->CurrentValue;
			$ViewValue = &$this->login->ViewValue;
			$ViewAttrs = &$this->login->ViewAttrs;
			$CellAttrs = &$this->login->CellAttrs;
			$HrefValue = &$this->login->HrefValue;
			$LinkAttrs = &$this->login->LinkAttrs;
			$this->Cell_Rendered($this->login, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
			...
			// id_rol
			$CurrentValue = $this->id_rol->CurrentValue;
			$ViewValue = &$this->id_rol->ViewValue;
			$ViewAttrs = &$this->id_rol->ViewAttrs;
			$CellAttrs = &$this->id_rol->CellAttrs;
			$HrefValue = &$this->id_rol->HrefValue;
			$LinkAttrs = &$this->id_rol->LinkAttrs;
			$this->Cell_Rendered($this->id_rol, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
		}
	...
	function SetupFieldCount() {
		...
		if ($this->apellido->Visible) $this->DtlColumnCount += 1;
		if ($this->id_centro->Visible) $this->DtlColumnCount += 1;
		if ($this->login->Visible) $this->DtlColumnCount += 1;
		if ($this->password->Visible) $this->DtlColumnCount += 1;
		if ($this->ci->Visible) $this->DtlColumnCount += 1;
		if ($this->id_rol->Visible) $this->DtlColumnCount += 1;
	}
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_usuario" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="usuario_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn usuario_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="apellido"><div class="usuario_apellido"><span class="ewTableHeaderCaption"><?php echo $Page->apellido->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="apellido">
<?php if ($Page->SortUrl($Page->apellido) == "") { ?>
		<div class="ewTableHeaderBtn usuario_apellido">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellido->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_apellido" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->apellido) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->apellido->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_centro"><div class="usuario_id_centro"><span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_centro">
<?php if ($Page->SortUrl($Page->id_centro) == "") { ?>
		<div class="ewTableHeaderBtn usuario_id_centro">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_id_centro" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_centro) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_centro->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->login->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="login"><div class="usuario_login"><span class="ewTableHeaderCaption"><?php echo $Page->login->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="login">
<?php if ($Page->SortUrl($Page->login) == "") { ?>
		<div class="ewTableHeaderBtn usuario_login">
			<span class="ewTableHeaderCaption"><?php echo $Page->login->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_login" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->login) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->login->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->login->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->login->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="password"><div class="usuario_password"><span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="password">
<?php if ($Page->SortUrl($Page->password) == "") { ?>
		<div class="ewTableHeaderBtn usuario_password">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_password" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->password) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->password->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ci"><div class="usuario_ci"><span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ci">
<?php if ($Page->SortUrl($Page->ci) == "") { ?>
		<div class="ewTableHeaderBtn usuario_ci">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_ci" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ci) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ci->FldCaption() ?></span>
...
<?php } ?>
<?php } ?>
<?php if ($Page->id_rol->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id_rol"><div class="usuario_id_rol"><span class="ewTableHeaderCaption"><?php echo $Page->id_rol->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id_rol">
<?php if ($Page->SortUrl($Page->id_rol) == "") { ?>
		<div class="ewTableHeaderBtn usuario_id_rol">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_rol->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer usuario_id_rol" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id_rol) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id_rol->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->id_rol->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->id_rol->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<span<?php echo $Page->apellido->ViewAttributes() ?>><?php echo $Page->apellido->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->id_centro->Visible) { ?>
...
<?php } ?>
<?php if ($Page->login->Visible) { ?>
		<td data-field="login"<?php echo $Page->login->CellAttributes() ?>>
<span<?php echo $Page->login->ViewAttributes() ?>><?php echo $Page->login->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->password->Visible) { ?>
...
<?php } ?>
<?php if ($Page->id_rol->Visible) { ?>
		<td data-field="id_rol"<?php echo $Page->id_rol->CellAttributes() ?>>
<span<?php echo $Page->id_rol->ViewAttributes() ?>><?php echo $Page->id_rol->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
