...
$provincia_edit = NULL; // Initialize page object first

class cprovincia_edit extends cprovincia {
	...
	// Page object name
	var $PageObjName = 'provincia_edit';
...
// Create page object
if (!isset($provincia_edit)) $provincia_edit = new cprovincia_edit();

// Page init
$provincia_edit->Page_Init();

// Page main
$provincia_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$provincia_edit->Page_Render();
?>
...
var CurrentForm = fprovinciaedit = new ew_Form("fprovinciaedit", "edit");

// Validate form
fprovinciaedit.Validate = function() {
...
fprovinciaedit.Form_CustomValidate = 
...
fprovinciaedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fprovinciaedit.Lists["x_id_departamento"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fprovinciaedit.Lists["x_id_departamento"].Data = "<?php echo $provincia_edit->id_departamento->LookupFilterQuery(FALSE, "edit") ?>";
fprovinciaedit.AutoSuggests["x_id_departamento"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $provincia_edit->id_departamento->LookupFilterQuery(TRUE, "edit"))) ?>;
...
<?php $provincia_edit->ShowPageHeader(); ?>
<?php
$provincia_edit->ShowMessage();
?>
<form name="fprovinciaedit" id="fprovinciaedit" class="<?php echo $provincia_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($provincia_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $provincia_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="provincia">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($provincia_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($provincia->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_provincia_id" class="<?php echo $provincia_edit->LeftColumnClass ?>"><?php echo $provincia->id->FldCaption() ?></label>
		<div class="<?php echo $provincia_edit->RightColumnClass ?>"><div<?php echo $provincia->id->CellAttributes() ?>>
<span id="el_provincia_id">
<span<?php echo $provincia->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $provincia->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="provincia" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($provincia->id->CurrentValue) ?>">
<?php echo $provincia->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($provincia->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_provincia_nombre" for="x_nombre" class="<?php echo $provincia_edit->LeftColumnClass ?>"><?php echo $provincia->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $provincia_edit->RightColumnClass ?>"><div<?php echo $provincia->nombre->CellAttributes() ?>>
...
<?php if ($provincia->descripcion->Visible) { // descripcion ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_provincia_descripcion" for="x_descripcion" class="<?php echo $provincia_edit->LeftColumnClass ?>"><?php echo $provincia->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $provincia_edit->RightColumnClass ?>"><div<?php echo $provincia->descripcion->CellAttributes() ?>>
...
<?php if ($provincia->id_departamento->Visible) { // id_departamento ?>
	<div id="r_id_departamento" class="form-group">
		<label id="elh_provincia_id_departamento" class="<?php echo $provincia_edit->LeftColumnClass ?>"><?php echo $provincia->id_departamento->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $provincia_edit->RightColumnClass ?>"><div<?php echo $provincia->id_departamento->CellAttributes() ?>>
...
<script type="text/javascript">
fprovinciaedit.CreateAutoSuggest({"id":"x_id_departamento","forceSelect":false});
</script>
</span>
...
<?php if (!$provincia_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $provincia_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $provincia_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
