...
$centros_edit = NULL; // Initialize page object first

class ccentros_edit extends ccentros {
...
// Create page object
if (!isset($centros_edit)) $centros_edit = new ccentros_edit();

// Page init
$centros_edit->Page_Init();

// Page main
$centros_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$centros_edit->Page_Render();
?>
...
var CurrentForm = fcentrosedit = new ew_Form("fcentrosedit", "edit");

// Validate form
fcentrosedit.Validate = function() {
...
fcentrosedit.Form_CustomValidate = 
...
fcentrosedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcentrosedit.Lists["x_ciudad"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departamento"};
fcentrosedit.Lists["x_ciudad"].Data = "<?php echo $centros_edit->ciudad->LookupFilterQuery(FALSE, "edit") ?>";
fcentrosedit.Lists["x_provincia"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_descripcion","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"provincia"};
fcentrosedit.Lists["x_provincia"].Data = "<?php echo $centros_edit->provincia->LookupFilterQuery(FALSE, "edit") ?>";
fcentrosedit.Lists["x_municipio"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_descripcion","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"municipio"};
fcentrosedit.Lists["x_municipio"].Data = "<?php echo $centros_edit->municipio->LookupFilterQuery(FALSE, "edit") ?>";
fcentrosedit.Lists["x_id_persona"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"persona"};
fcentrosedit.Lists["x_id_persona"].Data = "<?php echo $centros_edit->id_persona->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $centros_edit->ShowPageHeader(); ?>
<?php
$centros_edit->ShowMessage();
?>
<form name="fcentrosedit" id="fcentrosedit" class="<?php echo $centros_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($centros_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $centros_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="centros">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($centros_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($centros->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_centros_id" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->id->FldCaption() ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->id->CellAttributes() ?>>
<span id="el_centros_id">
<span<?php echo $centros->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $centros->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="centros" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($centros->id->CurrentValue) ?>">
<?php echo $centros->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($centros->nombreinstitucion->Visible) { // nombreinstitucion ?>
	<div id="r_nombreinstitucion" class="form-group">
		<label id="elh_centros_nombreinstitucion" for="x_nombreinstitucion" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->nombreinstitucion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->nombreinstitucion->CellAttributes() ?>>
...
<?php if ($centros->direccion->Visible) { // direccion ?>
	<div id="r_direccion" class="form-group">
		<label id="elh_centros_direccion" for="x_direccion" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->direccion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->direccion->CellAttributes() ?>>
...
<?php if ($centros->telefono->Visible) { // telefono ?>
	<div id="r_telefono" class="form-group">
		<label id="elh_centros_telefono" for="x_telefono" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->telefono->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->telefono->CellAttributes() ?>>
...
<?php if ($centros->ciudad->Visible) { // ciudad ?>
	<div id="r_ciudad" class="form-group">
		<label id="elh_centros_ciudad" for="x_ciudad" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->ciudad->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->ciudad->CellAttributes() ?>>
...
<?php if ($centros->provincia->Visible) { // provincia ?>
	<div id="r_provincia" class="form-group">
		<label id="elh_centros_provincia" for="x_provincia" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->provincia->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->provincia->CellAttributes() ?>>
...
<?php if ($centros->municipio->Visible) { // municipio ?>
	<div id="r_municipio" class="form-group">
		<label id="elh_centros_municipio" for="x_municipio" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->municipio->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->municipio->CellAttributes() ?>>
...
<?php if ($centros->id_persona->Visible) { // id_persona ?>
	<div id="r_id_persona" class="form-group">
		<label id="elh_centros_id_persona" for="x_id_persona" class="<?php echo $centros_edit->LeftColumnClass ?>"><?php echo $centros->id_persona->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $centros_edit->RightColumnClass ?>"><div<?php echo $centros->id_persona->CellAttributes() ?>>
<span id="el_centros_id_persona">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_persona"><?php echo (strval($centros->id_persona->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $centros->id_persona->ViewValue); ?></span>
</span>
...
<?php if (!$centros_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $centros_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $centros_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
