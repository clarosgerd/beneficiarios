...
$atencion_edit = NULL; // Initialize page object first

class catencion_edit extends catencion {
...
// Create page object
if (!isset($atencion_edit)) $atencion_edit = new catencion_edit();

// Page init
$atencion_edit->Page_Init();

// Page main
$atencion_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$atencion_edit->Page_Render();
?>
...
var CurrentForm = fatencionedit = new ew_Form("fatencionedit", "edit");

// Validate form
fatencionedit.Validate = function() {
...
fatencionedit.Form_CustomValidate = 
...
fatencionedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fatencionedit.Lists["x_id_neonato"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"neonatal"};
fatencionedit.Lists["x_id_neonato"].Data = "<?php echo $atencion_edit->id_neonato->LookupFilterQuery(FALSE, "edit") ?>";
fatencionedit.Lists["x_id_escolar"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"escolar"};
fatencionedit.Lists["x_id_escolar"].Data = "<?php echo $atencion_edit->id_escolar->LookupFilterQuery(FALSE, "edit") ?>";
fatencionedit.Lists["x_id_especialista"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombres","x_apellidopaterno","x_apellidomaterno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"especialista"};
fatencionedit.Lists["x_id_especialista"].Data = "<?php echo $atencion_edit->id_especialista->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php $atencion_edit->ShowPageHeader(); ?>
<?php
$atencion_edit->ShowMessage();
?>
<form name="fatencionedit" id="fatencionedit" class="<?php echo $atencion_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($atencion_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $atencion_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="atencion">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($atencion_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($atencion->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_atencion_id" class="<?php echo $atencion_edit->LeftColumnClass ?>"><?php echo $atencion->id->FldCaption() ?></label>
		<div class="<?php echo $atencion_edit->RightColumnClass ?>"><div<?php echo $atencion->id->CellAttributes() ?>>
<span id="el_atencion_id">
<span<?php echo $atencion->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $atencion->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="atencion" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($atencion->id->CurrentValue) ?>">
<?php echo $atencion->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($atencion->id_neonato->Visible) { // id_neonato ?>
	<div id="r_id_neonato" class="form-group">
		<label id="elh_atencion_id_neonato" for="x_id_neonato" class="<?php echo $atencion_edit->LeftColumnClass ?>"><?php echo $atencion->id_neonato->FldCaption() ?></label>
		<div class="<?php echo $atencion_edit->RightColumnClass ?>"><div<?php echo $atencion->id_neonato->CellAttributes() ?>>
<span id="el_atencion_id_neonato">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_neonato"><?php echo (strval($atencion->id_neonato->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $atencion->id_neonato->ViewValue); ?></span>
</span>
...
<?php if ($atencion->id_otros->Visible) { // id_otros ?>
	<div id="r_id_otros" class="form-group">
		<label id="elh_atencion_id_otros" for="x_id_otros" class="<?php echo $atencion_edit->LeftColumnClass ?>"><?php echo $atencion->id_otros->FldCaption() ?></label>
		<div class="<?php echo $atencion_edit->RightColumnClass ?>"><div<?php echo $atencion->id_otros->CellAttributes() ?>>
...
<?php if ($atencion->id_escolar->Visible) { // id_escolar ?>
	<div id="r_id_escolar" class="form-group">
		<label id="elh_atencion_id_escolar" for="x_id_escolar" class="<?php echo $atencion_edit->LeftColumnClass ?>"><?php echo $atencion->id_escolar->FldCaption() ?></label>
		<div class="<?php echo $atencion_edit->RightColumnClass ?>"><div<?php echo $atencion->id_escolar->CellAttributes() ?>>
<span id="el_atencion_id_escolar">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_escolar"><?php echo (strval($atencion->id_escolar->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $atencion->id_escolar->ViewValue); ?></span>
</span>
...
<?php if ($atencion->id_especialista->Visible) { // id_especialista ?>
	<div id="r_id_especialista" class="form-group">
		<label id="elh_atencion_id_especialista" for="x_id_especialista" class="<?php echo $atencion_edit->LeftColumnClass ?>"><?php echo $atencion->id_especialista->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $atencion_edit->RightColumnClass ?>"><div<?php echo $atencion->id_especialista->CellAttributes() ?>>
<span id="el_atencion_id_especialista">
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x_id_especialista"><?php echo (strval($atencion->id_especialista->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $atencion->id_especialista->ViewValue); ?></span>
</span>
...
<?php if (!$atencion_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $atencion_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $atencion_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
