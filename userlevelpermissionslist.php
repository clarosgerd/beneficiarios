...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	...
	<?php } else { ?>
		<th data-name="userlevelid" class="<?php echo $userlevelpermissions->userlevelid->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->userlevelid) ?>',2);"><div id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid">
...
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	...
	<?php } else { ?>
		<th data-name="_tablename" class="<?php echo $userlevelpermissions->_tablename->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->_tablename) ?>',2);"><div id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename">
...
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	...
	<?php } else { ?>
		<th data-name="permission" class="<?php echo $userlevelpermissions->permission->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->permission) ?>',2);"><div id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission">
