...
//
// Table class for audiologia
//
class caudiologia extends cTable {
	var $id;
	var $id_especialista;
	var $especialidad;
	var $fecha;
	...
	function __construct() {
		...
		$this->TableVar = 'audiologia';
		$this->TableName = 'audiologia';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`audiologia`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('audiologia', 'audiologia', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = FALSE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_especialista
		$this->id_especialista = new cField('audiologia', 'audiologia', 'x_id_especialista', 'id_especialista', '`id_especialista`', '`id_especialista`', 3, -1, FALSE, '`id_especialista`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// especialidad
		$this->especialidad = new cField('audiologia', 'audiologia', 'x_especialidad', 'especialidad', '`especialidad`', '`especialidad`', 200, -1, FALSE, '`especialidad`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->especialidad->Sortable = TRUE; // Allow sort
		$this->fields['especialidad'] = &$this->especialidad;

		// fecha
		$this->fecha = new cField('audiologia', 'audiologia', 'x_fecha', 'fecha', '`fecha`', ew_CastDateFieldForLike('`fecha`', 0, "DB"), 133, 0, FALSE, '`fecha`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_escolar
		$this->id_escolar = new cField('audiologia', 'audiologia', 'x_id_escolar', 'id_escolar', '`id_escolar`', '`id_escolar`', 3, -1, FALSE, '`id_escolar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->id_escolar->Sortable = TRUE; // Allow sort
		$this->id_escolar->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->id_escolar->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->id_escolar->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_escolar'] = &$this->id_escolar;

		// id_neonato
		$this->id_neonato = new cField('audiologia', 'audiologia', 'x_id_neonato', 'id_neonato', '`id_neonato`', '`id_neonato`', 3, -1, FALSE, '`id_neonato`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_otros
		$this->id_otros = new cField('audiologia', 'audiologia', 'x_id_otros', 'id_otros', '`id_otros`', '`id_otros`', 3, -1, FALSE, '`id_otros`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->id_otros->Sortable = TRUE; // Allow sort
		$this->id_otros->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->id_otros->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->id_otros->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_otros'] = &$this->id_otros;

		// observaciones
		$this->observaciones = new cField('audiologia', 'audiologia', 'x_observaciones', 'observaciones', '`observaciones`', '`observaciones`', 3, -1, FALSE, '`observaciones`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->observaciones->Sortable = TRUE; // Allow sort
		$this->observaciones->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['observaciones'] = &$this->observaciones;

		// id_atencion
		$this->id_atencion = new cField('audiologia', 'audiologia', 'x_id_atencion', 'id_atencion', '`id_atencion`', '`id_atencion`', 3, -1, FALSE, '`id_atencion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_centro
		$this->id_centro = new cField('audiologia', 'audiologia', 'x_id_centro', 'id_centro', '`id_centro`', '`id_centro`', 3, -1, FALSE, '`id_centro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "pruebasaudiologia") {
			$sDetailUrl = $GLOBALS["pruebasaudiologia"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "diagnosticoaudiologia") {
			$sDetailUrl = $GLOBALS["diagnosticoaudiologia"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "tratamiento") {
			$sDetailUrl = $GLOBALS["tratamiento"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "derivacion") {
			$sDetailUrl = $GLOBALS["derivacion"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "audiologialist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`audiologia`";
	}
	...
	function Update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE) {
		...
		// Cascade Update detail table 'pruebasaudiologia'
		$bCascadeUpdate = FALSE;
		$rscascade = array();
		if (!is_null($rsold) && (isset($rs['id']) && $rsold['id'] <> $rs['id'])) { // Update detail field 'id_audiologia'
			$bCascadeUpdate = TRUE;
			$rscascade['id_audiologia'] = $rs['id']; 
		}
		if ($bCascadeUpdate) {
			if (!isset($GLOBALS["pruebasaudiologia"])) $GLOBALS["pruebasaudiologia"] = new cpruebasaudiologia();
			$rswrk = $GLOBALS["pruebasaudiologia"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				...
				$bUpdate = $GLOBALS["pruebasaudiologia"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["pruebasaudiologia"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["pruebasaudiologia"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}

		// Cascade Update detail table 'diagnosticoaudiologia'
		$bCascadeUpdate = FALSE;
		$rscascade = array();
		if (!is_null($rsold) && (isset($rs['id']) && $rsold['id'] <> $rs['id'])) { // Update detail field 'id_audiologia'
			$bCascadeUpdate = TRUE;
		...
		if ($bCascadeUpdate) {
			if (!isset($GLOBALS["diagnosticoaudiologia"])) $GLOBALS["diagnosticoaudiologia"] = new cdiagnosticoaudiologia();
			$rswrk = $GLOBALS["diagnosticoaudiologia"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				$rskey = array();
				$fldname = 'id';
				$rskey[$fldname] = $rswrk->fields[$fldname];
				...
				// Call Row_Updating event
				$bUpdate = $GLOBALS["diagnosticoaudiologia"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["diagnosticoaudiologia"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["diagnosticoaudiologia"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}

		// Cascade Update detail table 'tratamiento'
		$bCascadeUpdate = FALSE;
		$rscascade = array();
		if (!is_null($rsold) && (isset($rs['id']) && $rsold['id'] <> $rs['id'])) { // Update detail field 'id_audiologia'
			$bCascadeUpdate = TRUE;
		...
		if ($bCascadeUpdate) {
			if (!isset($GLOBALS["tratamiento"])) $GLOBALS["tratamiento"] = new ctratamiento();
			$rswrk = $GLOBALS["tratamiento"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				$rskey = array();
				$fldname = 'id';
				$rskey[$fldname] = $rswrk->fields[$fldname];
				...
				// Call Row_Updating event
				$bUpdate = $GLOBALS["tratamiento"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["tratamiento"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["tratamiento"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}

		// Cascade Update detail table 'derivacion'
		$bCascadeUpdate = FALSE;
		$rscascade = array();
		if (!is_null($rsold) && (isset($rs['id']) && $rsold['id'] <> $rs['id'])) { // Update detail field 'id_audiologia'
			$bCascadeUpdate = TRUE;
		...
		if ($bCascadeUpdate) {
			if (!isset($GLOBALS["derivacion"])) $GLOBALS["derivacion"] = new cderivacion();
			$rswrk = $GLOBALS["derivacion"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				$rskey = array();
				$fldname = 'id';
				$rskey[$fldname] = $rswrk->fields[$fldname];
				...
				// Call Row_Updating event
				$bUpdate = $GLOBALS["derivacion"]->Row_Updating($rsdtlold, $rsdtlnew);
				if ($bUpdate)
					$bUpdate = $GLOBALS["derivacion"]->Update($rscascade, $rskey, $rswrk->fields);
				if (!$bUpdate) return FALSE;

				// Call Row_Updated event
				$GLOBALS["derivacion"]->Row_Updated($rsdtlold, $rsdtlnew);
				$rswrk->MoveNext();
			}
		}
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'pruebasaudiologia'
		if (!isset($GLOBALS["pruebasaudiologia"])) $GLOBALS["pruebasaudiologia"] = new cpruebasaudiologia();
		$rscascade = $GLOBALS["pruebasaudiologia"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["pruebasaudiologia"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["pruebasaudiologia"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["pruebasaudiologia"]->Row_Deleted($dtlrow);
			}
		}

		// Cascade delete detail table 'diagnosticoaudiologia'
		if (!isset($GLOBALS["diagnosticoaudiologia"])) $GLOBALS["diagnosticoaudiologia"] = new cdiagnosticoaudiologia();
		$rscascade = $GLOBALS["diagnosticoaudiologia"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["diagnosticoaudiologia"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["diagnosticoaudiologia"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["diagnosticoaudiologia"]->Row_Deleted($dtlrow);
			}
		}

		// Cascade delete detail table 'tratamiento'
		if (!isset($GLOBALS["tratamiento"])) $GLOBALS["tratamiento"] = new ctratamiento();
		$rscascade = $GLOBALS["tratamiento"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["tratamiento"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["tratamiento"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["tratamiento"]->Row_Deleted($dtlrow);
			}
		}

		// Cascade delete detail table 'derivacion'
		if (!isset($GLOBALS["derivacion"])) $GLOBALS["derivacion"] = new cderivacion();
		$rscascade = $GLOBALS["derivacion"]->LoadRs("`id_audiologia` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB")); 
		$dtlrows = ($rscascade) ? $rscascade->GetRows() : array();

		// Call Row Deleting event
		foreach ($dtlrows as $dtlrow) {
			$bDelete = $GLOBALS["derivacion"]->Row_Deleting($dtlrow);
			if (!$bDelete) break;
		}
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$bDelete = $GLOBALS["derivacion"]->Delete($dtlrow); // Delete
				if ($bDelete === FALSE)
					break;
			}
		}
		...
		if ($bDelete) {
			foreach ($dtlrows as $dtlrow) {
				$GLOBALS["derivacion"]->Row_Deleted($dtlrow);
			}
		}
		if ($bDelete)
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "audiologiaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "audiologiaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("audiologiaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("audiologiaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "audiologiaadd.php?" . $this->UrlParm($parm);
		else
			$url = "audiologiaadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("audiologiaedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("audiologiaedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("audiologiaadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("audiologiaadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("audiologiadelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->id_especialista->EditValue = $this->id_especialista->CurrentValue;
