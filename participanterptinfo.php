...
//
class crparticipante extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('participante', 'participante', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_sector
		$this->id_sector = new crField('participante', 'participante', 'x_id_sector', 'id_sector', '`id_sector`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_actividad
		$this->id_actividad = new crField('participante', 'participante', 'x_id_actividad', 'id_actividad', '`id_actividad`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->id_actividad->Sortable = TRUE; // Allow sort
		$this->id_actividad->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->id_actividad->DateFilter = "";
		$this->id_actividad->SqlSelect = "";
		$this->id_actividad->SqlOrderBy = "";
		$this->fields['id_actividad'] = &$this->id_actividad;

		// id_categoria
		$this->id_categoria = new crField('participante', 'participante', 'x_id_categoria', 'id_categoria', '`id_categoria`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->id_categoria->Sortable = TRUE; // Allow sort
		$this->id_categoria->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->id_categoria->DateFilter = "";
		$this->id_categoria->SqlSelect = "";
		$this->id_categoria->SqlOrderBy = "";
		$this->fields['id_categoria'] = &$this->id_categoria;

		// apellidopaterno
		$this->apellidopaterno = new crField('participante', 'participante', 'x_apellidopaterno', 'apellidopaterno', '`apellidopaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidomaterno
		$this->apellidomaterno = new crField('participante', 'participante', 'x_apellidomaterno', 'apellidomaterno', '`apellidomaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombre
		$this->nombre = new crField('participante', 'participante', 'x_nombre', 'nombre', '`nombre`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fecha_nacimiento
		$this->fecha_nacimiento = new crField('participante', 'participante', 'x_fecha_nacimiento', 'fecha_nacimiento', '`fecha_nacimiento`', 133, EWR_DATATYPE_DATE, 0);
		...
		// sexo
		$this->sexo = new crField('participante', 'participante', 'x_sexo', 'sexo', '`sexo`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ci
		$this->ci = new crField('participante', 'participante', 'x_ci', 'ci', '`ci`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nrodiscapacidad
		$this->nrodiscapacidad = new crField('participante', 'participante', 'x_nrodiscapacidad', 'nrodiscapacidad', '`nrodiscapacidad`', 200, EWR_DATATYPE_STRING, -1);
		...
		// celular
		$this->celular = new crField('participante', 'participante', 'x_celular', 'celular', '`celular`', 200, EWR_DATATYPE_STRING, -1);
		...
		// direcciondomicilio
		$this->direcciondomicilio = new crField('participante', 'participante', 'x_direcciondomicilio', 'direcciondomicilio', '`direcciondomicilio`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ocupacion
		$this->ocupacion = new crField('participante', 'participante', 'x_ocupacion', 'ocupacion', '`ocupacion`', 200, EWR_DATATYPE_STRING, -1);
		...
		// email
		$this->_email = new crField('participante', 'participante', 'x__email', 'email', '`email`', 200, EWR_DATATYPE_STRING, -1);
		...
		// cargo
		$this->cargo = new crField('participante', 'participante', 'x_cargo', 'cargo', '`cargo`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nivelestudio
		$this->nivelestudio = new crField('participante', 'participante', 'x_nivelestudio', 'nivelestudio', '`nivelestudio`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_institucion
		$this->id_institucion = new crField('participante', 'participante', 'x_id_institucion', 'id_institucion', '`id_institucion`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->id_institucion->Sortable = TRUE; // Allow sort
		$this->id_institucion->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->id_institucion->DateFilter = "";
		$this->id_institucion->SqlSelect = "";
		$this->id_institucion->SqlOrderBy = "";
		$this->fields['id_institucion'] = &$this->id_institucion;

		// observaciones
		$this->observaciones = new crField('participante', 'participante', 'x_observaciones', 'observaciones', '`observaciones`', 200, EWR_DATATYPE_STRING, -1);
		...
		// id_centro
		$this->id_centro = new crField('participante', 'participante', 'x_id_centro', 'id_centro', '`id_centro`', 3, EWR_DATATYPE_NUMBER, -1);
