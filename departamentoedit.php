	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $departamento->nombre->FldCaption(), $departamento->nombre->ReqErrMsg)) ?>");
...
fdepartamentoedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($departamento_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($departamento->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_departamento_id" class="<?php echo $departamento_edit->LeftColumnClass ?>"><?php echo $departamento->id->FldCaption() ?></label>
		<div class="<?php echo $departamento_edit->RightColumnClass ?>"><div<?php echo $departamento->id->CellAttributes() ?>>
<span id="el_departamento_id">
<span<?php echo $departamento->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $departamento->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="departamento" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($departamento->id->CurrentValue) ?>">
<?php echo $departamento->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($departamento->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_departamento_nombre" for="x_nombre" class="<?php echo $departamento_edit->LeftColumnClass ?>"><?php echo $departamento->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $departamento_edit->RightColumnClass ?>"><div<?php echo $departamento->nombre->CellAttributes() ?>>
<span id="el_departamento_nombre">
<input type="text" data-table="departamento" data-field="x_nombre" name="x_nombre" id="x_nombre" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($departamento->nombre->getPlaceHolder()) ?>" value="<?php echo $departamento->nombre->EditValue ?>"<?php echo $departamento->nombre->EditAttributes() ?>>
</span>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $departamento_edit->OffsetColumnClass ?>"><!-- buttons offset -->
