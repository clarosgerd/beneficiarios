...
$ReportEstudiantes = NULL;

//
// Table class for ReportEstudiantes
//
class crReportEstudiantes extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'ReportEstudiantes';
		$this->TableName = 'ReportEstudiantes';
		...
		// fechanacimiento
		$this->fechanacimiento = new crField('ReportEstudiantes', 'ReportEstudiantes', 'x_fechanacimiento', 'fechanacimiento', '`fechanacimiento`', 133, EWR_DATATYPE_DATE, 0);
		...
		// sexo
		$this->sexo = new crField('ReportEstudiantes', 'ReportEstudiantes', 'x_sexo', 'sexo', '`sexo`', 200, EWR_DATATYPE_STRING, -1);
		...
		// curso
		$this->curso = new crField('ReportEstudiantes', 'ReportEstudiantes', 'x_curso', 'curso', '`curso`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nrodiscapacidad
		$this->nrodiscapacidad = new crField('ReportEstudiantes', 'ReportEstudiantes', 'x_nrodiscapacidad', 'nrodiscapacidad', '`nrodiscapacidad`', 200, EWR_DATATYPE_STRING, -1);
		...
		// codigorude_es
		$this->codigorude_es = new crField('ReportEstudiantes', 'ReportEstudiantes', 'x_codigorude_es', 'codigorude_es', '`codigorude_es`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombreinstitucion
		$this->nombreinstitucion = new crField('ReportEstudiantes', 'ReportEstudiantes', 'x_nombreinstitucion', 'nombreinstitucion', '`nombreinstitucion`', 200, EWR_DATATYPE_STRING, -1);
		$this->nombreinstitucion->Sortable = TRUE; // Allow sort
		$this->nombreinstitucion->GroupingFieldId = 1;
		$this->nombreinstitucion->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->nombreinstitucion->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->nombreinstitucion->DateFilter = "";
		$this->nombreinstitucion->SqlSelect = "";
		$this->nombreinstitucion->SqlOrderBy = "";
		$this->nombreinstitucion->FldGroupByType = "";
	...
	function getSqlFirstGroupField() {
		return ($this->_SqlFirstGroupField <> "") ? $this->_SqlFirstGroupField : "`nombreinstitucion`";
	}
	...
	function getSqlOrderByGroup() {
		return ($this->_SqlOrderByGroup <> "") ? $this->_SqlOrderByGroup : "`nombreinstitucion` ASC";
	}
