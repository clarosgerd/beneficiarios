...
<?php include_once "tipotratamientoaudiologiarptinfo.php" ?>
<?php
...
$tipotratamientoaudiologia_rpt = NULL; // Initialize page object first

class crtipotratamientoaudiologia_rpt extends crtipotratamientoaudiologia {
	...
	// Page object name
	var $PageObjName = 'tipotratamientoaudiologia_rpt';
	...
	function __construct() {
		...
		if (!isset($GLOBALS["tipotratamientoaudiologia"])) {
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'tipotratamientoaudiologia', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption ftipotratamientoaudiologiarpt";
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'tipotratamientoaudiologia');
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewrExportLink ewEmail\" title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_tipotratamientoaudiologia\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_tipotratamientoaudiologia',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"ftipotratamientoaudiologiarpt\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"ftipotratamientoaudiologiarpt\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"ftipotratamientoaudiologiarpt\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($tipotratamientoaudiologia_rpt)) $tipotratamientoaudiologia_rpt = new crtipotratamientoaudiologia_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$tipotratamientoaudiologia_rpt;
...
// Create page object
var tipotratamientoaudiologia_rpt = new ewr_Page("tipotratamientoaudiologia_rpt");

// Page properties
tipotratamientoaudiologia_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = tipotratamientoaudiologia_rpt.PageID;
</script>
...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_tipotratamientoaudiologia" class="<?php if (ewr_IsResponsiveLayout()) { echo "table-responsive "; } ?>ewGridMiddlePanel">
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="id"><div class="tipotratamientoaudiologia_id"><span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="id">
<?php if ($Page->SortUrl($Page->id) == "") { ?>
		<div class="ewTableHeaderBtn tipotratamientoaudiologia_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipotratamientoaudiologia_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->id) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->id->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="nombre"><div class="tipotratamientoaudiologia_nombre"><span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="nombre">
<?php if ($Page->SortUrl($Page->nombre) == "") { ?>
		<div class="ewTableHeaderBtn tipotratamientoaudiologia_nombre">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer tipotratamientoaudiologia_nombre" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->nombre) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->nombre->FldCaption() ?></span>
...
<?php include "tipotratamientoaudiologiarptpager.php" ?>
