...
//
class crdocente extends crTableBase {
	...
	function __construct() {
		...
		// id
		$this->id = new crField('docente', 'docente', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_departamento
		$this->id_departamento = new crField('docente', 'docente', 'x_id_departamento', 'id_departamento', '`id_departamento`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// unidadeducativa
		$this->unidadeducativa = new crField('docente', 'docente', 'x_unidadeducativa', 'unidadeducativa', '`unidadeducativa`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// apellidopaterno
		$this->apellidopaterno = new crField('docente', 'docente', 'x_apellidopaterno', 'apellidopaterno', '`apellidopaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// apellidomaterno
		$this->apellidomaterno = new crField('docente', 'docente', 'x_apellidomaterno', 'apellidomaterno', '`apellidomaterno`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nombres
		$this->nombres = new crField('docente', 'docente', 'x_nombres', 'nombres', '`nombres`', 200, EWR_DATATYPE_STRING, -1);
		...
		// nrodiscapacidad
		$this->nrodiscapacidad = new crField('docente', 'docente', 'x_nrodiscapacidad', 'nrodiscapacidad', '`nrodiscapacidad`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ci
		$this->ci = new crField('docente', 'docente', 'x_ci', 'ci', '`ci`', 200, EWR_DATATYPE_STRING, -1);
		...
		// fechanacimiento
		$this->fechanacimiento = new crField('docente', 'docente', 'x_fechanacimiento', 'fechanacimiento', '`fechanacimiento`', 133, EWR_DATATYPE_DATE, 0);
		...
		// sexo
		$this->sexo = new crField('docente', 'docente', 'x_sexo', 'sexo', '`sexo`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// celular
		$this->celular = new crField('docente', 'docente', 'x_celular', 'celular', '`celular`', 200, EWR_DATATYPE_STRING, -1);
		...
		// materias
		$this->materias = new crField('docente', 'docente', 'x_materias', 'materias', '`materias`', 200, EWR_DATATYPE_STRING, -1);
		...
		// discapacidad
		$this->discapacidad = new crField('docente', 'docente', 'x_discapacidad', 'discapacidad', '`discapacidad`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// tipodiscapacidad
		$this->tipodiscapacidad = new crField('docente', 'docente', 'x_tipodiscapacidad', 'tipodiscapacidad', '`tipodiscapacidad`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// id_centro
		$this->id_centro = new crField('docente', 'docente', 'x_id_centro', 'id_centro', '`id_centro`', 3, EWR_DATATYPE_NUMBER, -1);
