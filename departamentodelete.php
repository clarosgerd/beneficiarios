...
fdepartamentodelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($departamento->id->Visible) { // id ?>
		<th class="<?php echo $departamento->id->HeaderCellClass() ?>"><span id="elh_departamento_id" class="departamento_id"><?php echo $departamento->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($departamento->nombre->Visible) { // nombre ?>
		<th class="<?php echo $departamento->nombre->HeaderCellClass() ?>"><span id="elh_departamento_nombre" class="departamento_nombre"><?php echo $departamento->nombre->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($departamento->id->Visible) { // id ?>
		<td<?php echo $departamento->id->CellAttributes() ?>>
<span id="el<?php echo $departamento_delete->RowCnt ?>_departamento_id" class="departamento_id">
