...
//
// Table class for provincia
//
class cprovincia extends cTable {
	var $id;
	var $nombre;
	var $descripcion;
	var $id_departamento;
	...
	function __construct() {
		...
		$this->TableVar = 'provincia';
		$this->TableName = 'provincia';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`provincia`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('provincia', 'provincia', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nombre
		$this->nombre = new cField('provincia', 'provincia', 'x_nombre', 'nombre', '`nombre`', '`nombre`', 200, -1, FALSE, '`nombre`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nombre->Sortable = TRUE; // Allow sort
		$this->fields['nombre'] = &$this->nombre;

		// descripcion
		$this->descripcion = new cField('provincia', 'provincia', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// id_departamento
		$this->id_departamento = new cField('provincia', 'provincia', 'x_id_departamento', 'id_departamento', '`id_departamento`', '`id_departamento`', 3, -1, FALSE, '`id_departamento`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`provincia`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "provinciaedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "provinciaadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("provinciaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("provinciaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "provinciaadd.php?" . $this->UrlParm($parm);
		else
			$url = "provinciaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("provinciaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("provinciaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("provinciadelete.php", $this->UrlParm());
	}
